...
The Learning Resources system provides contextual, in-product learning materials to help users understand and use UMetadata features. Resources are matched to specific pages/components and displayed on-demand when users click a lightbulb icon.
...
**Location:** `umetadata-spec/src/main/resources/json/schema/entity/learning/learningResource.json`
...
- `source`:
  ...
  - `provider`: Source name (e.g., "Collate", "UMetadata", "YouTube")
...
**File:** `umetadata-service/src/main/java/org/umetadata/service/jdbi3/LearningResourceRepository.java`
...
**File:** `umetadata-service/src/main/java/org/umetadata/service/resources/learning/LearningResourceResource.java`
...
**Location:** `umetadata-service/src/main/resources/json/data/learningResource/`
...
1. **LearningBadge**
   - Schema: `umetadata-spec/.../entity/learning/learningBadge.json`
...
2. **LearningResourceProgress**
   - Schema: `umetadata-spec/.../entity/learning/learningResourceProgress.json`
...
```bash
# Backend
mvn clean compile -pl umetadata-service -DskipTests
mvn spotless:apply -pl umetadata-service
mvn test-compile -pl umetadata-service
...
**Backend:**
- Entity schema: `umetadata-spec/src/main/resources/json/schema/entity/learning/learningResource.json`
- Repository: `umetadata-service/src/main/java/org/umetadata/service/jdbi3/LearningResourceRepository.java`
- Resource: `umetadata-service/src/main/java/org/umetadata/service/resources/learning/LearningResourceResource.java`
- Tests: `umetadata-service/src/test/java/org/umetadata/service/resources/learning/LearningResourceResourceTest.java`
- Sample data: `umetadata-service/src/main/resources/json/data/learningResource/*.json`
...
**Backend:**
- Standard UMetadata entity framework
...
Save to: `umetadata-service/src/main/resources/json/data/learning/resource/Intermediate_MyFeature.json`
...
3. **Bug Reports:** Standard UMetadata issue process

...
import static org.umetadata.schema.api.services.CreateMlModelService.MlModelServiceType.Sklearn;
import static org.umetadata.schema.entity.services.ServiceType.ML_MODEL;
...
import org.umetadata.schema.services.connections.mlmodel.SklearnConnection;
    ...
    secretsManager =
        DBSecretsManager.getInstance(
            ...
            new SecretsManager.SecretsConfig(
                "umetadata", "prefix", List.of("key:value", "key2:value2"), null));

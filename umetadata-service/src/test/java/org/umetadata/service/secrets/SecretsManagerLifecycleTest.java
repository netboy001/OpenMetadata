...
import static org.umetadata.schema.api.services.CreateDatabaseService.DatabaseServiceType.Mysql;
...
public class SecretsManagerLifecycleTest {
    ...
    secretsManager =
        InMemorySecretsManager.getInstance(
            new SecretsManager.SecretsConfig(
                "umetadata", "prefix", List.of("key1:value1", "key2:value2"), null));
  ...
  void testDatabaseServiceConnectionConfigLifecycle() {
    String password = "umetadata-test";
    String secretName = "/prefix/umetadata/database/test/authtype/password";
  ...
  void testWorkflowLifecycle() {
    String password = "umetadata_password";
    String secretName =
        "/prefix/umetadata/workflow/test-connection/request/connection/config/authtype/password";
  ...
  void test_buildSecretId() {
    ...
    assertEquals(
        "/prefix/umetadata/database/test_name",

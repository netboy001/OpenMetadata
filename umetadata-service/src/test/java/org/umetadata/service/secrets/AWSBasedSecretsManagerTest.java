...
public abstract class AWSBasedSecretsManagerTest extends ExternalSecretsManagerTest {
  ...
  void tearDown() {
    ...
    try {
      resetSingleton("org.umetadata.service.secrets.AWSSecretsManager");
      resetSingleton("org.umetadata.service.secrets.AWSSSMSecretsManager");
    } catch (Exception e) {
  ...
  void testEncryptDecryptIngestionPipelineDBTConfig() {
    String secretKey =
        "secret:/umetadata/pipeline/my-pipeline/sourceconfig/config/dbtconfigsource"

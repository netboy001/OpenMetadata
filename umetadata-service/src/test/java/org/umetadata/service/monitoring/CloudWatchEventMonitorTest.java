...
import static org.umetadata.service.resources.services.ingestionpipelines.IngestionPipelineResourceTest.DATABASE_METADATA_CONFIG;
...
import org.umetadata.schema.monitoring.EventMonitorProvider;
...
public class CloudWatchEventMonitorTest {
  ...
  private static final String EXPECTED_NAMESPACE = "umetadata/INGESTION_PIPELINE";

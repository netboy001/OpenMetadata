...
class LdapAuthCompleteFlowTest extends UMetadataApplicationTest {
  ...
  private void updateAuthenticationConfigToLdap() throws Exception {
    ...
    authConfig.put("clientId", "u-metadata");
    ...
    authorizerConfig.put("className", "org.umetadata.service.security.DefaultAuthorizer");
    authorizerConfig.put("containerRequestFilter", "org.umetadata.service.security.JwtFilter");

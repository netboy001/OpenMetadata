...
class OpenSearchSearchManagerIntegrationTest extends UMetadataApplicationTest {
  ...
  void setUp() {
    ...
    org.umetadata.schema.service.configuration.elasticsearch.ElasticSearchConfiguration
    ...
    if (client != null && testIndexPrefix != null) {
      try {
        String globalSearchIndex =
            org.umetadata.service.Entity.getSearchRepository()
  ...
  void testSearchByField_SuccessfulSearch() throws Exception {
    ...
    String actualIndexName =
        org.umetadata.service.Entity.getSearchRepository().getIndexOrAliasName(indexName);
  ...
  void testListWithOffset_BasicPagination() throws Exception {
    ...
    String actualIndexName =
        org.umetadata.service.Entity.getSearchRepository().getIndexOrAliasName(testIndex);
    createTestIndex(actualIndexName);
    ...
    org.umetadata.service.search.SearchSortFilter sortFilter =
        new org.umetadata.service.search.SearchSortFilter("name.keyword", "asc", null, null);

    // Test first page
    org.umetadata.service.search.SearchResultListMapper result1 =
    ...
    // Test second page
    org.umetadata.service.search.SearchResultListMapper result2 =
    ...
    // Test third page
    org.umetadata.service.search.SearchResultListMapper result3 =
  ...
  void testListWithOffset_WithQueryString() throws Exception {
    ...
    org.umetadata.service.search.SearchResultListMapper result =
  ...
  void testListWithOffset_WithSorting() throws Exception {
    ...
    // Test ascending sort
    org.umetadata.service.search.SearchSortFilter ascSortFilter =
        new org.umetadata.service.search.SearchSortFilter("name.keyword", "asc", null, null);

    org.umetadata.service.search.SearchResultListMapper ascResult =
    ...
    org.umetadata.service.search.SearchSortFilter descSortFilter =
        new org.umetadata.service.search.SearchSortFilter("name.keyword", "desc", null, null);

    org.umetadata.service.search.SearchResultListMapper descResult =
  ...
  void testListWithDeepPagination_WithFilter() throws Exception {
    ...
    for (int i = 1; i <= 20; i++) {
      final int entityNum = i;
      String entityType = (entityNum % 2 == 0) ? "table" : "dashboard";
      String entityJson =
          String.format(
              """
              {
  ...
  void testListWithDeepPagination_MultiplePages() throws Exception {
    ...
    org.umetadata.service.search.SearchSortFilter sortFilter =
        new org.umetadata.service.search.SearchSortFilter("id", "asc", null, null);
  ...
  void testSearchWithDirectQuery_BasicQuery() throws Exception {
    ...
    org.umetadata.schema.search.SearchRequest searchRequest =
        new org.umetadata.schema.search.SearchRequest();
  ...
  void testSearchWithDirectQuery_WithPagination() throws Exception {
    ...
    // Test first page
    org.umetadata.schema.search.SearchRequest request1 =
        new org.umetadata.schema.search.SearchRequest();
    ...
    // Test second page
    org.umetadata.schema.search.SearchRequest request2 =
        new org.umetadata.schema.search.SearchRequest();
  ...
  void testPreviewSearch_WithCustomSettings() throws Exception {
    ...
    org.umetadata.schema.api.search.GlobalSettings globalSettings =
        new org.umetadata.schema.api.search.GlobalSettings();
    globalSettings.setTermBoosts(new java.util.ArrayList<>());

    org.umetadata.schema.api.search.SearchSettings customSettings =
        new org.umetadata.schema.api.search.SearchSettings();
  ...
  void testSearchWithNLQ_SuccessfulTransformation() throws Exception {
    ...
    org.umetadata.service.search.nlq.NLQService mockNlqService =
        mock(org.umetadata.service.search.nlq.NLQService.class);
  ...
  void testSearchDataQualityLineage_BasicLineage() throws Exception {
    ...
    String table3Json =
        String.format(
            ...
            """,
            table3Fqn, org.umetadata.service.util.FullyQualifiedName.buildHash(table3Fqn));
    ...
    String table2Json =
        String.format(
            ...
            """,
            table2Fqn,
            org.umetadata.service.util.FullyQualifiedName.buildHash(table2Fqn),
            table3Fqn,
            table2Fqn);
    ...
    String table1Json =
        String.format(
            ...
            """,
            table1Fqn,
            org.umetadata.service.util.FullyQualifiedName.buildHash(table1Fqn),
            table2Fqn,
            table1Fqn);
  ...
  void testSearchDataQualityLineage_NoLineage() throws Exception {
    ...
    String tableJson =
        String.format(
            ...
            """,
            tableFqn, org.umetadata.service.util.FullyQualifiedName.buildHash(tableFqn));
  ...
  void testSearchDataQualityLineage_WithQueryFilter() throws Exception {
    ...
    String table2Json =
        String.format(
            ...
            """,
            table2Fqn, org.umetadata.service.util.FullyQualifiedName.buildHash(table2Fqn));
  ...
  void testSearchDataQualityLineage_ComplexLineageGraph() throws Exception {
    ...
    String table4Json =
        String.format(
            ...
            """,
            table4Fqn, org.umetadata.service.util.FullyQualifiedName.buildHash(table4Fqn));
    ...
    String table3Json =
        String.format(
            ...
            """,
            table3Fqn,
            org.umetadata.service.util.FullyQualifiedName.buildHash(table3Fqn),
            table4Fqn,
            table3Fqn);

...
class OpenSearchEntitiesProcessorTest {

  @Mock private SearchRepository searchRepository;
  @Mock private IndexMapping indexMapping;

  private OpenSearchEntitiesProcessor processor;
  ...
  @BeforeEach
  void setUp() {
    processor = new OpenSearchEntitiesProcessor(TOTAL);
  }
  ...
  void testUpdateStats() {
    ...
    // When
    processor.updateStats(20, 5);

    // Then
    assertEquals(20, processor.getStats().getSuccessRecords());

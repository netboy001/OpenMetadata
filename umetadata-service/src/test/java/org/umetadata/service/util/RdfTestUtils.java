...
public class RdfTestUtils {
  ...
  public static void verifyRelationshipInRdf(
      ...
      EntityReference to,
      org.umetadata.schema.type.Relationship relationship) {
  ...
  public static void verifyContainsRelationshipInRdf(
    ...
    verifyRelationshipInRdf(parent, child, org.umetadata.schema.type.Relationship.CONTAINS);
  }
  ...
  public static void verifyUsesRelationshipInRdf(EntityReference from, EntityReference to) {
    verifyRelationshipInRdf(from, to, org.umetadata.schema.type.Relationship.USES);
  }
  ...
  public static void verifyUpstreamRelationshipInRdf(
    ...
    verifyRelationshipInRdf(
        downstream, upstream, org.umetadata.schema.type.Relationship.UPSTREAM);
  }
  ...
  public static void verifyAppliedToRelationshipInRdf(
    ...
    verifyRelationshipInRdf(
        tagOrTerm, entity, org.umetadata.schema.type.Relationship.APPLIED_TO);
  }
  ...
  public static void verifyJoinedWithRelationshipInRdf(
    ...
    verifyRelationshipInRdf(table1, table2, org.umetadata.schema.type.Relationship.JOINED_WITH);
  }
  ...
  private static String inferEntityTypeFromFQN(String fqn) {
    ...
    String[] parts = org.umetadata.service.util.FullyQualifiedName.split(fqn);
    if (parts.length == 0) {
      return "entity";
    }

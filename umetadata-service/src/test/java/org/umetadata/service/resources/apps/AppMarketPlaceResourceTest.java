...
import org.umetadata.schema.entity.app.AppConfiguration;
  ...
  public CreateAppMarketPlaceDefinitionReq createRequest(String name) {
    try {
      return new CreateAppMarketPlaceDefinitionReq()
          ...
          .withSupportEmail("test@wondersgroup.com")
          .withPrivacyPolicyUrl("https://privacy@wondersgroup.com")
          .withClassName("org.umetadata.service.apps.bundles.test.NoOpTestApplication")

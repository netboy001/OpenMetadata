...
import static org.umetadata.schema.entity.policies.accessControl.Rule.Effect.ALLOW;
...
import org.umetadata.service.JwtAuthUMetadataApplicationTest;
...
public class ImpersonationTest extends JwtAuthUMetadataApplicationTest {
  ...
  private void setupJWT() {
    ...
    JWTAuthMechanism adminToken =
        jwtTokenGenerator.generateJWTToken(
            ...
            org.umetadata.schema.auth.ServiceTokenType.OM_USER);
  ...
  void test_botImpersonation_success() throws Exception {
    ...
    org.umetadata.schema.entity.teams.AuthenticationMechanism authMechanism =
        new org.umetadata.schema.entity.teams.AuthenticationMechanism()
            .withAuthType(org.umetadata.schema.entity.teams.AuthenticationMechanism.AuthType.JWT)
            .withConfig(jwtAuth);
    ...
    String originalBotJson = org.umetadata.schema.utils.JsonUtils.pojoToJson(bot);
    bot.setAllowImpersonation(true);
    String updatedBotJson = org.umetadata.schema.utils.JsonUtils.pojoToJson(bot);
  ...
  void test_impersonation_auditTrail_showsUpdatedByAndImpersonatedBy() throws Exception {
        ...
        new org.umetadata.schema.api.services.CreateDatabaseService()
            ...
            .withConnection(
                new DatabaseConnection()
                    .withConfig(
                        new org.umetadata.schema.services.connections.database.MysqlConnection()
    ...
    org.umetadata.schema.entity.data.Database database =
        postWithJWT(
            databasesTarget,
            createDatabase,
            org.umetadata.schema.entity.data.Database.class,
            adminAuthHeaders);
    ...
    org.umetadata.schema.entity.data.DatabaseSchema schema =
        postWithJWT(
            schemasTarget,
            createSchema,
            org.umetadata.schema.entity.data.DatabaseSchema.class,
            adminAuthHeaders);
    ...
    org.umetadata.schema.entity.data.Table table =
        postWithJWT(
            tablesTarget,
            createTable,
            org.umetadata.schema.entity.data.Table.class,
    ...
    // We need to verify how UMetadata tracks "impersonatedBy"
    ...
    org.umetadata.schema.entity.data.Table fetchedTable =
        getWithJWT(tableTarget, org.umetadata.schema.entity.data.Table.class, adminAuthHeaders);
  ...
  void test_impersonation_updateOperation() throws Exception {
    ...
    String originalPolicyJson = org.umetadata.schema.utils.JsonUtils.pojoToJson(createdPolicy);
    createdPolicy.setDescription("Updated via impersonation");
    String updatedPolicyJson = org.umetadata.schema.utils.JsonUtils.pojoToJson(createdPolicy);
  ...
  void test_impersonation_botImpersonatingBot() throws Exception {
    ...
    org.umetadata.schema.entity.teams.AuthenticationMechanism authMechanism1 =
        new org.umetadata.schema.entity.teams.AuthenticationMechanism()
            .withAuthType(org.umetadata.schema.entity.teams.AuthenticationMechanism.AuthType.JWT)
            .withConfig(jwtAuth1);
    ...
    String originalBot1Json = org.umetadata.schema.utils.JsonUtils.pojoToJson(bot1);
    bot1.setAllowImpersonation(true);
    String updatedBot1Json = org.umetadata.schema.utils.JsonUtils.pojoToJson(bot1);
    ...
    org.umetadata.schema.entity.teams.AuthenticationMechanism authMechanism2 =
        new org.umetadata.schema.entity.teams.AuthenticationMechanism()
            .withAuthType(org.umetadata.schema.entity.teams.AuthenticationMechanism.AuthType.JWT)
            .withConfig(jwtAuth2);
  ...
  void test_impersonation_permissionRevokedAfterTokenIssued() throws Exception {
    ...
    String originalBotJson2 = org.umetadata.schema.utils.JsonUtils.pojoToJson(bot);
    bot.setRoles(listOf()); // Remove all roles
    String updatedBotJson2 = org.umetadata.schema.utils.JsonUtils.pojoToJson(bot);

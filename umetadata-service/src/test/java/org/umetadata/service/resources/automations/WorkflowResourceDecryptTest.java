...
import org.umetadata.service.secrets.masker.EntityMasker;
...
class WorkflowResourceDecryptTest {
  ...
  @Test
  void decryptOrNullify_doesNotReturnUMetadataServerConnection() throws Exception {
  ...
  private Workflow buildWorkflowWithConnection() {
    UMetadataConnection connection =
        new UMetadataConnection()
            ...
            .withSecurityConfig(new UMetadataJWTClientConfig().withJwtToken("test-jwt-token"));
    return new Workflow()

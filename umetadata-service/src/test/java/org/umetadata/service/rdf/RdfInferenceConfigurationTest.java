...
import org.umetadata.service.rdf.reasoning.InferenceEngine;
import org.umetadata.service.rdf.reasoning.InferenceEngine.ReasoningLevel;
...
class RdfInferenceConfigurationTest {
  ...
  class ReasoningLevelTests {
    ...
    @Test
    @DisplayName("CUSTOM level should apply UMetadata-specific rules")

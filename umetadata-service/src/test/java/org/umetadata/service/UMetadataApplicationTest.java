...
import org.umetadata.service.resources.events.MSTeamsCallbackResource;
import org.umetadata.service.resources.events.SlackCallbackResource;
import org.umetadata.service.resources.events.WebhookCallbackResource;
...
import org.umetadata.service.util.JdkHttpClientConnector;
...
public abstract class UMetadataApplicationTest {
  ...
  public static final String ELASTIC_SEARCH_CLUSTER_ALIAS = "umetadata";
  ...
  public static DropwizardAppExtension<UMetadataApplicationConfig> APP;
  ...
  protected UMetadataApplicationConfig readTestAppConfig(String path)
    ...
    if ("true".equals(enableCache) && "redis".equals(cacheType)) {
      ...
      try {
        ...
        Class<?> cachedDAOClass =
            Class.forName("org.umetadata.service.cache.CachedCollectionDAO");
  ...
  @NotNull
  protected DropwizardAppExtension<UMetadataApplicationConfig> getApp(
      ConfigOverride[] configOverridesArray) {
    return new DropwizardAppExtension<>(
        UMetadataApplication.class, CONFIG_PATH, configOverridesArray);
  }
      ...
      try {
        RDF_CONTAINER =
            new GenericContainer<>(DockerImageName.parse(rdfContainerImage))
                ...
                .withEnv("FUSEKI_DATASET_1", "umetadata")
                .waitingFor(
                    Wait.forHttp("/$/ping")
                        .forPort(3030)
                        .forStatusCode(200)
        ...
        configOverrides.add(ConfigOverride.config("rdf.dataset", "umetadata"));
  ...
  protected static ElasticSearchConfiguration getSearchConfig() {
    ...
    if (Boolean.TRUE.equals(runWithVectorEmbeddings) && Boolean.TRUE.equals(runWithOpensearch)) {
      org.umetadata.schema.service.configuration.elasticsearch.NaturalLanguageSearchConfiguration
          nlSearch =
              new org.umetadata.schema.service.configuration.elasticsearch
                  .NaturalLanguageSearchConfiguration();
      nlSearch.setSemanticSearchEnabled(true);
      nlSearch.setEmbeddingProvider("djl");
      nlSearch.setDjl(
          new org.umetadata.schema.service.configuration.elasticsearch.Djl()
              .withEmbeddingModel(
                  "ai.djl.huggingface.pytorch/sentence-transformers/all-MiniLM-L6-v2"));

  ...
  private EmailMessage createExpectedEmailWithEnvelope(String subject, String content) {
    ...
    String envelopeHtml =
        "<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3.org/TR/html4/loose.dtd\">"
            ...
            + "<!--[if !mso]><!-- -->"
            + "<img class=\"hero-img\" src=\"https://cdn.getcollate.io/om-change-event-header.png\" width=\"600\" alt=\"UMetadata · Change Event\" style=\"width:100%; height:auto; border-top-left-radius:14px; border-top-right-radius:14px;\">"
            + "<!--<![endif]-->"
            + "</td></tr>"

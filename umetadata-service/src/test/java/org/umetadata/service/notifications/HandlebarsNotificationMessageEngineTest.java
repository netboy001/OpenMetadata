...
package org.umetadata.service.notifications;
...
import org.umetadata.service.apps.bundles.changeEvent.msteams.TeamsMessage;
import org.umetadata.service.apps.bundles.changeEvent.slack.SlackMessage;
import org.umetadata.service.jdbi3.NotificationTemplateRepository;
import org.umetadata.service.notifications.channels.NotificationMessage;
import org.umetadata.service.notifications.channels.email.EmailMessage;
import org.umetadata.service.notifications.channels.gchat.GChatMessageV2;

@Slf4j
@DisplayName("HandlebarsNotificationMessageEngine Integration Test")
class HandlebarsNotificationMessageEngineTest extends UMetadataApplicationTest {
   ...
   * This wraps the provided content in the complete UMetadata email envelope.
   *
  ...
  private EmailMessage createExpectedEmailWithEnvelope(String subject, String content) {
    ...
    String envelopeHtml =
        "<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3.org/TR/html4/loose.dtd\">"
            ...
            + "<title>UMetadata · Change Event</title>"
            ...
            + "<div class=\"preheader\">Fresh activity spotted in your UMetadata environment.</div>"
            ...
            + "<!--[if mso]><v:rect xmlns:v=\"urn:schemas-microsoft-com:vml\" fill=\"true\" stroke=\"false\" style=\"width:600px;height:96px;\"><v:fill type=\"frame\" src=\"https://cdn.wondersgroup.com/om-change-event-header.png\" /><v:textbox inset=\"0,0,0,0\"></v:textbox></v:rect><![endif]-->"
            + "<!--[if !mso]><!-- -->"
            + "<img class=\"hero-img\" src=\"https://cdn.wondersgroup.com/om-change-event-header.png\" width=\"600\" alt=\"UMetadata · Change Event\" style=\"width:100%; height:auto; border-top-left-radius:14px; border-top-right-radius:14px;\">"
            + "<!--<![endif]-->"
            + "</td></tr>"
            ...
            + "<strong>Heads up!</strong> Some fresh updates just landed in your UMetadata environment. Take a quick look at what's new below:"
            + "</td></tr></table></td></tr>"
            ...
            + "<table role=\"presentation\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">"
            + "<tr><td align=\"left\" style=\"font-family:-apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif; font-size:14px; line-height:22px; color:#1f2937;\">"
            + "<span style=\"font-weight:550;\">Happy exploring!</span><br>Thanks,<br><span style=\"color:#9ca3af; font-style:italic;\">UMetadata Team</span>"
  ...
  void testEntityDefault_Email() {
    ...
    EmailMessage expectedEmail =
        createExpectedEmailWithEnvelope(
            "[Test Subscription for entity-default-email] - Change Event Update from UMetadata",
                    ...
                    HeaderBlock.builder()
                        .text(
                            PlainTextObject.builder()
                                .text(
                                    "[Test Subscription for entity-default-slack] - Change Event Update from UMetadata")
                                .build())
                        .build(),
                                ...
                                .body(
                                    List.of(
                                        TeamsMessage.TextBlock.builder()
                                            .type("TextBlock")
                                            .text(
                                                "[Test Subscription for entity-default-teams] - Change Event Update from UMetadata")
                                            .size("Large")
                                            .weight("Bolder")
                                            .wrap(true)
                                            .build(),
                            ...
                            GChatMessageV2.Card.builder()
                                .header(
                                    GChatMessageV2.Header.builder()
                                        .title(
                                            "[Test Subscription for entity-default-gchat] - Change Event Update from UMetadata")
                                        .build())
                                .sections(
                                    List.of(
  ...
  void testEntitySoftDeleted_Email() {
    ...
    EmailMessage expectedEmail =
        createExpectedEmailWithEnvelope(
            "[Test Subscription for entity-soft-deleted-email] - Change Event Update from UMetadata",
                ...
                List.of(
                    HeaderBlock.builder()
                        .text(
                            PlainTextObject.builder()
                                .text(
                                    "[Test Subscription for entity-soft-deleted-slack] - Change Event Update from UMetadata")
                                .build())
                        .build(),
                    SectionBlock.builder()
                        .text(
                                ...
                                .body(
                                    List.of(
                                        TeamsMessage.TextBlock.builder()
                                            .type("TextBlock")
                                            .text(
                                                "[Test Subscription for entity-soft-deleted-teams] - Change Event Update from UMetadata")
                                            .size("Large")
                                            .weight("Bolder")
                                            .wrap(true)
                                            .build(),
                        ...
                        .card(
                            GChatMessageV2.Card.builder()
                                .header(
                                    GChatMessageV2.Header.builder()
                                        .title(
                                            "[Test Subscription for entity-soft-deleted-gchat] - Change Event Update from UMetadata")
                                        .build())
                                .sections(
                                    List.of(
                                        GChatMessageV2.Section.builder()
  ...
  void testPostCreated_Email() {
    ...
    EmailMessage expectedEmail =
        createExpectedEmailWithEnvelope(
            "[Test Subscription for post-created-email] - Change Event Update from UMetadata",
                ...
                List.of(
                    HeaderBlock.builder()
                        .text(
                            PlainTextObject.builder()
                                .text(
                                    "[Test Subscription for post-created-slack] - Change Event Update from UMetadata")
                                .build())
                        .build(),
                    SectionBlock.builder()
                        .text(
                                ...
                                .body(
                                    List.of(
                                        TeamsMessage.TextBlock.builder()
                                            .type("TextBlock")
                                            .text(
                                                "[Test Subscription for post-created-teams] - Change Event Update from UMetadata")
                                            .size("Large")
                                            .weight("Bolder")
                                            .wrap(true)
                                            .build(),
                        ...
                        .card(
                            GChatMessageV2.Card.builder()
                                .header(
                                    GChatMessageV2.Header.builder()
                                        .title(
                                            "[Test Subscription for post-created-gchat] - Change Event Update from UMetadata")
                                        .build())
                                .sections(
                                    List.of(
                                        GChatMessageV2.Section.builder()
  ...
  void testTaskClosed_Email() {
    ...
    EmailMessage expectedEmail =
        createExpectedEmailWithEnvelope(
            "[Test Subscription for task-closed-email] - Change Event Update from UMetadata",
                ...
                List.of(
                    HeaderBlock.builder()
                        .text(
                            PlainTextObject.builder()
                                .text(
                                    "[Test Subscription for task-closed-slack] - Change Event Update from UMetadata")
                                .build())
                        .build(),
                    SectionBlock.builder()
                        .text(
                                ...
                                .body(
                                    List.of(
                                        TeamsMessage.TextBlock.builder()
                                            .type("TextBlock")
                                            .text(
                                                "[Test Subscription for task-closed-teams] - Change Event Update from UMetadata")
                                            .size("Large")
                                            .weight("Bolder")
                                            .wrap(true)
                                            .build(),
                        ...
                        .card(
                            GChatMessageV2.Card.builder()
                                .header(
                                    GChatMessageV2.Header.builder()
                                        .title(
                                            "[Test Subscription for task-closed-gchat] - Change Event Update from UMetadata")
                                        .build())
                                .sections(
                                    List.of(
                                        GChatMessageV2.Section.builder()
  ...
  void testTaskResolved_Email() {
    ...
    EmailMessage expectedEmail =
        createExpectedEmailWithEnvelope(
            "[Test Subscription for task-resolved-email] - Change Event Update from UMetadata",
                ...
                List.of(
                    HeaderBlock.builder()
                        .text(
                            PlainTextObject.builder()
                                .text(
                                    "[Test Subscription for task-resolved-slack] - Change Event Update from UMetadata")
                                .build())
                        .build(),
                    SectionBlock.builder()
                        .text(
                                ...
                                .body(
                                    List.of(
                                        TeamsMessage.TextBlock.builder()
                                            .type("TextBlock")
                                            .text(
                                                "[Test Subscription for task-resolved-teams] - Change Event Update from UMetadata")
                                            .size("Large")
                                            .weight("Bolder")
                                            .wrap(true)
                                            .build(),
                        ...
                        .card(
                            GChatMessageV2.Card.builder()
                                .header(
                                    GChatMessageV2.Header.builder()
                                        .title(
                                            "[Test Subscription for task-resolved-gchat] - Change Event Update from UMetadata")
                                        .build())
                                .sections(
                                    List.of(
                                        GChatMessageV2.Section.builder()
  ...
  void testLogicalTestCaseAdded_Email() {
    ...
    EmailMessage expectedEmail =
        createExpectedEmailWithEnvelope(
            "[Test Subscription for logical-test-case-added-email] - Change Event Update from UMetadata",
                ...
                List.of(
                    HeaderBlock.builder()
                        .text(
                            PlainTextObject.builder()
                                .text(
                                    "[Test Subscription for logical-test-case-added-slack] - Change Event Update from UMetadata")
                                .build())
                        .build(),
                    SectionBlock.builder()
                        .text(
                                ...
                                .body(
                                    List.of(
                                        TeamsMessage.TextBlock.builder()
                                            .type("TextBlock")
                                            .text(
                                                "[Test Subscription for logical-test-case-added-teams] - Change Event Update from UMetadata")
                                            .size("Large")
                                            .weight("Bolder")
                                            .wrap(true)
                                            .build(),
                        ...
                        .card(
                            GChatMessageV2.Card.builder()
                                .header(
                                    GChatMessageV2.Header.builder()
                                        .title(
                                            "[Test Subscription for logical-test-case-added-gchat] - Change Event Update from UMetadata")
                                        .build())
                                .sections(
                                    List.of(
                                        GChatMessageV2.Section.builder()
  ...
  void testThreadCreatedTask_Email() {
    ...
    EmailMessage expectedEmail =
        createExpectedEmailWithEnvelope(
            "[Test Subscription for thread-created-email] - Change Event Update from UMetadata",
                ...
                List.of(
                    HeaderBlock.builder()
                        .text(
                            PlainTextObject.builder()
                                .text(
                                    "[Test Subscription for thread-created-slack] - Change Event Update from UMetadata")
                                .build())
                        .build(),
                    SectionBlock.builder()
                        .text(
                                ...
                                .body(
                                    List.of(
                                        TeamsMessage.TextBlock.builder()
                                            .type("TextBlock")
                                            .text(
                                                "[Test Subscription for thread-created-teams] - Change Event Update from UMetadata")
                                            .size("Large")
                                            .weight("Bolder")
                                            .wrap(true)
                                            .build(),
                        ...
                        .card(
                            GChatMessageV2.Card.builder()
                                .header(
                                    GChatMessageV2.Header.builder()
                                        .title(
                                            "[Test Subscription for thread-created-gchat] - Change Event Update from UMetadata")
                                        .build())
                                .sections(
                                    List.of(
                                        GChatMessageV2.Section.builder()
  ...
  void testThreadUpdatedTask_Email() {
    ...
    EmailMessage expectedEmail =
        createExpectedEmailWithEnvelope(
            "[Test Subscription for thread-updated-email] - Change Event Update from UMetadata",
                ...
                List.of(
                    HeaderBlock.builder()
                        .text(
                            PlainTextObject.builder()
                                .text(
                                    "[Test Subscription for thread-updated-slack] - Change Event Update from UMetadata")
                                .build())
                        .build(),
                    SectionBlock.builder()
                        .text(
                                ...
                                .body(
                                    List.of(
                                        TeamsMessage.TextBlock.builder()
                                            .type("TextBlock")
                                            .text(
                                                "[Test Subscription for thread-updated-teams] - Change Event Update from UMetadata")
                                            .size("Large")
                                            .weight("Bolder")
                                            .wrap(true)
                                            .build(),
                        ...
                        .card(
                            GChatMessageV2.Card.builder()
                                .header(
                                    GChatMessageV2.Header.builder()
                                        .title(
                                            "[Test Subscription for thread-updated-gchat] - Change Event Update from UMetadata")
                                        .build())
                                .sections(
                                    List.of(
                                        GChatMessageV2.Section.builder()
  ...
  void testThreadCreatedConversation_Email() {
    ...
    EmailMessage expectedEmail =
        createExpectedEmailWithEnvelope(
            "[Test Subscription for thread-created-conversation-email] - Change Event Update from UMetadata",
                ...
                List.of(
                    HeaderBlock.builder()
                        .text(
                            PlainTextObject.builder()
                                .text(
                                    "[Test Subscription for thread-created-conversation-slack] - Change Event Update from UMetadata")
                                .build())
                        .build(),
                    SectionBlock.builder()
                        .text(
                                ...
                                .body(
                                    List.of(
                                        TeamsMessage.TextBlock.builder()
                                            .type("TextBlock")
                                            .text(
                                                "[Test Subscription for thread-created-conversation-teams] - Change Event Update from UMetadata")
                                            .size("Large")
                                            .weight("Bolder")
                                            .wrap(true)
                                            .build(),
                        ...
                        .card(
                            GChatMessageV2.Card.builder()
                                .header(
                                    GChatMessageV2.Header.builder()
                                        .title(
                                            "[Test Subscription for thread-created-conversation-gchat] - Change Event Update from UMetadata")
                                        .build())
                                .sections(
                                    List.of(
                                        GChatMessageV2.Section.builder()
  ...
  void testThreadCreatedAnnouncement_Email() {
    ...
    EmailMessage expectedEmail =
        createExpectedEmailWithEnvelope(
            "[Test Subscription for thread-created-announcement-email] - Change Event Update from UMetadata",
                ...
                List.of(
                    HeaderBlock.builder()
                        .text(
                            PlainTextObject.builder()
                                .text(
                                    "[Test Subscription for thread-created-announcement-slack] - Change Event Update from UMetadata")
                                .build())
                        .build(),
                    SectionBlock.builder()
                        .text(
                                ...
                                .body(
                                    List.of(
                                        TeamsMessage.TextBlock.builder()
                                            .type("TextBlock")
                                            .text(
                                                "[Test Subscription for thread-created-announcement-teams] - Change Event Update from UMetadata")
                                            .size("Large")
                                            .weight("Bolder")
                                            .wrap(true)
                                            .build(),
                        ...
                        .card(
                            GChatMessageV2.Card.builder()
                                .header(
                                    GChatMessageV2.Header.builder()
                                        .title(
                                            "[Test Subscription for thread-created-announcement-gchat] - Change Event Update from UMetadata")
                                        .build())
                                .sections(
                                    List.of(
                                        GChatMessageV2.Section.builder()
  ...
  void testThreadUpdatedConversation_Email() {
    ...
    EmailMessage expectedEmail =
        createExpectedEmailWithEnvelope(
            "[Test Subscription for thread-updated-conversation-email] - Change Event Update from UMetadata",
                ...
                List.of(
                    HeaderBlock.builder()
                        .text(
                            PlainTextObject.builder()
                                .text(
                                    "[Test Subscription for thread-updated-conversation-slack] - Change Event Update from UMetadata")
                                .build())
                        .build(),
                    SectionBlock.builder()
                        .text(
                                ...
                                .body(
                                    List.of(
                                        TeamsMessage.TextBlock.builder()
                                            .type("TextBlock")
                                            .text(
                                                "[Test Subscription for thread-updated-conversation-teams] - Change Event Update from UMetadata")
                                            .size("Large")
                                            .weight("Bolder")
                                            .wrap(true)
                                            .build(),
                        ...
                        .card(
                            GChatMessageV2.Card.builder()
                                .header(
                                    GChatMessageV2.Header.builder()
                                        .title(
                                            "[Test Subscription for thread-updated-conversation-gchat] - Change Event Update from UMetadata")
                                        .build())
                                .sections(
                                    List.of(
                                        GChatMessageV2.Section.builder()
  ...
  void testThreadUpdatedAnnouncementActive_Email() {
    ...
    EmailMessage expectedEmail =
        createExpectedEmailWithEnvelope(
            "[Test Subscription for thread-updated-announcement-active-email] - Change Event Update from UMetadata",
                ...
                List.of(
                    HeaderBlock.builder()
                        .text(
                            PlainTextObject.builder()
                                .text(
                                    "[Test Subscription for thread-updated-announcement-active-slack] - Change Event Update from UMetadata")
                                .build())
                        .build(),
                    SectionBlock.builder()
                        .text(
                                ...
                                .body(
                                    List.of(
                                        TeamsMessage.TextBlock.builder()
                                            .type("TextBlock")
                                            .text(
                                                "[Test Subscription for thread-updated-announcement-active-teams] - Change Event Update from UMetadata")
                                            .size("Large")
                                            .weight("Bolder")
                                            .wrap(true)
                                            .build(),
                        ...
                        .card(
                            GChatMessageV2.Card.builder()
                                .header(
                                    GChatMessageV2.Header.builder()
                                        .title(
                                            "[Test Subscription for thread-updated-announcement-active-gchat] - Change Event Update from UMetadata")
                                        .build())
                                .sections(
                                    List.of(
                                        GChatMessageV2.Section.builder()
  ...
  void testThreadUpdatedAnnouncementDeleted_Email() {
    ...
    EmailMessage expectedEmail =
        createExpectedEmailWithEnvelope(
            "[Test Subscription for thread-updated-announcement-deleted-email] - Change Event Update from UMetadata",
                ...
                List.of(
                    HeaderBlock.builder()
                        .text(
                            PlainTextObject.builder()
                                .text(
                                    "[Test Subscription for thread-updated-announcement-deleted-slack] - Change Event Update from UMetadata")
                                .build())
                        .build(),
                    SectionBlock.builder()
                        .text(
                                ...
                                .body(
                                    List.of(
                                        TeamsMessage.TextBlock.builder()
                                            .type("TextBlock")
                                            .text(
                                                "[Test Subscription for thread-updated-announcement-deleted-teams] - Change Event Update from UMetadata")
                                            .size("Large")
                                            .weight("Bolder")
                                            .wrap(true)
                                            .build(),
                        ...
                        .card(
                            GChatMessageV2.Card.builder()
                                .header(
                                    GChatMessageV2.Header.builder()
                                        .title(
                                            "[Test Subscription for thread-updated-announcement-deleted-gchat] - Change Event Update from UMetadata")
                                        .build())
                                .sections(
                                    List.of(
                                        GChatMessageV2.Section.builder()
  ...
  void testEntityDeleted_Email() {
    ...
    EmailMessage expectedEmail =
        createExpectedEmailWithEnvelope(
            "[Test Subscription for entity-deleted-email] - Change Event Update from UMetadata",
                ...
                List.of(
                    HeaderBlock.builder()
                        .text(
                            PlainTextObject.builder()
                                .text(
                                    "[Test Subscription for entity-deleted-slack] - Change Event Update from UMetadata")
                                .build())
                        .build(),
                    SectionBlock.builder()
                        .text(
                                ...
                                .body(
                                    List.of(
                                        TeamsMessage.TextBlock.builder()
                                            .type("TextBlock")
                                            .text(
                                                "[Test Subscription for entity-deleted-teams] - Change Event Update from UMetadata")
                                            .size("Large")
                                            .weight("Bolder")
                                            .wrap(true)
                                            .build(),
                        ...
                        .card(
                            GChatMessageV2.Card.builder()
                                .header(
                                    GChatMessageV2.Header.builder()
                                        .title(
                                            "[Test Subscription for entity-deleted-gchat] - Change Event Update from UMetadata")
                                        .build())
                                .sections(
                                    List.of(
                                        GChatMessageV2.Section.builder()
  ...
  void testEntityCreated_Email() {
    ...
    EmailMessage expectedEmail =
        createExpectedEmailWithEnvelope(
            "[Test Subscription for entity-created-email] - Change Event Update from UMetadata",
                ...
                List.of(
                    HeaderBlock.builder()
                        .text(
                            PlainTextObject.builder()
                                .text(
                                    "[Test Subscription for entity-created-slack] - Change Event Update from UMetadata")
                                .build())
                        .build(),
                    SectionBlock.builder()
                        .text(
                                ...
                                .body(
                                    List.of(
                                        TeamsMessage.TextBlock.builder()
                                            .type("TextBlock")
                                            .text(
                                                "[Test Subscription for entity-created-teams] - Change Event Update from UMetadata")
                                            .size("Large")
                                            .weight("Bolder")
                                            .wrap(true)
                                            .build(),
                        ...
                        .card(
                            GChatMessageV2.Card.builder()
                                .header(
                                    GChatMessageV2.Header.builder()
                                        .title(
                                            "[Test Subscription for entity-created-gchat] - Change Event Update from UMetadata")
                                        .build())
                                .sections(
                                    List.of(
                                        GChatMessageV2.Section.builder()

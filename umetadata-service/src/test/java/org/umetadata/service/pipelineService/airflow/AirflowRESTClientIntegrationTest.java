 ...
 */
package org.umetadata.service.pipelineService.airflow;
...
import org.umetadata.service.clients.pipeline.airflow.AirflowRESTClient;
...
class AirflowRESTClientTest {
  ...
  void test_buildUri() throws KeyStoreException {
    ...
    assertEquals(
        "http://localhost:8080/api/v1/umetadata/last_dag_logs",
    ...
    assertEquals(
        "http://localhost:8080/airflow/api/v1/umetadata/last_dag_logs",
        restClient.buildURI("last_dag_logs").toString());
    ...
    restClient = new AirflowRESTClient(config);
    assertEquals(
        "http://localhost:8080/airflow/foo/api/v1/umetadata/health",

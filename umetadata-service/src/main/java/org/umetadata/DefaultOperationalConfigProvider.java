...
import org.umetadata.schema.operations.OperationalConfiguration;

@Getter
@Setter
public class DefaultOperationalConfigProvider {
  private SmtpSettings emailSettings;
  private UMetadataBaseUrlConfiguration serverUrl;
  ...
  private static UMetadataBaseUrlConfiguration getDefaultServerUrl() {
    String url =

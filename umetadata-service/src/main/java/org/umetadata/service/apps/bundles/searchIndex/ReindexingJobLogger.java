      ...
      stats
          ...
          .forEach(
              (entity, entityStatsObj) -> {
                if (entityStatsObj instanceof org.umetadata.schema.system.StepStats) {
                  org.umetadata.schema.system.StepStats entityStats =
                      (org.umetadata.schema.system.StepStats) entityStatsObj;

...
import org.umetadata.service.apps.bundles.searchIndex.listeners.LoggingProgressListener;
import org.umetadata.service.apps.bundles.searchIndex.listeners.SlackProgressListener;
        ...
        if (!SearchIndexApp.TIME_SERIES_ENTITIES.contains(entityType)) {
          total +=
              Entity.getEntityRepository(entityType)
                  .getDao()
                  .listCount(
                      new org.umetadata.service.jdbi3.ListFilter(
                          org.umetadata.schema.type.Include.ALL));
        }
      } catch (Exception e) {

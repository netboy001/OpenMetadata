...
import static org.umetadata.service.apps.scheduler.AppScheduler.APPS_JOB_GROUP;
import static org.umetadata.service.apps.scheduler.AppScheduler.APP_INFO_KEY;
...
import org.umetadata.schema.api.configuration.apps.AppPrivateConfig;
...
import org.umetadata.service.resources.events.subscription.EventSubscriptionMapper;
...
public class ApplicationHandler {
  ...
  private final UMetadataApplicationConfig config;
  ...
  private ApplicationHandler(UMetadataApplicationConfig config) {
    this.config = config;

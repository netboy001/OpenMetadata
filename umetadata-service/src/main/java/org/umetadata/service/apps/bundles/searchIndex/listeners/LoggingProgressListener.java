...
import org.umetadata.service.apps.bundles.searchIndex.ReindexingJobLogger;
...
public class LoggingProgressListener implements ReindexingProgressListener {
  ...
  private static class ReindexingJobLoggerAdapter extends ReindexingJobLogger {
    ...
    private static org.umetadata.schema.system.EventPublisherJob createMinimalJobData(
        Set<String> entities) {
      return new org.umetadata.schema.system.EventPublisherJob().withEntities(entities);
    }
  }
}

package org.umetadata.service.apps.bundles.cache;
...
import static org.umetadata.service.socket.WebSocketManager.CACHE_WARMUP_JOB_BROADCAST_CHANNEL;
...
import org.umetadata.service.cache.CacheProvider;
import org.umetadata.service.cache.CachedEntityDao;
import org.umetadata.service.cache.CachedRelationshipDao;
import org.umetadata.service.cache.CachedTagUsageDao;
...
public class CacheWarmupApp extends AbstractNativeApplication {
   ...
   * of the cache warmup job runs across all UMetadata servers.
   */

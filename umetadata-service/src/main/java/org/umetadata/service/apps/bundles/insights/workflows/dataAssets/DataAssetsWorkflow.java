package org.umetadata.service.apps.bundles.insights.workflows.dataAssets;
...
import static org.umetadata.service.workflows.searchIndex.ReindexingUtil.getSearchIndexFields;
...
import org.umetadata.service.apps.bundles.insights.search.DataInsightsSearchConfiguration;
...
import org.umetadata.service.apps.bundles.insights.workflows.dataAssets.processors.DataInsightsElasticSearchProcessor;
import org.umetadata.service.apps.bundles.insights.workflows.dataAssets.processors.DataInsightsEntityEnricherProcessor;
import org.umetadata.service.apps.bundles.insights.workflows.dataAssets.processors.DataInsightsOpenSearchProcessor;
...
import org.umetadata.service.search.elasticsearch.ElasticSearchIndexSink;
import org.umetadata.service.search.opensearch.OpenSearchIndexSink;
import org.umetadata.service.workflows.interfaces.Processor;
import org.umetadata.service.workflows.interfaces.Sink;
import org.umetadata.service.workflows.interfaces.TaggedOperation;
...
public class DataAssetsWorkflow {
  ...
  private int computeConcurrencyBudget() {
    ...
    try {
      int poolSize =
          UMetadataApplicationConfigHolder.getInstance().getDataSourceFactory().getMaxSize();
      if (poolSize > 0) {

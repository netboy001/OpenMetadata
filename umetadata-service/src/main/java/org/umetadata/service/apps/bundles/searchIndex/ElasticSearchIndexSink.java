...
import static org.umetadata.schema.system.IndexingError.ErrorSource.SINK;
...
import org.umetadata.service.search.elasticsearch.EsUtils;
...
public class ElasticSearchIndexSink implements BulkSink, Closeable {
  ...
  public ElasticSearchIndexSink(
    ...
    this.asyncClient = new ElasticsearchAsyncClient(esClient.getNewClient()._transport());
            ...
            op.update(
                upd ->
                    upd.index(indexName)
                        ...
                        .action(a -> a.doc(EsUtils.toJsonData(jsonDoc)).docAsUpsert(true))));
  }

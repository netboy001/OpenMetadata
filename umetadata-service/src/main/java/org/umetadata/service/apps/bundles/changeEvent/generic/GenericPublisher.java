...
package org.umetadata.service.apps.bundles.changeEvent.generic;

import static org.umetadata.schema.entity.events.SubscriptionDestination.SubscriptionType.WEBHOOK;
  ...
  public GenericPublisher(
    ...
    if (subscriptionDestination.getType() == WEBHOOK) {
      ...
      if (this.webhook != null && this.webhook.getEndpoint() != null) {
        org.umetadata.service.util.URLValidator.validateURL(

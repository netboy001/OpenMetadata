...
package org.umetadata.service.apps.bundles.searchIndex.distributed;
...
import org.umetadata.service.apps.bundles.searchIndex.IndexingFailureRecorder;
import org.umetadata.service.apps.bundles.searchIndex.ReindexingConfiguration;
          ...
          boolean isReaderFailure =
              e.getIndexingError() != null
                  && e.getIndexingError().getErrorSource()
                      == org.umetadata.schema.system.IndexingError.ErrorSource.READER;
  ...
  private BatchResult processBatch(
    ...
    try {
      ...
      throw new SearchIndexException(
          new org.umetadata.schema.system.IndexingError()
              .withErrorSource(org.umetadata.schema.system.IndexingError.ErrorSource.SINK)

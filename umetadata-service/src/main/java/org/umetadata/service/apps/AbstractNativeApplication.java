...
import static org.umetadata.service.apps.scheduler.OmAppJobListener.JOB_LISTENER_NAME;
import static org.umetadata.service.exception.CatalogExceptionMessage.NO_MANUAL_TRIGGER_ERR;
import static org.umetadata.service.resources.apps.AppResource.SCHEDULED_TYPES;
...
import org.umetadata.schema.AppRuntime;
...
import org.umetadata.service.apps.scheduler.OmAppJobListener;
...
public class AbstractNativeApplication implements NativeApplication {
  ...
  private static final String SERVICE_NAME = "UMetadata";
  ...
  protected IngestionPipeline getIngestionPipeline(
    ...
    UMetadataConnection uMetadataServerConnection =
        new UMetadataConnectionBuilder(
                ingestionPipelineRepository.getUMetadataApplicationConfig(), botName)
            .build();

package org.umetadata.service.apps.bundles.rdf;
...
import static org.umetadata.service.socket.WebSocketManager.RDF_INDEX_JOB_BROADCAST_CHANNEL;
...
import org.umetadata.service.jdbi3.CollectionDAO.EntityRelationshipObject;
import org.umetadata.service.jdbi3.EntityDAO;
...
public class RdfIndexApp extends AbstractNativeApplication {
  ...
  private void processBatchRelationships(
    ...
    try {
      ...
      List<org.umetadata.schema.type.EntityRelationship> allRelationships = new ArrayList<>();
  ...
  private org.umetadata.schema.type.EntityRelationship convertToEntityRelationship(
      EntityRelationshipObject rel) {
    return new org.umetadata.schema.type.EntityRelationship()

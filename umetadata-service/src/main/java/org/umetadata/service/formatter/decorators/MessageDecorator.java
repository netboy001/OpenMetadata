...
package org.umetadata.service.formatter.decorators;

import static org.umetadata.common.utils.CommonUtil.nullOrEmpty;
import static org.umetadata.service.events.subscription.AlertUtil.convertInputListToString;
import static org.umetadata.service.events.subscription.AlertsRuleEvaluator.getEntity;
import static org.umetadata.service.events.subscription.AlertsRuleEvaluator.getThread;
import static org.umetadata.service.events.subscription.AlertsRuleEvaluator.getThreadEntity;
import static org.umetadata.service.formatter.entity.IngestionPipelineFormatter.getDataContractUrl;
import static org.umetadata.service.formatter.entity.IngestionPipelineFormatter.getIngestionPipelineUrl;
import static org.umetadata.service.resources.feeds.MessageParser.replaceEntityLinks;
...
import org.umetadata.service.jdbi3.TestCaseRepository;
...
import org.umetadata.service.util.branding.MessageBrandingResolver;
...
public interface MessageDecorator<T> {
  ...
  static Map<DQ_Template_Section, Map<Enum<?>, Object>> buildDataContractTemplateData(
    ...
    org.umetadata.schema.entity.data.DataContract dataContract =
        (org.umetadata.schema.entity.data.DataContract) getEntity(event);

...
import static org.umetadata.service.search.SearchClient.UPSTREAM_ENTITY_RELATIONSHIP_FIELD;
import static org.umetadata.service.search.SearchClient.UPSTREAM_LINEAGE_FIELD;
...
import org.umetadata.schema.api.entityRelationship.EntityRelationshipDirection;
...
import org.umetadata.service.util.SSLUtil;
...
public final class SearchUtils {
  ...
  public static List<org.umetadata.schema.api.entityRelationship.EsEntityRelationshipData>
    ...
    if (esDoc.containsKey(UPSTREAM_ENTITY_RELATIONSHIP_FIELD)) {
      return JsonUtils.readOrConvertValues(
          ...
          org.umetadata.schema.api.entityRelationship.EsEntityRelationshipData.class);
    }
    return Collections.emptyList();
  }
  ...
  public static List<org.umetadata.schema.api.entityRelationship.EsEntityRelationshipData>
      paginateUpstreamEntityRelationships(
          List<org.umetadata.schema.api.entityRelationship.EsEntityRelationshipData>
              upstreamEntities,
          int from,
          int size) {
  ...
  public static org.umetadata.schema.api.entityRelationship.RelationshipRef
      getEntityRelationshipRef(Map<String, Object> entityMap) {
    return new org.umetadata.schema.api.entityRelationship.RelationshipRef()
        .withId(UUID.fromString(entityMap.get("id").toString()))
        .withType(entityMap.get("entityType").toString())
        .withFullyQualifiedName(entityMap.get("fullyQualifiedName").toString())
        .withFqnHash(FullyQualifiedName.buildHash(entityMap.get("fullyQualifiedName").toString()));

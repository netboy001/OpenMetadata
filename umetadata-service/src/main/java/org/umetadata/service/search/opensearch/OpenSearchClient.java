...
import static org.umetadata.service.search.SearchUtils.buildHttpHostsForHc5;
import static org.umetadata.service.search.SearchUtils.buildScopedCredentialsProvider;
import static org.umetadata.service.search.SearchUtils.createElasticSearchSSLContext;
import static org.umetadata.service.search.SearchUtils.getEntityRelationshipDirection;
import static org.umetadata.service.util.AwsCredentialsUtil.buildCredentialsProvider;
import static org.umetadata.service.util.AwsCredentialsUtil.isAwsIamAuthEnabled;
...
import org.umetadata.schema.api.entityRelationship.SearchSchemaEntityRelationshipResult;
...
import org.umetadata.schema.dataInsight.custom.DataInsightCustomChartResultList;
...
import org.umetadata.schema.service.configuration.elasticsearch.AwsConfiguration;
...
import org.umetadata.service.search.SearchHealthStatus;
...
import org.umetadata.service.search.opensearch.queries.OpenSearchQueryBuilderFactory;
import org.umetadata.service.search.queries.QueryBuilderFactory;
...
public class OpenSearchClient implements SearchClient {
  ...
  public SearchEntityRelationshipResult searchEntityRelationship(
    ...
    for (var nodeFromDownstream : result.getNodes().entrySet()) {
      if (upstreamResult.getNodes().containsKey(nodeFromDownstream.getKey())) {
        org.umetadata.schema.type.entityRelationship.NodeInformation existingNode =
  ...
  public SearchEntityRelationshipResult searchEntityRelationshipWithDirection(
    ...
    if (entityRelationshipRequest.getDirection()
        == org.umetadata.schema.api.entityRelationship.EntityRelationshipDirection.DOWNSTREAM) {

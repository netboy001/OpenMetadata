...
public class LineagePathPreserver {
  ...
  static Map<String, List<String>> buildParentAdjacencyMap(SearchLineageResult result) {
    ...
    if (result.getUpstreamEdges() != null) {
      for (org.umetadata.schema.api.lineage.EsLineageData edge :
  ...
  private static void collectFromEdgeMap(
      Map<String, org.umetadata.schema.api.lineage.EsLineageData> edges,
      String columnFilter,
      ColumnMetadataCache metadataCache,
      Set<String> matchingNodes) {
    if (edges == null) {
    ...
    for (org.umetadata.schema.api.lineage.EsLineageData edge : edges.values()) {
      boolean matches =
          metadataCache != null
  ...
  private static void addEdgeEndpoints(
      org.umetadata.schema.api.lineage.EsLineageData edge, Set<String> nodes) {
    if (edge.getFromEntity() != null) {
  ...
  private static Map<String, org.umetadata.schema.api.lineage.EsLineageData>
      retainEdgesConnecting(
          Map<String, org.umetadata.schema.api.lineage.EsLineageData> edges,
          Set<String> includedNodes) {
    Map<String, org.umetadata.schema.api.lineage.EsLineageData> filtered = new HashMap<>();
    for (Map.Entry<String, org.umetadata.schema.api.lineage.EsLineageData> entry :
        edges.entrySet()) {
      org.umetadata.schema.api.lineage.EsLineageData edge = entry.getValue();
      String fromFqn =

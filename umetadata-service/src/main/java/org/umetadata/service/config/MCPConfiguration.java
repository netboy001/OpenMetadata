package org.umetadata.service.config;
...
public class MCPConfiguration {
  ...
  private String mcpServerName = "umetadata-mcp-server";
   ...
   * If not set, falls back to system settings (UMetadataBaseUrlConfiguration).
   ...
   * IMPORTANT: Add your UMetadata server's hosted URL to this list for production deployments.
   * Example: If UMetadata is hosted at https://om.company.com, add it to this list.
   */

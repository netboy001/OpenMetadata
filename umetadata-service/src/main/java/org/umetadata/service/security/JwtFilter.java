...
import static org.umetadata.service.security.SecurityUtil.findEmailFromClaims;
import static org.umetadata.service.security.SecurityUtil.findUserNameFromClaims;
import static org.umetadata.service.security.SecurityUtil.isBot;
import static org.umetadata.service.security.SecurityUtil.validateDomainEnforcement;
import static org.umetadata.service.security.SecurityUtil.validatePrincipalClaimsMapping;
import static org.umetadata.service.security.jwt.JWTTokenGenerator.ROLES_CLAIM;
import static org.umetadata.service.security.jwt.JWTTokenGenerator.TOKEN_TYPE;
import static org.umetadata.service.security.jwt.JWTTokenGenerator.getAlgorithmFromPublicKey;
...
public class JwtFilter implements ContainerRequestFilter {
  ...
  public void checkValidationsForToken(
    ...
    try {
      ...
      LOG.debug("Unable to read key id from token during UMetadata issuer check", e);
    }
    checkValidationsForToken(claims, tokenFromHeader, tokenKeyId, userName, impersonatedBy);
  }
  ...
  private boolean isInternallyIssuedToken(Map<String, Claim> claims, String tokenKeyId) {
    ...
    return SecurityUtil.isUMetadataIssuedToken(

...
import static org.umetadata.schema.api.teams.CreateUser.CreatePasswordType.ADMIN_CREATE;
import static org.umetadata.schema.auth.ChangePasswordRequest.RequestType.SELF;
import static org.umetadata.schema.auth.ChangePasswordRequest.RequestType.USER;
import static org.umetadata.schema.auth.TokenType.EMAIL_VERIFICATION;
import static org.umetadata.schema.auth.TokenType.PASSWORD_RESET;
import static org.umetadata.schema.entity.teams.AuthenticationMechanism.AuthType.BASIC;
import static org.umetadata.service.exception.CatalogExceptionMessage.EMAIL_EXISTS;
import static org.umetadata.service.exception.CatalogExceptionMessage.EMAIL_SENDING_ISSUE;
import static org.umetadata.service.exception.CatalogExceptionMessage.FAILED_SEND_EMAIL;
import static org.umetadata.service.exception.CatalogExceptionMessage.INCORRECT_OLD_PASSWORD;
import static org.umetadata.service.exception.CatalogExceptionMessage.INVALID_TOKEN;
import static org.umetadata.service.exception.CatalogExceptionMessage.INVALID_USERNAME_PASSWORD;
import static org.umetadata.service.exception.CatalogExceptionMessage.INVALID_USER_OR_PASSWORD;
import static org.umetadata.service.exception.CatalogExceptionMessage.MAX_FAILED_LOGIN_ATTEMPT;
import static org.umetadata.service.exception.CatalogExceptionMessage.PASSWORD_RESET_TOKEN_EXPIRED;
import static org.umetadata.service.exception.CatalogExceptionMessage.SELF_SIGNUP_DISABLED_MESSAGE;
import static org.umetadata.service.exception.CatalogExceptionMessage.SELF_SIGNUP_NOT_ENABLED;
import static org.umetadata.service.exception.CatalogExceptionMessage.TOKEN_EXPIRED;
import static org.umetadata.service.exception.CatalogExceptionMessage.TOKEN_EXPIRY_ERROR;
...
import static org.umetadata.service.util.UserUtil.getUser;
import static org.umetadata.service.util.email.EmailUtil.getSmtpSettings;
import static org.umetadata.service.util.email.EmailUtil.sendAccountStatus;
import static org.umetadata.service.util.email.TemplateConstants.APPLICATION_LOGIN_LINK;
import static org.umetadata.service.util.email.TemplateConstants.ENTITY;
import static org.umetadata.service.util.email.TemplateConstants.INVITE_CREATE_PASSWORD_TEMPLATE;
import static org.umetadata.service.util.email.TemplateConstants.INVITE_RANDOM_PASSWORD_TEMPLATE;
import static org.umetadata.service.util.email.TemplateConstants.PASSWORD;
import static org.umetadata.service.util.email.TemplateConstants.SUPPORT_URL;
import static org.umetadata.service.util.email.TemplateConstants.USERNAME;
...
import org.umetadata.service.util.TokenUtil;
import org.umetadata.service.util.email.EmailUtil;

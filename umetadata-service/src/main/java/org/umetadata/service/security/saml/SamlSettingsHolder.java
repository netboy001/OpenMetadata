...
import org.umetadata.catalog.type.SamlSecurityConfig;
...
public class SamlSettingsHolder {
  ...
  public void initDefaultSettings(UMetadataApplicationConfig catalogApplicationConfig)
    ...
    samlData.put(SettingsBuilder.UNIQUE_ID_PREFIX_PROPERTY_KEY, "UMETADATA_");

...
public class JdbiMetricsPlugin {
   ...
   */
  public static SqlLogger createMetricsSqlLogger(UMetadataMetrics metrics) {
  ...
  private static class MetricsSqlLogger implements SqlLogger {
    private final UMetadataMetrics metrics;

    public MetricsSqlLogger(UMetadataMetrics metrics) {

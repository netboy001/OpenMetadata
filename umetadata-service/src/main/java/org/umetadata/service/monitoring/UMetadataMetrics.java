...
import static org.umetadata.service.monitoring.MetricUtils.LATENCY_SLA_BUCKETS;
import static org.umetadata.service.monitoring.MetricUtils.normalizeUri;
...
/**
 * Central metrics class for UMetadata using Micrometer API.
 * This class provides a unified interface for recording various metrics
 * throughout the application.
 */
@Slf4j
@Singleton
public class UMetadataMetrics {
  ...
  @Inject
  public UMetadataMetrics(MeterRegistry meterRegistry) {

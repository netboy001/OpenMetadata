...
import org.umetadata.service.governance.workflows.elements.nodes.userTask.impl.CreateApprovalTaskImpl;
...
public class UserApprovalTask implements NodeInterface {
  ...
  private UserTask getUserTask(
    ...
    FlowableListener createUMetadataTaskListener =
        new FlowableListenerBuilder()
            .event("create")
    ...
    return new UserTaskBuilder()
        ...
        .addListener(createUMetadataTaskListener)

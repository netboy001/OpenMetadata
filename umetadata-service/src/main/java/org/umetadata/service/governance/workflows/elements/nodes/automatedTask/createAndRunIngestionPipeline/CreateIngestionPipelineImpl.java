...
import static org.umetadata.service.Entity.API_SERVICE;
import static org.umetadata.service.Entity.DASHBOARD_SERVICE;
import static org.umetadata.service.Entity.DATABASE_SERVICE;
import static org.umetadata.service.Entity.MESSAGING_SERVICE;
import static org.umetadata.service.Entity.METADATA_SERVICE;
import static org.umetadata.service.Entity.MLMODEL_SERVICE;
import static org.umetadata.service.Entity.PIPELINE_SERVICE;
import static org.umetadata.service.Entity.SEARCH_SERVICE;
import static org.umetadata.service.Entity.STORAGE_SERVICE;
...
import org.umetadata.schema.metadataIngestion.ApiServiceMetadataPipeline;
import org.umetadata.schema.metadataIngestion.DashboardServiceMetadataPipeline;
import org.umetadata.schema.metadataIngestion.DatabaseServiceAutoClassificationPipeline;
...
import org.umetadata.schema.metadataIngestion.MlmodelServiceMetadataPipeline;
import org.umetadata.schema.metadataIngestion.PipelineServiceMetadataPipeline;
import org.umetadata.schema.metadataIngestion.SearchServiceMetadataPipeline;
import org.umetadata.schema.metadataIngestion.SourceConfig;
import org.umetadata.schema.metadataIngestion.StorageServiceMetadataPipeline;
...
public class CreateIngestionPipelineImpl {
  ...
  private IngestionPipeline createIngestionPipeline(
      ...
      ServiceEntityInterface service,
      String displayName) {
    org.umetadata.schema.api.services.ingestionPipelines.CreateIngestionPipeline create =
        new org.umetadata.schema.api.services.ingestionPipelines.CreateIngestionPipeline()
            .withAirflowConfig(
    ...
    for (String ingestionPipelineStr :
      ...
      if (ingestionPipeline.getPipelineType().equals(pipelineType)
        ...
        UMetadataConnection uMetadataServerConnection =
            new UMetadataConnectionBuilder(repository.getUMetadataApplicationConfig())
                .build();

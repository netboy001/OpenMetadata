...
import org.umetadata.schema.api.lineage.openlineage.DatasourceFacet;
...
import org.umetadata.schema.api.lineage.openlineage.Owner;
import org.umetadata.schema.api.lineage.openlineage.OwnershipFacet;
...
import org.umetadata.schema.api.lineage.openlineage.SymlinkIdentifier;
import org.umetadata.schema.api.lineage.openlineage.SymlinksFacet;
...
public class OpenLineageEntityResolver {
  ...
  private String searchSchemaByName(String schemaName) {
    try {
      ...
      if (!schemas.isEmpty()) {
        ...
        if (schema instanceof org.umetadata.schema.entity.data.DatabaseSchema dbSchema) {
  ...
  private static class ListFilterByFqnSuffix extends org.umetadata.service.jdbi3.ListFilter {
  ...
  private static class ListFilterByFqnPattern extends org.umetadata.service.jdbi3.ListFilter {
  ...
  private static class ListFilterByJsonField extends org.umetadata.service.jdbi3.ListFilter {
    ...
    public String getCondition(String tableName) {
      ...
      if (Boolean.TRUE.equals(
          org.umetadata.service.resources.databases.DatasourceConfig.getInstance().isMySQL())) {
        fieldClause =
            String.format(

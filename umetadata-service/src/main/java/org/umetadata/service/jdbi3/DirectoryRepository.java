...
import static org.umetadata.service.Entity.DIRECTORY;
import static org.umetadata.service.Entity.FIELD_DOMAINS;
import static org.umetadata.service.Entity.FILE;
import static org.umetadata.service.Entity.SPREADSHEET;
...
import org.umetadata.service.resources.drives.DirectoryResource;
      ...
      if (children != null && !children.isEmpty()) {
        ...
        for (EntityReference child : children) {
          if (FILE.equals(child.getType())) {
            ...
            try {
              org.umetadata.schema.entity.data.File file =
            ...
            try {
              org.umetadata.schema.entity.data.Spreadsheet spreadsheet =
                  Entity.getEntity(child, "", Include.NON_DELETED);

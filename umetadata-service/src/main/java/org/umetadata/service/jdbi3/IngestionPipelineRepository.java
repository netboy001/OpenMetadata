...
import static org.umetadata.service.Entity.INGESTION_PIPELINE;
...
import org.umetadata.service.resources.services.ingestionpipelines.IngestionPipelineResource;
...
public class IngestionPipelineRepository extends EntityRepository<IngestionPipeline> {
  ...
  @Getter private final UMetadataApplicationConfig uMetadataApplicationConfig;

  public IngestionPipelineRepository(UMetadataApplicationConfig config) {
    super(
  ...
  protected void deployPipelineBeforeUpdate(IngestionPipeline ingestionPipeline) {
    ...
    UMetadataConnection uMetadataServerConnection =
        new org.umetadata.service.util.UMetadataConnectionBuilder(
  ...
  public void storeEntity(IngestionPipeline ingestionPipeline, boolean update) {
    ...
    if (secretsManager != null) {
      ...
      umetadataConnection =
          secretsManager.encryptUMetadataConnection(umetadataConnection, true);
    }
  ...
  public Response streamLogs(String pipelineFQN, UUID runId) {
    try {
      if (isS3LogStorageEnabled()) {
        ...
        org.umetadata.service.logstorage.S3LogStorage s3Storage =
            (org.umetadata.service.logstorage.S3LogStorage) logStorage;
                ...
                new jakarta.ws.rs.core.StreamingOutput() {
                  ...
                  public void write(java.io.OutputStream output) throws java.io.IOException {
                    try {
                      ...
                      org.umetadata.service.logstorage.S3LogStorage.LogStreamListener listener =
                          logLine -> {
                            try {
                              String event =

...
import org.umetadata.service.resources.apps.AppResource;
...
public class AppRepository extends EntityRepository<App> {
  ...
  public void prepare(App entity, boolean update) {
    ...
    if (entity.getAppConfiguration() != null && entity.getClassName() != null) {
      try {
        org.umetadata.service.apps.ApplicationHandler handler =
            org.umetadata.service.apps.ApplicationHandler.getInstance();
        if (handler != null) {
          App encryptedApp =
   ...
   * {@link org.umetadata.service.resources.mcp.McpUsageResource}'s page size (1000) the risk

...
import org.umetadata.schema.type.RecognizerException;
import org.umetadata.schema.type.RecognizerFeedback;
import org.umetadata.schema.type.Resolution;
...
public class RecognizerFeedbackRepository {
  ...
  public RecognizerFeedback get(UUID id) {
    ...
    if (json == null) {
      throw new org.umetadata.service.exception.EntityNotFoundException(
  ...
  public UUID getRecognizerIdFromTagLabel(String entityLink, String tagFQN) {
    try {
      ...
      org.umetadata.schema.EntityInterface entity =
          (org.umetadata.schema.EntityInterface)
  ...
  private void removeTagFromEntity(String entityLink, String tagFQN, String updatedBy) {
    try {
      ...
      org.umetadata.schema.EntityInterface originalEntity =
  ...
  private org.umetadata.schema.type.EntityReference getUserReference(String userName) {
    ...
    try {
      return Entity.getEntityReferenceByName(
          Entity.USER, userName, org.umetadata.schema.type.Include.NON_DELETED);

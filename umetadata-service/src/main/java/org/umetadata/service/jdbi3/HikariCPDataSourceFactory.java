...
public class HikariCPDataSourceFactory extends DataSourceFactory {
  ...
  @JsonProperty private String poolName = "umetadata-hikari-pool";
  ...
  private HikariConfig buildHikariConfig(String poolNameToUse) {
    ...
    // `leakDetectionThreshold` in umetadata.yaml.
  ...
  private void configurePostgreSQLProperties(Properties props) {
    ...
    // to 5 minutes. Real UMetadata queries should never run that long; jobs
    ...
    props.putIfAbsent("ApplicationName", "UMetadata");

...
import static org.umetadata.common.utils.CommonUtil.collectionOrDefault;
...
import static org.umetadata.csv.EntityCsv.getCsvDocumentation;
import static org.umetadata.service.Entity.API_ENDPOINT;
...
import static org.umetadata.service.Entity.FIELD_SERVICE;
import static org.umetadata.service.Entity.METRIC;
...
import static org.umetadata.service.search.SearchClient.REMOVE_LINEAGE_SCRIPT;
...
import org.umetadata.csv.CsvUtil;
import org.umetadata.schema.EntityInterface;
import org.umetadata.schema.api.lineage.AddLineage;
import org.umetadata.schema.api.lineage.EsLineageData;
import org.umetadata.schema.api.lineage.LineageDirection;
import org.umetadata.schema.api.lineage.RelationshipRef;
...
import org.umetadata.schema.type.MlFeature;
...
import org.umetadata.sdk.exception.CSVExportException;
      ...
      SearchLineageResult response =
          Entity.getSearchRepository()
              .searchLineageByEntityCount(
                  new org.umetadata.schema.api.lineage.EntityCountLineageRequest()
                      .withFqn(fqn)
                      ...
                      .withIncludeSourceFields(
                          org.umetadata.service.search.SearchUtils.getRequiredLineageFields(
                              includeSourceFields)));
      String jsonResponse = JsonUtils.pojoToJson(response);
      JsonNode rootNode = JsonUtils.readTree(jsonResponse);

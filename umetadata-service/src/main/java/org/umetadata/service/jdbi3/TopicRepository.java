...
import org.umetadata.service.resources.topics.TopicResource;
    ...
    var records =
        daoCollection
            ...
            .findFromBatch(
                ...
                org.umetadata.schema.type.Relationship.FOLLOWS.ordinal());
  ...
  private Map<UUID, EntityReference> batchFetchServices(List<Topic> topics) {
    ...
    var records =
        daoCollection
            ...
            .findFromBatch(
                entityListToStrings(topics),
                org.umetadata.schema.type.Relationship.CONTAINS.ordinal());

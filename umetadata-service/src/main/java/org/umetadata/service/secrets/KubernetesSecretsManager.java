...
import org.umetadata.service.exception.SecretsManagerUpdateException;
...
public class KubernetesSecretsManager extends ExternalSecretsManager {
  ...
  protected SecretsIdConfig builSecretsIdConfig() {
    ...
    // This way the DB stores names like "umetadata-bot-name-config-jwttoken"
  ...
  protected void storeSecret(String secretName, String secretValue) {
    ...
    try {
      ...
      labels.put("app", "umetadata");
      labels.put("managed-by", "umetadata-secrets-manager");

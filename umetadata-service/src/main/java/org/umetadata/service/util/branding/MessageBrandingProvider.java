...
package org.umetadata.service.util.branding;
 ...
 *
 * Register implementations via META-INF/services/org.umetadata.service.util.branding.MessageBrandingProvider.
 * The highest-priority provider wins (see MessageBrandingResolver).
 */
public interface MessageBrandingProvider {

  /** Display name of the product, e.g. "UMetadata" or "Collate". */

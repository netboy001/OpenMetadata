...
public final class RestUtil {
  public static final String CHANGE_CUSTOM_HEADER = "X-UMetadata-Change";
  ...
  public record PatchResponse<T>(Status status, T entity, EventType changeType) {
    public Response toResponse() {
      ...
      if (entity != null && entity instanceof org.umetadata.schema.EntityInterface) {
        EntityETag.addETagHeader(responseBuilder, (org.umetadata.schema.EntityInterface) entity);
      }

package org.umetadata.service.migration.utils.v150;
...
import org.umetadata.schema.dataInsight.custom.SummaryChartMetric;
...
public class MigrationUtil {
  ...
  public static void deleteLegacyDataInsightPipelines(
    ...
    String dataInsightsPipelineNameFqn = "UMetadata.UMetadata_dataInsight";
  ...
  public static void migrateTestCaseDimension(Handle handle, CollectionDAO collectionDAO) {
    String MYSQL_TEST_CASE_DIMENSION_QUERY =
        "SELECT json FROM test_definition WHERE JSON_CONTAINS(json -> '$.testPlatforms', '\"UMetadata\"')";
    String POSTGRES_TEST_CASE_DIMENSION_QUERY =
        "SELECT json FROM test_definition WHERE json -> 'testPlatforms' @> '\"UMetadata\"'";

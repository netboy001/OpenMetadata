package org.umetadata.service.migration.utils.v1114;
    ...
    try {
      ...
      if (potentialDataLoss) {
        LOG.warn(
            ...
            2. Restart the UMetadata server - this will re-seed default
               roles and policies from the built-in seed data
            3. Custom roles/policies will need to be recreated manually

            For more information, see the UMetadata documentation.
            ============================================================
            """,
            warnings);
      } else {

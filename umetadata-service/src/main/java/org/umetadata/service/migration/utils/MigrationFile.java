package org.umetadata.service.migration.utils;
...
public class MigrationFile implements Comparable<MigrationFile> {
  ...
  public final UMetadataApplicationConfig uMetadataApplicationConfig;
  ...
  public static final String DEFAULT_MIGRATION_PROCESS_CLASS =
      "org.umetadata.service.migration.api.MigrationProcessImpl";
  ...
  public String getMigrationProcessClassName() {
    String clazzName =
        String.format(
            "org.umetadata.service.migration.%s.%s.Migration",

package org.umetadata.service.notifications.channels.email;
...
import org.umetadata.service.notifications.channels.HtmlSanitizer;
...
import org.umetadata.service.util.resourcepath.providers.EmailEnvelopeResourcePathProvider;
...
public class EmailHtmlRenderer implements ChannelRenderer {
  ...
  private String applyEmailEnvelope(String htmlContent) {
    ...
    // Hardcode logo URL for UMetadata (can be overridden by commercial version)

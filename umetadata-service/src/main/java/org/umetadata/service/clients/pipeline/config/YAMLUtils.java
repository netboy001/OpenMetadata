...
public class YAMLUtils {
   ...
   */
  public static String stringifiedOMWorkflowConfig(UMetadataWorkflowConfig workflowConfig)
    ...
    try {
      ...
      throw new WorkflowBuildException(
          String.format(
              "JSON Processing error converting UMetadataWorkflowConfig to string due to [%s]",
              exc.getMessage()));
    }
  }

  public static String stringifiedOMAppConfig(UMetadataAppConfig applicationConfig)
      throws WorkflowBuildException {
    try {
      ...
      throw new WorkflowBuildException(
          String.format(
              "JSON Processing error converting UMetadataApplicationConfig to string due to [%s]",
              exc.getMessage()));
    }
  }

...
package org.umetadata.service.workflows.searchIndex;

import static org.umetadata.service.apps.bundles.searchIndex.SearchIndexApp.TIME_SERIES_ENTITIES;
...
public class ReindexingUtil {
  ...
  public static List<String> getSearchIndexFields(String entityType) {
    ...
    org.umetadata.service.search.SearchRepository repo =

...
import static org.umetadata.schema.entity.teams.AuthenticationMechanism.AuthType.JWT;
...
import static org.umetadata.service.secrets.ExternalSecretsManager.NULL_SECRET_STRING;
import static org.umetadata.service.security.jwt.JWTTokenGenerator.getExpiryDate;
import static org.umetadata.service.util.UserUtil.getRoleListFromUser;
import static org.umetadata.service.util.UserUtil.getRolesFromAuthorizationToken;
import static org.umetadata.service.util.UserUtil.getUser;
import static org.umetadata.service.util.UserUtil.reSyncUserRolesFromToken;
import static org.umetadata.service.util.UserUtil.validateAndGetRolesRef;
...
import org.umetadata.schema.auth.EmailRequest;
...
import org.umetadata.schema.auth.LogoutRequest;
...
import org.umetadata.service.resources.Collection;
...
import org.umetadata.service.security.CatalogPrincipal;
import org.umetadata.service.security.auth.AuthenticatorHandler;
import org.umetadata.service.security.auth.BotTokenCache;
...
import org.umetadata.service.security.auth.UserTokenCache;
...
import org.umetadata.service.security.saml.JwtTokenCacheManager;
...
import org.umetadata.service.util.email.TemplateConstants;
...
@Tag(
    name = "Users",
    description =
        "A `User` represents a user of UMetadata. A user can be part of 0 or more teams. A special type of user called Bot is used for automation. A user can be an owner of zero or more data assets. A user can also follow zero or more data assets.")
...
public class UserResource extends EntityResource<User, UserRepository> {
  ...
  @Override
  public void initialize(UMetadataApplicationConfig config) throws IOException {

...
import org.umetadata.service.jdbi3.QueryRepository;
...
public class QueryResource extends EntityResource<Query, QueryRepository> {
  ...
  @Operation(
      ...
      description =
          "Create or update multiple queries in a single operation. "
              + "Returns a BulkOperationResult with success/failure details for each query.",
      responses = {
        @ApiResponse(
            responseCode = "200",
  ...
  public Response bulkCreateOrUpdate(
      ...
      List<CreateQuery> createRequests) {

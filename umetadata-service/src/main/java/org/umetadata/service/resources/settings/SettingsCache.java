...
package org.umetadata.service.resources.settings;

import static org.umetadata.schema.settings.SettingsType.ASSET_CERTIFICATION_SETTINGS;
...
import static org.umetadata.schema.settings.SettingsType.CUSTOM_UI_THEME_PREFERENCE;
import static org.umetadata.schema.settings.SettingsType.EMAIL_CONFIGURATION;
import static org.umetadata.schema.settings.SettingsType.ENTITY_RULES_SETTINGS;
import static org.umetadata.schema.settings.SettingsType.LINEAGE_SETTINGS;
import static org.umetadata.schema.settings.SettingsType.LOGIN_CONFIGURATION;
import static org.umetadata.schema.settings.SettingsType.MCP_CONFIGURATION;
import static org.umetadata.schema.settings.SettingsType.OPEN_LINEAGE_SETTINGS;
import static org.umetadata.schema.settings.SettingsType.U_METADATA_BASE_URL_CONFIGURATION;
import static org.umetadata.schema.settings.SettingsType.SCIM_CONFIGURATION;
import static org.umetadata.schema.settings.SettingsType.SEARCH_SETTINGS;
import static org.umetadata.schema.settings.SettingsType.WORKFLOW_SETTINGS;
...
import org.umetadata.schema.api.lineage.LineageLayer;
...
import org.umetadata.service.resources.system.SearchSettingsHandler;
...
public class SettingsCache {
  ...
  private static void createDefaultConfiguration(UMetadataApplicationConfig applicationConfig) {
    ...
    Settings storedUMetadataBaseUrlConfiguration =
        Entity.getSystemRepository()
            .getConfigWithKey(U_METADATA_BASE_URL_CONFIGURATION.toString());
    if (storedUMetadataBaseUrlConfiguration == null) {
      Settings setting =
          new Settings()
              .withConfigType(U_METADATA_BASE_URL_CONFIGURATION)
              .withConfigValue(
              ...
              .withConfigValue(
                  new LineageSettings()
                      ...
                      .withGraphPerformanceConfig(
                          new org.umetadata.schema.api.lineage.GraphPerformanceConfig()
  ...
  static class SettingsLoader extends CacheLoader<String, Settings> {
    ...
    public @NonNull Settings load(@CheckForNull String settingsName) {
      ...
      switch (SettingsType.fromValue(settingsName)) {
        ...
        case U_METADATA_BASE_URL_CONFIGURATION -> {

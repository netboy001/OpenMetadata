...
import org.umetadata.catalog.type.IdentityProviderConfig;
...
import org.umetadata.service.clients.pipeline.PipelineServiceAPIClientConfig;
...
import org.umetadata.service.security.jwt.JWKSResponse;
...
public class ConfigResource {
  ...
  public Map<String, Object> getConfig() {
    ...
    config.put("basePath", uMetadataApplicationConfig.getBasePath());

    // Add RDF configuration
    if (uMetadataApplicationConfig.getRdfConfiguration() != null) {
      config.put("rdfEnabled", uMetadataApplicationConfig.getRdfConfiguration().getEnabled());
    } else {
  ...
  public AuthorizerConfiguration getAuthorizerConfig() {
    ...
    AuthorizerConfiguration yamlConfig = uMetadataApplicationConfig.getAuthorizerConfiguration();
    if (yamlConfig != null) {
  ...
  public PipelineServiceAPIClientConfig getPipelineServiceConfig() {
    ...
    if (uMetadataApplicationConfig.getPipelineServiceClientConfiguration() != null) {
      pipelineServiceClientConfigForAPI.setApiEndpoint(
          uMetadataApplicationConfig.getPipelineServiceClientConfiguration().getApiEndpoint());
    }

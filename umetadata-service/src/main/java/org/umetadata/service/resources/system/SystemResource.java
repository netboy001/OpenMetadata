...
import org.umetadata.service.exception.SystemSettingsException;
...
import org.umetadata.service.rules.LogicOps;
...
public class SystemResource {
  ...
  private UMetadataApplicationConfig applicationConfig;
  ...
  @Operation(
      ...
      description = "Get a list of all UMetadata settings",
      responses = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description = "Get a UMetadata Settings",
      responses = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      summary = "Validate the UMetadata deployment",
      description =

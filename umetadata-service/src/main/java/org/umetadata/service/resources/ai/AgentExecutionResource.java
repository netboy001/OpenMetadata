...
import org.umetadata.service.jdbi3.AgentExecutionRepository;
...
import org.umetadata.service.security.policyevaluator.AgentExecutionContext;
...
public class AgentExecutionResource
  ...
  public ResultList<AgentExecution> list(
    ...
    ListFilter filter = new ListFilter(org.umetadata.schema.type.Include.ALL);
    if (agentId != null) {

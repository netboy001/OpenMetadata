...
import org.umetadata.service.jdbi3.APIEndpointRepository;
...
public class APIEndpointResource extends EntityResource<APIEndpoint, APIEndpointRepository> {
  ...
  public ResultList<APIEndpoint> list(
      ...
      @Parameter(
              ...
              schema = @Schema(type = "string", example = "UMetadata API Service"))
          @QueryParam("service")
          String serviceParam,
      @Parameter(
  ...
  @Path("/bulk")
  @Operation(
      operationId = "bulkCreateOrUpdateAPIEndpoints",
      summary = "Bulk create or update API endpoints",
      description =
          "Create or update multiple API endpoints in a single operation. "
              + "Returns a BulkOperationResult with success/failure details for each API endpoint.",
      responses = {
        @ApiResponse(
            responseCode = "200",

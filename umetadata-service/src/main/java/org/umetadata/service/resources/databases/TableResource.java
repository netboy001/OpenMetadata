...
import static org.umetadata.service.search.SearchUtils.getRequiredEntityRelationshipFields;
...
public class TableResource extends EntityResource<Table, TableRepository> {
  ...
  public static class TableColumnList extends ResultList<org.umetadata.schema.type.Column> {
    /* Required for serde */
  }
  ...
  public TableColumnList getTableColumns(
    ...
    ResultList<org.umetadata.schema.type.Column> result =

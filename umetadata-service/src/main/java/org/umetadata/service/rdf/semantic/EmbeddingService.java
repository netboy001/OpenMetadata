package org.umetadata.service.rdf.semantic;
...
public class EmbeddingService {
  ...
  private EmbeddingService(UMetadataApplicationConfig config) {
  ...
  public static EmbeddingService getInstance(UMetadataApplicationConfig config) {
    if (INSTANCE == null) {
      synchronized (EmbeddingService.class) {
        if (INSTANCE == null) {

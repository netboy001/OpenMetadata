package org.umetadata.service.rdf.reasoning;
...
public class InferenceEngine {
  ...
  public enum ReasoningLevel {
    ...
    CUSTOM // Custom rules for UMetadata-specific inference
  }
  ...
  /**
   * Define custom inference rules for UMetadata. Note: Jena rules require full URIs, not
   * prefixed names.
   */

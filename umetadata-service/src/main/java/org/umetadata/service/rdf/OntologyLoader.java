...
public class OntologyLoader {
  ...
  public void loadOntologies() {
    ...
    try {
      ...
      loadOntologyFile("umetadata.ttl", ONTOLOGY_GRAPH);

      // Load SHACL shapes
      loadShapesFile("umetadata-shapes.ttl", SHAPES_GRAPH);

      LOG.info("Successfully loaded UMetadata ontologies and shapes");
    } catch (Exception e) {

package org.umetadata.service.rdf;
...
import org.umetadata.service.rdf.storage.RdfStorageFactory;
import org.umetadata.service.rdf.storage.RdfStorageInterface;
import org.umetadata.service.rdf.translator.JsonLdTranslator;
...
public class RdfRepository {
  ...
  private void loadOntologies() {
    try {
      ...
      if (!loader.areOntologiesLoaded()) {
        LOG.info("Loading UMetadata ontologies into RDF store");
        loader.loadOntologies();
      } else {
        LOG.info("UMetadata ontologies already loaded");
      }
    } catch (Exception e) {
  ...
  public String executeSparqlQueryWithInference(
    ...
    try {
      ...
      org.umetadata.service.rdf.reasoning.InferenceEngine.ReasoningLevel level =
          switch (inferenceLevel.toLowerCase()) {
            case "rdfs" -> org.umetadata.service.rdf.reasoning.InferenceEngine.ReasoningLevel
                .RDFS;
            case "owl" -> org.umetadata.service.rdf.reasoning.InferenceEngine.ReasoningLevel
                .OWL_LITE;
            case "custom" -> org.umetadata.service.rdf.reasoning.InferenceEngine.ReasoningLevel
                .CUSTOM;
            default -> org.umetadata.service.rdf.reasoning.InferenceEngine.ReasoningLevel.NONE;
          };

      if (level == org.umetadata.service.rdf.reasoning.InferenceEngine.ReasoningLevel.NONE) {
      ...
      org.umetadata.service.rdf.reasoning.InferenceEngine engine =
          new org.umetadata.service.rdf.reasoning.InferenceEngine(level);

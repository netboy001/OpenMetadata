...
package org.umetadata.service.events.scheduled;

import static org.umetadata.service.apps.bundles.changeEvent.AbstractEventConsumer.ALERT_INFO_KEY;
import static org.umetadata.service.apps.bundles.changeEvent.AbstractEventConsumer.ALERT_OFFSET_KEY;
import static org.umetadata.service.events.subscription.AlertUtil.getStartingOffset;
...
import org.umetadata.schema.api.events.EventSubscriptionDiagnosticInfo;
import org.umetadata.schema.api.events.EventsRecord;
import org.umetadata.schema.entity.events.EventSubscription;
import org.umetadata.schema.entity.events.EventSubscriptionOffset;
import org.umetadata.schema.entity.events.FailedEventResponse;
import org.umetadata.schema.entity.events.FilteringRules;
...
import org.umetadata.service.audit.AuditLogConsumer;
...
import org.umetadata.service.util.DIContainer;
...
public class EventSubscriptionScheduler {
  ...
  private EventSubscriptionScheduler(
      ...
      UMetadataConnectionBuilder uMetadataConnectionBuilder)
    ...
    di.registerResource(UMetadataConnectionBuilder.class, uMetadataConnectionBuilder);
  ...
  public static void initialize(UMetadataApplicationConfig uMetadataApplicationConfig) {
    if (!initialized) {
      try {
        instance =
            new EventSubscriptionScheduler(
                ...
                new UMetadataConnectionBuilder(uMetadataApplicationConfig));
        initialized = true;

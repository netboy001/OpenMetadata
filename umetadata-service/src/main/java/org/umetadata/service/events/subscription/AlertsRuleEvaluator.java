...
import static org.umetadata.schema.type.Function.ParameterType.ALL_INDEX_ELASTIC_SEARCH;
import static org.umetadata.schema.type.Function.ParameterType.NOT_REQUIRED;
import static org.umetadata.schema.type.Function.ParameterType.READ_FROM_PARAM_CONTEXT;
import static org.umetadata.schema.type.Function.ParameterType.READ_FROM_PARAM_CONTEXT_PER_ENTITY;
import static org.umetadata.schema.type.Function.ParameterType.SPECIFIC_INDEX_ELASTIC_SEARCH;
...
import static org.umetadata.service.Entity.THREAD;
...
import org.umetadata.schema.Function;
...
public class AlertsRuleEvaluator {
  ...
  public boolean matchPipelineState(List<String> pipelineState) {
    ...
    for (FieldChange fieldChange : changeEvent.getChangeDescription().getFieldsUpdated()) {
      if (fieldChange.getName().equals("pipelineStatus") && fieldChange.getNewValue() != null) {
        org.umetadata.schema.entity.data.PipelineStatus pipelineStatus =
            JsonUtils.convertValue(
                fieldChange.getNewValue(),
                org.umetadata.schema.entity.data.PipelineStatus.class);

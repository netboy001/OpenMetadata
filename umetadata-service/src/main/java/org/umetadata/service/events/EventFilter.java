...
import org.umetadata.service.util.ParallelStreamUtil;
...
public class EventFilter implements ContainerResponseFilter {
  ...
  public EventFilter(UMetadataApplicationConfig config) {
    this.forkJoinPool =
        new ForkJoinPool(
  ...
  private void registerEventHandlers(UMetadataApplicationConfig config) {

...
UMetadata uses **two different Quartz schedulers** with distinct responsibilities:
...
In HA deployments with multiple UMetadata instances, the following race condition can occur:

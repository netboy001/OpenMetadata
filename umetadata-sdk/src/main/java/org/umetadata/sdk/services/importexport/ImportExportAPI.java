package org.umetadata.sdk.services.importexport;
...
public class ImportExportAPI {
  ...
  public String exportEntities(String entityType) throws UMetadataException {
  ...
  public String importEntities(String entityType, String data) throws UMetadataException {
  ...
  public String exportDatabase(String databaseId) throws UMetadataException {
    return httpClient.executeForString(
        HttpMethod.GET, String.format("/v1/databases/%s/export", databaseId), null);
  }

  public String exportGlossary(String glossaryId) throws UMetadataException {
    return httpClient.executeForString(
        HttpMethod.GET, String.format("/v1/glossaries/%s/export", glossaryId), null);
  }

  public String importGlossary(String glossaryId, String data) throws UMetadataException {
    RequestOptions options =
  ...
  public String getImportStatus(String jobId) throws UMetadataException {
    return httpClient.executeForString(
        HttpMethod.GET, String.format("/v1/import/status/%s", jobId), null);
  }

  public String getExportStatus(String jobId) throws UMetadataException {
    return httpClient.executeForString(

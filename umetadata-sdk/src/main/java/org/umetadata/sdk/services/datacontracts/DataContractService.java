package org.umetadata.sdk.services.datacontracts;
...
public class DataContractService extends EntityServiceBase<DataContract> {
  ...
  public DataContract create(CreateDataContract request) throws UMetadataException {
    return httpClient.execute(HttpMethod.POST, basePath, request, DataContract.class);
  }

  public DataContract createOrUpdate(CreateDataContract request) throws UMetadataException {
   ...
   */
  public DataContract getByEntityId(UUID entityId, String entityType) throws UMetadataException {
   ...
   */
  public DataContractResult validate(UUID contractId) throws UMetadataException {
    return httpClient.execute(
   ...
   */
  public DataContractResult getLatestResult(UUID contractId) throws UMetadataException {
    return httpClient.execute(
        HttpMethod.GET,
   ...
   */
  public void deleteResult(UUID contractId, Long timestamp) throws UMetadataException {
   ...
   */
  public void deleteResultsBefore(UUID contractId, Long timestamp) throws UMetadataException {
    httpClient.executeForString(
   ...
   */
  public ODCSDataContract exportToODCS(UUID contractId) throws UMetadataException {
    return httpClient.execute(
   ...
   */
  public ODCSDataContract exportToODCSByFqn(String fqn) throws UMetadataException {
    return httpClient.execute(
   ...
   */
  public String exportToODCSYaml(UUID contractId) throws UMetadataException {
  ...
  public DataContract createOrUpdateFromODCS(
      ODCSDataContract odcs, UUID entityId, String entityType) throws UMetadataException {
  ...
  public DataContract createOrUpdateFromODCSYaml(
      String yamlContent, UUID entityId, String entityType) throws UMetadataException {
   ...
   */
  public String exportToODCSYamlByFqn(String fqn) throws UMetadataException {
    RequestOptions options = RequestOptions.builder().header("Accept", "application/yaml").build();
    return httpClient.executeForString(
   ...
   * validation results including entity errors, constraint errors, and schema field mismatches.
   */
  public ContractValidation validateContractYaml(String yamlContent) throws UMetadataException {
    RequestOptions options =

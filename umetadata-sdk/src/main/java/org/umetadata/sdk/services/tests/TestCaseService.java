...
import org.umetadata.schema.api.tests.CreateLogicalTestCases;
...
public class TestCaseService extends EntityServiceBase<TestCase> {
  ...
  public TestCase create(CreateTestCase request) throws UMetadataException {
    return httpClient.execute(HttpMethod.POST, basePath, request, TestCase.class);
  }

  // Create or update using CreateTestCase request
  public TestCase upsert(CreateTestCase request) throws UMetadataException {
   ...
   */
  public List<TestCase> createMany(List<CreateTestCase> requests) throws UMetadataException {
    try {
      String response =
      ...
      throw new UMetadataException("Failed to create test cases: " + e.getMessage(), e);
    }
  }
   ...
   */
  public org.umetadata.schema.tests.TestSuite addToLogicalTestSuite(
      CreateLogicalTestCases request) throws UMetadataException {
    return httpClient.execute(
        HttpMethod.PUT,
        basePath + "/logicalTestCases",
        request,
        org.umetadata.schema.tests.TestSuite.class);
  }
   ...
   */
  public TableData getFailedRowsSample(String testCaseId) throws UMetadataException {
    return httpClient.execute(
   ...
   * @return The updated test case
   */
  public TestCase deleteFailedRowsSample(String testCaseId) throws UMetadataException {
    return httpClient.execute(
   ...
   * @return The updated test case
   */
  public TestCase setInspectionQuery(String testCaseId, String query) throws UMetadataException {
    ...
    try {
      ...
      throw new UMetadataException("Failed to set inspection query: " + e.getMessage(), e);
    }
  }
   ...
   */
  @Override
  public TestCase update(String id, TestCase entity, String etag) throws UMetadataException {
    try {

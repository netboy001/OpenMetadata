package org.umetadata.sdk.services;
...
import org.umetadata.sdk.models.AllModels;
...
public abstract class EntityServiceBase<T> {
  ...
  private T fetchEntity(String id, String fields) throws UMetadataException {
    if (fields != null) {
  ...
  public T get(String id, String fields, String include) throws UMetadataException {
  ...
  protected ListResponse<T> deserializeListResponse(String json) throws UMetadataException {
    ...
    try {
      ...
      throw new UMetadataException("Failed to deserialize list response: " + e.getMessage(), e);
    }
  }
   ...
   */
  public T restore(UUID id) throws UMetadataException {
   ...
   * Restore a soft-deleted entity
   */
  public T restore(String id) throws UMetadataException {
    org.umetadata.schema.api.data.RestoreEntity restoreEntity =
        new org.umetadata.schema.api.data.RestoreEntity();
   ...
   * @throws UMetadataException if export fails
   */
  public String exportCsv(String name) throws UMetadataException {
   ...
   * @throws UMetadataException if export fails
   */
  public String exportCsv(String name, boolean recursive) throws UMetadataException {
   ...
   * @throws UMetadataException if export fails
   */
  public String exportCsvAsync(String name) throws UMetadataException {
   ...
   * @throws UMetadataException if export fails
   */
  public String exportCsvAsync(String name, boolean recursive) throws UMetadataException {
   ...
   * @throws UMetadataException if import fails
   */
  public String importCsv(String name, String csvData) throws UMetadataException {
   ...
   * @throws UMetadataException if import fails
   */
  public String importCsvAsync(String name, String csvData) throws UMetadataException {
   ...
   */
  public EntityHistory getVersionList(UUID id) throws UMetadataException {
   ...
   * @throws UMetadataException if request fails
   */
  public EntityHistory getVersionList(String id) throws UMetadataException {
   ...
   * @throws UMetadataException if request fails
   */
  public T getVersion(UUID id, Double version) throws UMetadataException {
   ...
   * @throws UMetadataException if request fails
   */
  public T getVersion(String id, Double version) throws UMetadataException {
   ...
   * @throws UMetadataException if request fails
   */
  public T getVersion(UUID id, Double version, String fields) throws UMetadataException {
   ...
   * @throws UMetadataException if request fails
   */
  public T getVersion(String id, Double version, String fields) throws UMetadataException {
    String path = basePath + "/" + id + "/versions/" + version.toString();
    RequestOptions options = RequestOptions.builder().queryParam("fields", fields).build();

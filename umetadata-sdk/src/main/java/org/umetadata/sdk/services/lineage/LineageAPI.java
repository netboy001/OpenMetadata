package org.umetadata.sdk.services.lineage;
...
public class LineageAPI {
  ...
  public String getLineage(String entity) throws UMetadataException {
    return getLineage(entity, null, null);
  }

  public String addLineage(Object lineageRequest) throws UMetadataException {
    return httpClient.executeForString(HttpMethod.PUT, "/v1/lineage", lineageRequest);
  }

  public String deleteLineage(String fromEntity, String toEntity) throws UMetadataException {
    ...
    if (fromParts.length != 2 || toParts.length != 2) {
      throw new UMetadataException("Invalid entity format. Expected 'entityType:entityId'");
    }
  ...
  public String getEntityLineage(String entityType, String entityId) throws UMetadataException {

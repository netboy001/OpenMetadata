...
public class TestCaseResultService {
   ...
   */
  public ListResponse<TestCaseResult> get(String testCaseFqn) throws UMetadataException {
   ...
   */
  public ListResponse<TestCaseResult> searchList(ListParams params) throws UMetadataException {
   ...
   */
  public ListResponse<TestCaseResult> searchLatest(ListParams params) throws UMetadataException {
   ...
   */
  public void delete(String testCaseFqn, Long timestamp) throws UMetadataException {
    httpClient.execute(
  ...
  public static class ResultBuilder {
    ...
    private org.umetadata.schema.tests.type.TestCaseStatus testCaseStatus;
    ...
    public ResultBuilder status(org.umetadata.schema.tests.type.TestCaseStatus status) {
      this.testCaseStatus = status;
      return this;
    }

    public ResultBuilder passed() {
      this.testCaseStatus = org.umetadata.schema.tests.type.TestCaseStatus.Success;
      return this;
    }

    public ResultBuilder failed() {
      this.testCaseStatus = org.umetadata.schema.tests.type.TestCaseStatus.Failed;
      return this;
    }

    public ResultBuilder aborted() {
      this.testCaseStatus = org.umetadata.schema.tests.type.TestCaseStatus.Aborted;
      return this;
    }
    ...
    public TestCaseResult create() throws UMetadataException {

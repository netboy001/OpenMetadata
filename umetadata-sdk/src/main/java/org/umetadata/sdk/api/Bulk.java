 ...
 *
 * This provides a builder-style fluent interface for performing bulk operations in UMetadata.
 *
 * Usage Examples:
 * <pre>
 * // Bulk load entities
...
public final class Bulk {
  ...
  public static class BulkImporter {
    ...
    BulkImporter(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class BulkExporter {
    ...
    BulkExporter(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class BulkTagUpdater {
    ...
    BulkTagUpdater(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class BulkDeleter {
    ...
    BulkDeleter(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class BulkOwnerChanger {
    ...
    BulkOwnerChanger(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class BulkPatcher {
    ...
    BulkPatcher(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class BulkGetter {
    ...
    BulkGetter(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class BulkValidator {
    ...
    BulkValidator(UMetadataClient client) {
      this.client = client;
    }

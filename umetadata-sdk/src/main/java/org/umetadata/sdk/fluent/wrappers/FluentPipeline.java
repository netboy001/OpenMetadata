...
public class FluentPipeline {
   ...
   */
  public FluentPipeline withOwner(org.umetadata.schema.entity.teams.User user) {
   ...
   */
  public FluentPipeline withOwner(org.umetadata.schema.entity.teams.Team team) {
    EntityReference ownerRef =
        new EntityReference()
            .withId(team.getId())
            .withType("team")

...
import org.umetadata.sdk.fluent.collections.DatabaseSchemaCollection;
 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.DatabaseSchemas.*;
 *
 * // Create
...
public final class DatabaseSchemas {
  ...
  public static org.umetadata.sdk.models.ListResponse<DatabaseSchema> list(
  ...
  public static class DatabaseSchemaCreator {
    ...
    DatabaseSchemaCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class DatabaseSchemaFinder {
    ...
    DatabaseSchemaFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    DatabaseSchemaFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class DatabaseSchemaDeleter {
    ...
    DatabaseSchemaDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class DatabaseSchemaLister {
    ...
    DatabaseSchemaLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentDatabaseSchema {
    ...
    public FluentDatabaseSchema(DatabaseSchema databaseSchema, UMetadataClient client) {
  ...
  public static class CsvExporter
    ...
    CsvExporter(UMetadataClient client, String databaseSchemaName) {
  ...
  public static class CsvImporter
      extends org.umetadata.sdk.fluent.common.CsvOperations.BaseCsvImporter {
    private final String databaseSchemaName;

    CsvImporter(UMetadataClient client, String databaseSchemaName) {
      super(client, "databaseSchema");
      this.databaseSchemaName = databaseSchemaName;
    }

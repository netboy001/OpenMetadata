package org.umetadata.sdk.fluent.common;
...
import org.umetadata.sdk.websocket.WebSocketManager;
...
public class CsvOperations {
  ...
  public abstract static class BaseCsvExporter {
    ...
    protected final UMetadataClient client;
    ...
    protected BaseCsvExporter(UMetadataClient client, String entityName) {
      this.client = client;
  ...
  public abstract static class BaseCsvImporter {
    ...
    protected BaseCsvImporter(UMetadataClient client, String entityName) {
      this.client = client;
      this.entityName = entityName;
    }

...
import org.umetadata.schema.entity.ai.PolicyType;
...
public final class AIGovernancePolicies {
  ...
  public static class AIGovernancePolicyCreator {
    ...
    AIGovernancePolicyCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class AIGovernancePolicyFinder {
    ...
    AIGovernancePolicyFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    AIGovernancePolicyFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class AIGovernancePolicyDeleter {
    ...
    AIGovernancePolicyDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class AIGovernancePolicyLister {
    ...
    AIGovernancePolicyLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentAIGovernancePolicy {
    ...
    public FluentAIGovernancePolicy(AIGovernancePolicy entity, UMetadataClient client) {
      this.entity = entity;
      this.client = client;
    }

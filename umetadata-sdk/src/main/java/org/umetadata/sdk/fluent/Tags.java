 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.Tags.*;
 *
 * // Create
 * Tag tag = create()
 *     .name("tag_name")
...
public final class Tags {
  ...
  public static class TagCreator {
    ...
    TagCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class TagFinder {
    ...
    TagFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    TagFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class TagDeleter {
    ...
    TagDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class TagLister {
    ...
    TagLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentTag {
    ...
    public FluentTag(Tag tag, UMetadataClient client) {
      this.tag = tag;
      this.client = client;
    }

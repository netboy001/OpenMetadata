 ...
 *
 * <p>This provides a builder-style fluent interface for searching UMetadata entities.
 *
 * <p>Usage Examples:
 *
 * <pre>
...
public final class SearchAPI {
  ...
  private SearchAPI() {} // Prevent instantiation
  ...
  private static UMetadataClient getClient() {
    if (defaultClient == null) {
      throw new IllegalStateException(
          "Client not initialized. Call SearchAPI.setDefaultClient() first.");
    }
  ...
  public static class SearchBuilder {
    ...
    SearchBuilder(UMetadataClient client, String query) {
      this.client = client;
      this.query = query;
    }
  ...
  public static class AggregationBuilder {
    ...
    AggregationBuilder(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class SuggestBuilder {
    ...
    SuggestBuilder(UMetadataClient client, String prefix) {
      this.client = client;
      this.prefix = prefix;
    }
  ...
  public static class FacetedSearchBuilder {
    ...
    FacetedSearchBuilder(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class ReindexOperation {
    ...
    ReindexOperation(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class SearchResults {
    ...
    SearchResults(String rawResults, UMetadataClient client) {

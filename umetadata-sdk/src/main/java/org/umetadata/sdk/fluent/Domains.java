 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.Domains.*;
 *
 * // Create
...
public final class Domains {
  ...
  public static org.umetadata.sdk.models.ListResponse<Domain> list(
  ...
  public static class DomainCreator {
    ...
    DomainCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class DomainFinder {
    ...
    DomainFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    DomainFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class DomainDeleter {
    ...
    DomainDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class DomainLister {
    ...
    DomainLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentDomain {
    ...
    public FluentDomain(Domain domain, UMetadataClient client) {
      this.domain = domain;
      this.client = client;
    }

 ...
 *
 * <pre>
 * import static org.umetadata.sdk.fluent.DataContracts.*;
 *
...
public final class DataContracts {
  ...
  public static class DataContractCreator {
    ...
    DataContractCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class DataContractFinder {
    ...
    DataContractFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    DataContractFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
    ...
    DataContractFinder(UMetadataClient client, UUID entityId, String entityType) {
      this.client = client;
  ...
  public static class ContractOperations {
    ...
    ContractOperations(UMetadataClient client, String contractId) {
      this.client = client;
  ...
  public static class ResultBuilder {
    ...
    ResultBuilder(UMetadataClient client, String contractId) {
      this(client, contractId, null);
    }

    ResultBuilder(UMetadataClient client, String contractId, String contractFqn) {
      this.client = client;
      this.contractId = contractId;
  ...
  public static class DataContractDeleter {
    ...
    DataContractDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class DataContractLister {
    ...
    DataContractLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentDataContract {
    ...
    public FluentDataContract(DataContract contract, UMetadataClient client) {

...
public final class Apps {
  ...
  public static class AppInstaller {
    ...
    AppInstaller(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class AppFinder {
    ...
    AppFinder(UMetadataClient client, String identifier, boolean isByName) {
      this.client = client;
  ...
  public static class AppTrigger {
    ...
    AppTrigger(UMetadataClient client, String appName) {
      this.client = client;

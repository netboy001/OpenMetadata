...
import org.umetadata.sdk.fluent.collections.TeamCollection;
 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.Teams.*;
 *
 * // Create
 * Team team = create()
 *     .name("team_name")
...
public final class Teams {
  ...
  public static org.umetadata.sdk.models.ListResponse<Team> list(
  ...
  public static class TeamCreator {
    ...
    TeamCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class TeamFinder {
    ...
    TeamFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    TeamFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class TeamDeleter {
    ...
    TeamDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class TeamLister {
    ...
    TeamLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentTeam {
    ...
    public FluentTeam(Team team, UMetadataClient client) {
      this.team = team;
      this.client = client;
    }

...
import org.umetadata.sdk.fluent.collections.UserCollection;
 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.Users.*;
 *
 * // Create
 * User user = create()
 *     .name("user_name")
...
public final class Users {
  ...
  public static org.umetadata.sdk.models.ListResponse<User> list(
  ...
  public static class UserCreator {
    ...
    UserCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class UserFinder {
    ...
    UserFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    UserFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class UserDeleter {
    ...
    UserDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class UserLister {
    ...
    UserLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentUser {
    ...
    public FluentUser(User user, UMetadataClient client) {
      this.user = user;
      this.client = client;
    }

 ...
 *
 * This provides a builder-style fluent interface for managing data lineage in UMetadata.
 *
 * Usage Examples:
 * <pre>
 * // Get lineage for an entity
 * var lineage = Lineage.for("table", tableId)
 *     .upstream(3)
 *     .downstream(2)
...
public final class LineageAPI {
  ...
  private LineageAPI() {} // Prevent instantiation
  ...
  private static UMetadataClient getClient() {
    if (defaultClient == null) {
      throw new IllegalStateException(
          "Client not initialized. Call LineageAPI.setDefaultClient() first.");
    }
  ...
  public static class LineageQuery {
    ...
    LineageQuery(UMetadataClient client, String entityType, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class LineageConnector {
    ...
    LineageConnector(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class LineageDisconnector {
    ...
    LineageDisconnector(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class LineageExporter {
    ...
    LineageExporter(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class LineagePathFinder {
    ...
    LineagePathFinder(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class ImpactAnalyzer {
    ...
    ImpactAnalyzer(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class LineageGraph {
    ...
    LineageGraph(String rawData, UMetadataClient client) {

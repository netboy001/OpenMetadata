 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.Topics.*;
 *
 * // Create
 * Topic topic = create()
 *     .name("topic_name")
...
public final class Topics {
  ...
  public static org.umetadata.sdk.models.ListResponse<Topic> list(
  ...
  public static class TopicCreator {
    ...
    TopicCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class TopicFinder {
    ...
    TopicFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    TopicFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class TopicDeleter {
    ...
    TopicDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class TopicLister {
    ...
    TopicLister(UMetadataClient client) {
      this.client = client;
    }

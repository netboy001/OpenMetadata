 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.Classifications.*;
 *
 * // Create
...
public final class Classifications {
  ...
  public static class ClassificationCreator {
    ...
    ClassificationCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class ClassificationFinder {
    ...
    ClassificationFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    ClassificationFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class ClassificationDeleter {
    ...
    ClassificationDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class ClassificationLister {
    ...
    ClassificationLister(UMetadataClient client) {
      this.client = client;
    }

 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.Containers.*;
 *
 * // Create
...
public final class Containers {
  ...
  public static class ContainerCreator {
    ...
    ContainerCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class ContainerFinder {
    ...
    ContainerFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    ContainerFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class ContainerDeleter {
    ...
    ContainerDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class ContainerLister {
    ...
    ContainerLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class ContainerChildrenLister {
    ...
    ContainerChildrenLister(UMetadataClient client, String parentFqn) {
      this.client = client;

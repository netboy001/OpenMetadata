...
public class PipelineBuilder {
  ...
  public PipelineBuilder(UMetadataClient client) {
    this.client = client;
  }
   ...
   */
  public PipelineBuilder owner(org.umetadata.schema.entity.teams.User user) {
   ...
   */
  public PipelineBuilder owner(org.umetadata.schema.entity.teams.Team team) {
    EntityReference ownerRef =
        new EntityReference()
            .withId(team.getId())
            .withType("team")
  ...
  public PipelineBuilder tags(String... tagFQNs) {
    List<org.umetadata.schema.type.TagLabel> tagLabels = new ArrayList<>();

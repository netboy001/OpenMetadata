 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.StoredProcedures.*;
 *
 * // Create
...
public final class StoredProcedures {
  ...
  public static class StoredProcedureCreator {
    ...
    StoredProcedureCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class StoredProcedureFinder {
    ...
    StoredProcedureFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    StoredProcedureFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class StoredProcedureDeleter {
    ...
    StoredProcedureDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class StoredProcedureLister {
    ...
    StoredProcedureLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentStoredProcedure {
    ...
    public FluentStoredProcedure(StoredProcedure storedProcedure, UMetadataClient client) {
  ...
  public static class CsvExporter {
    ...
    CsvExporter(UMetadataClient client, String storedProcedureName) {
      this.client = client;
  ...
  public static class CsvImporter {
    ...
    CsvImporter(UMetadataClient client, String storedProcedureName) {
      this.client = client;
      this.storedProcedureName = storedProcedureName;
    }

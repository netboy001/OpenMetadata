...
public final class PromptTemplates {
  ...
  public static class PromptTemplateCreator {
    ...
    PromptTemplateCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class PromptTemplateFinder {
    ...
    PromptTemplateFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    PromptTemplateFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class PromptTemplateDeleter {
    ...
    PromptTemplateDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class PromptTemplateLister {
    ...
    PromptTemplateLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentPromptTemplate {
    ...
    public FluentPromptTemplate(PromptTemplate entity, UMetadataClient client) {
      this.entity = entity;
      this.client = client;
    }

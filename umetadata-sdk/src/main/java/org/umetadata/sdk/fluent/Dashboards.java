 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.Dashboards.*;
 *
 * // Create
...
public final class Dashboards {
  ...
  public static class DashboardCreator {
    ...
    DashboardCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class DashboardFinder {
    ...
    DashboardFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    DashboardFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class DashboardDeleter {
    ...
    DashboardDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class DashboardLister {
    ...
    DashboardLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentDashboard {
    ...
    public FluentDashboard(Dashboard dashboard, UMetadataClient client) {

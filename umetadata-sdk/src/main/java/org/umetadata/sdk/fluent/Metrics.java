 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.Metrics.*;
 *
 * // Create
...
public final class Metrics {
  ...
  public static class MetricCreator {
    ...
    MetricCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class MetricFinder {
    ...
    MetricFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    MetricFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class MetricDeleter {
    ...
    MetricDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class MetricLister {
    ...
    MetricLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentMetric {
    ...
    public FluentMetric(Metric metric, UMetadataClient client) {
      this.metric = metric;
      this.client = client;
    }
  ...
  public static class CsvExporter {
    ...
    CsvExporter(UMetadataClient client, String metricName) {
      this.client = client;
  ...
  public static class CsvImporter {
    ...
    CsvImporter(UMetadataClient client, String metricName) {
      this.client = client;
      this.metricName = metricName;
    }

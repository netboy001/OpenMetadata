...
public final class AIApplications {
  ...
  public static class AIApplicationCreator {
    ...
    AIApplicationCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class AIApplicationFinder {
    ...
    AIApplicationFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    AIApplicationFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class AIApplicationDeleter {
    ...
    AIApplicationDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class AIApplicationLister {
    ...
    AIApplicationLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentAIApplication {
    ...
    public FluentAIApplication(AIApplication entity, UMetadataClient client) {
      this.entity = entity;
      this.client = client;
    }

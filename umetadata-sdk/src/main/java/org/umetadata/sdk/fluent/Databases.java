...
import org.umetadata.sdk.fluent.collections.DatabaseCollection;
 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.Databases.*;
 *
 * // Create
...
public final class Databases {
  ...
  public static org.umetadata.sdk.models.ListResponse<Database> list(
  ...
  public static class DatabaseCreator {
    ...
    DatabaseCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class DatabaseFinder {
    ...
    DatabaseFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    DatabaseFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class DatabaseDeleter {
    ...
    DatabaseDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class DatabaseLister {
    ...
    DatabaseLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentDatabase {
    ...
    public FluentDatabase(Database database, UMetadataClient client) {
  ...
  public static class CsvExporter
    ...
    CsvExporter(UMetadataClient client, String databaseName) {
  ...
  public static class CsvImporter
    ...
    CsvImporter(UMetadataClient client, String databaseName) {
      super(client, "database");
      this.databaseName = databaseName;
    }

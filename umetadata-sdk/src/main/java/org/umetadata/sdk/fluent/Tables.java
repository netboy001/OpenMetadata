 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.Tables.*;
 *
 * // Create
 * Table table = create()
 *     .name("table_name")
...
public final class Tables {
  ...
  public static org.umetadata.sdk.models.ListResponse<Table> list(
  ...
  public static org.umetadata.sdk.fluent.collections.TableCollection collection() {
    return new org.umetadata.sdk.fluent.collections.TableCollection(getClient());
  }
  ...
  public static class TableCreator {
    ...
    TableCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class TableFinder {
    ...
    TableFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    TableFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
    ...
    public org.umetadata.sdk.fluent.wrappers.FluentTable fetch() {
      Table table;
      if (includes.isEmpty()) {
      ...
      return new org.umetadata.sdk.fluent.wrappers.FluentTable(table, client);
    }
  ...
  public static class TableOperations {
    ...
    TableOperations(UMetadataClient client, String tableId) {
      this.client = client;
  ...
  public static class TableDeleter {
    ...
    public TableDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class TableLister {
    ...
    TableLister(UMetadataClient client) {
      this.client = client;
    }
    ...
    public List<org.umetadata.sdk.fluent.wrappers.FluentTable> fetch() {
      ...
      List<org.umetadata.sdk.fluent.wrappers.FluentTable> items = new ArrayList<>();
      for (Table item : response.getData()) {
        items.add(new org.umetadata.sdk.fluent.wrappers.FluentTable(item, client));
      }
      return items;
    }

    public void forEach(
        java.util.function.Consumer<org.umetadata.sdk.fluent.wrappers.FluentTable> action) {
  ...
  public static class FluentTable {
    ...
    public FluentTable(Table table, UMetadataClient client) {
      this.table = table;
      this.client = client;
    }
  ...
  public static class CsvExporter {
    ...
    CsvExporter(UMetadataClient client, String tableName) {
      this.client = client;
  ...
  public static class CsvImporter {
    ...
    CsvImporter(UMetadataClient client, String tableName) {
      this.client = client;
      this.tableName = tableName;
    }

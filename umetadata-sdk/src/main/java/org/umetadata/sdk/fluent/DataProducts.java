 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.DataProducts.*;
 *
 * // Create
...
public final class DataProducts {
  ...
  public static class DataProductCreator {
    ...
    DataProductCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class DataProductFinder {
    ...
    DataProductFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    DataProductFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class DataProductDeleter {
    ...
    DataProductDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class DataProductLister {
    ...
    DataProductLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentDataProduct {
    ...
    public FluentDataProduct(DataProduct dataProduct, UMetadataClient client) {

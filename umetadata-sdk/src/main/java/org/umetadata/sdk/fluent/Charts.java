 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.Charts.*;
 *
 * // Create
 * Chart chart = create()
 *     .name("chart_name")
...
public final class Charts {
  ...
  public static class ChartCreator {
    ...
    ChartCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class ChartFinder {
    ...
    ChartFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    ChartFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class ChartDeleter {
    ...
    ChartDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class ChartLister {
    ...
    ChartLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentChart {
    ...
    public FluentChart(Chart chart, UMetadataClient client) {
      this.chart = chart;
      this.client = client;
    }

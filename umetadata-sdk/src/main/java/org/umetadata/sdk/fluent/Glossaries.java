...
import org.umetadata.sdk.fluent.collections.GlossaryCollection;
 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.Glossaries.*;
 *
 * // Create
...
public final class Glossaries {
  ...
  public static class GlossaryCreator {
    ...
    GlossaryCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class GlossaryFinder {
    ...
    GlossaryFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    GlossaryFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class GlossaryDeleter {
    ...
    GlossaryDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class GlossaryLister {
    ...
    GlossaryLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentGlossary {
    ...
    public FluentGlossary(Glossary glossary, UMetadataClient client) {
  ...
  public static class CsvExporter
      extends org.umetadata.sdk.fluent.common.CsvOperations.BaseCsvExporter {
    private final String glossaryName;

    CsvExporter(UMetadataClient client, String glossaryName) {
  ...
  public static class CsvImporter {
    ...
    CsvImporter(UMetadataClient client, String glossaryName) {
      this.client = client;
      this.glossaryName = glossaryName;
    }
        ...
        try {
          ...
          if (serverUrl != null) {
            ...
            if (userId != null) {
              ...
              org.umetadata.sdk.websocket.WebSocketManager wsManager =
                  org.umetadata.sdk.websocket.WebSocketManager.getInstance(serverUrl, userId);

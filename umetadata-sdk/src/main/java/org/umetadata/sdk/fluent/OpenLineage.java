...
public final class OpenLineage {
  ...
  private static final String DEFAULT_PRODUCER = "https://github.com/UMetadata/UMetadata";
   ...
   */
  public static String postEvent(Map<String, Object> event) throws UMetadataException {
   ...
   */
  public static String postBatch(List<Map<String, Object>> events) throws UMetadataException {
  ...
  public static class RunEventBuilder {
    ...
    RunEventBuilder(UMetadataClient client) {
      this.client = client;
    }
    ...
    /**
     * Send the event to UMetadata.
     */
    public String send() throws UMetadataException {
      return client
          .getHttpClient()
  ...
  public static class BatchEventBuilder {
    ...
    BatchEventBuilder(UMetadataClient client) {
      this.client = client;
    }

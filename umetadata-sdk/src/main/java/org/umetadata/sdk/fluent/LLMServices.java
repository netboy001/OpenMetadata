...
public final class LLMServices {
  ...
  public static class LLMServiceCreator {
    ...
    LLMServiceCreator(UMetadataClient client) {
      this.client = client;
    }
    ...
    public LLMServiceCreator withConnection(org.umetadata.schema.type.LLMConnection connection) {
  ...
  public static class LLMServiceFinder {
    ...
    LLMServiceFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    LLMServiceFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class LLMServiceDeleter {
    ...
    LLMServiceDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class LLMServiceLister {
    ...
    LLMServiceLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentLLMService {
    ...
    public FluentLLMService(LLMService entity, UMetadataClient client) {
      this.entity = entity;
      this.client = client;
    }

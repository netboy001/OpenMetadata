 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.MlModels.*;
 *
 * // Create
...
public final class MlModels {
  ...
  public static class MlModelCreator {
    ...
    MlModelCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class MlModelFinder {
    ...
    MlModelFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    MlModelFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class MlModelDeleter {
    ...
    MlModelDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class MlModelLister {
    ...
    MlModelLister(UMetadataClient client) {
      this.client = client;
    }

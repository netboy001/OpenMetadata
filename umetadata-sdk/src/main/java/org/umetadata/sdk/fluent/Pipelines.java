 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.Pipelines.*;
 *
 * // Create
...
public final class Pipelines {
  ...
  public static org.umetadata.sdk.models.ListResponse<Pipeline> list(
  ...
  public static class PipelineCreator {
    ...
    PipelineCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class PipelineFinder {
    ...
    PipelineFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    PipelineFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class PipelineDeleter {
    ...
    PipelineDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class PipelineLister {
    ...
    PipelineLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentPipeline {
    ...
    public FluentPipeline(Pipeline pipeline, UMetadataClient client) {

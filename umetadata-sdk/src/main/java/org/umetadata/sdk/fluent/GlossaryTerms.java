...
import org.umetadata.sdk.fluent.collections.GlossaryTermCollection;
 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.GlossaryTerms.*;
 *
 * // Create
...
public final class GlossaryTerms {
  ...
  public static class GlossaryTermCreator {
    ...
    GlossaryTermCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class GlossaryTermFinder {
    ...
    GlossaryTermFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    GlossaryTermFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class GlossaryTermDeleter {
    ...
    GlossaryTermDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class GlossaryTermLister {
    ...
    GlossaryTermLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class FluentGlossaryTerm {
    ...
    public FluentGlossaryTerm(GlossaryTerm glossaryTerm, UMetadataClient client) {

 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.TestCases.*;
 *
 * // Create
...
public final class TestCases {
  ...
  public static class TestCaseCreator {
    ...
    TestCaseCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class TestCaseOperations {
    ...
    TestCaseOperations(UMetadataClient client, String testCaseId) {
      this.client = client;
  ...
  public static class TestCaseFinder {
    ...
    TestCaseFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    TestCaseFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class FluentTestCase {
    ...
    FluentTestCase(UMetadataClient client, TestCase testCase) {
      this.client = client;
  ...
  public static class TestCaseLister {
    ...
    TestCaseLister(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class DeleteOperation {
    ...
    DeleteOperation(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }

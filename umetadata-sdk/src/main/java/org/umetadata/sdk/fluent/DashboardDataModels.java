 ...
 * Usage:
 * <pre>
 * import static org.umetadata.sdk.fluent.DashboardDataModels.*;
 *
 * // Create
...
public final class DashboardDataModels {
  ...
  public static class DashboardDataModelCreator {
    ...
    DashboardDataModelCreator(UMetadataClient client) {
      this.client = client;
    }
  ...
  public static class DashboardDataModelFinder {
    ...
    DashboardDataModelFinder(UMetadataClient client, String identifier) {
      this(client, identifier, false);
    }

    DashboardDataModelFinder(UMetadataClient client, String identifier, boolean isFqn) {
      this.client = client;
  ...
  public static class DashboardDataModelDeleter {
    ...
    DashboardDataModelDeleter(UMetadataClient client, String id) {
      this.client = client;
      this.id = id;
    }
  ...
  public static class DashboardDataModelLister {
    ...
    DashboardDataModelLister(UMetadataClient client) {
      this.client = client;
    }

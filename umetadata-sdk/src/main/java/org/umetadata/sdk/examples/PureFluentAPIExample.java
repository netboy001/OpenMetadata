...
public class PureFluentAPIExample {
  ...
  public static void main(String[] args) {
    ...
    var createRequest = new org.umetadata.schema.api.data.CreateTable();
    ...
    java.util.List<org.umetadata.schema.type.Column> columns = new java.util.ArrayList<>();

    org.umetadata.schema.type.Column idCol = new org.umetadata.schema.type.Column();
    idCol.setName("id");
    idCol.setDataType(org.umetadata.schema.type.ColumnDataType.BIGINT);
    columns.add(idCol);

    org.umetadata.schema.type.Column emailCol = new org.umetadata.schema.type.Column();
    emailCol.setName("email");
    emailCol.setDataType(org.umetadata.schema.type.ColumnDataType.VARCHAR);
    emailCol.setDataLength(255);
    columns.add(emailCol);

    org.umetadata.schema.type.Column createdAtCol = new org.umetadata.schema.type.Column();
    createdAtCol.setName("created_at");
    createdAtCol.setDataType(org.umetadata.schema.type.ColumnDataType.TIMESTAMP);

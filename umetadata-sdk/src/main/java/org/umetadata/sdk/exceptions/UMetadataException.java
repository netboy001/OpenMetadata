...
public class UMetadataException extends RuntimeException {
  ...
  public UMetadataException(String message, int statusCode) {
    this(message, null, statusCode, null);
  }

  public UMetadataException(String message, int statusCode, String errorCode) {
    this(message, null, statusCode, errorCode);
  }

  public UMetadataException(String message, Throwable cause, int statusCode, String errorCode) {
    super(message, cause);

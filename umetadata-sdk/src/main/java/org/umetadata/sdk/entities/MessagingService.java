...
public class MessagingService extends org.umetadata.schema.entity.services.MessagingService {
  ...
  // Static CRUD methods
  public static org.umetadata.schema.entity.services.MessagingService create(
      CreateMessagingService request) {
    // Convert CreateMessagingService to MessagingService
    org.umetadata.schema.entity.services.MessagingService service =
        new org.umetadata.schema.entity.services.MessagingService();
  ...
  public static org.umetadata.schema.entity.services.MessagingService retrieve(String id) {
    return getClient().messagingServices().get(id);
  }

  public static org.umetadata.schema.entity.services.MessagingService retrieve(
      String id, String fields) {
    return getClient().messagingServices().get(id, fields);
  }

  public static org.umetadata.schema.entity.services.MessagingService retrieveByName(
      String name) {
  ...
  public static org.umetadata.schema.entity.services.MessagingService update(
      String id, org.umetadata.schema.entity.services.MessagingService service) {
  ...
  // Async operations
  public static CompletableFuture<org.umetadata.schema.entity.services.MessagingService>

...
public class Classification {
  ...
  // Static CRUD methods
  public static org.umetadata.schema.entity.classification.Classification create(
      CreateClassification request) {
    return getClient().classifications().create(request);
  }

  public static org.umetadata.schema.entity.classification.Classification retrieve(String id) {
    return getClient().classifications().get(id);
  }

  public static org.umetadata.schema.entity.classification.Classification retrieve(
      String id, String fields) {
    return getClient().classifications().get(id, fields);
  }

  public static org.umetadata.schema.entity.classification.Classification retrieveByName(
      String name) {
  ...
  public static org.umetadata.schema.entity.classification.Classification update(
      String id, org.umetadata.schema.entity.classification.Classification entity) {
    return getClient().classifications().update(id, entity);
  }

  public static org.umetadata.schema.entity.classification.Classification update(
      org.umetadata.schema.entity.classification.Classification entity) {
  ...
  // Async operations
  public static CompletableFuture<org.umetadata.schema.entity.classification.Classification>

...
public class MlModelService extends org.umetadata.schema.entity.services.MlModelService {
  ...
  // Static CRUD methods
  public static org.umetadata.schema.entity.services.MlModelService create(
      CreateMlModelService request) {
    // Convert CreateMlModelService to MlModelService
    org.umetadata.schema.entity.services.MlModelService service =
        new org.umetadata.schema.entity.services.MlModelService();
  ...
  public static org.umetadata.schema.entity.services.MlModelService retrieve(String id) {
    return getClient().mlModelServices().get(id);
  }

  public static org.umetadata.schema.entity.services.MlModelService retrieve(
      String id, String fields) {
    return getClient().mlModelServices().get(id, fields);
  }

  public static org.umetadata.schema.entity.services.MlModelService retrieveByName(String name) {
    return getClient().mlModelServices().getByName(name);
  }

  public static org.umetadata.schema.entity.services.MlModelService retrieveByName(
      String name, String fields) {
    return getClient().mlModelServices().getByName(name, fields);
  }

  public static org.umetadata.schema.entity.services.MlModelService update(
      String id, org.umetadata.schema.entity.services.MlModelService service) {
  ...
  // Async operations
  public static CompletableFuture<org.umetadata.schema.entity.services.MlModelService>

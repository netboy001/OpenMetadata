...
public class PipelineService extends org.umetadata.schema.entity.services.PipelineService {
  ...
  // Static CRUD methods
  public static org.umetadata.schema.entity.services.PipelineService create(
      CreatePipelineService request) {
    // Convert CreatePipelineService to PipelineService
    org.umetadata.schema.entity.services.PipelineService service =
        new org.umetadata.schema.entity.services.PipelineService();
  ...
  public static org.umetadata.schema.entity.services.PipelineService retrieve(String id) {
    return getClient().pipelineServices().get(id);
  }

  public static org.umetadata.schema.entity.services.PipelineService retrieve(
      String id, String fields) {
    return getClient().pipelineServices().get(id, fields);
  }

  public static org.umetadata.schema.entity.services.PipelineService retrieveByName(
      String name) {
  ...
  public static org.umetadata.schema.entity.services.PipelineService update(
      String id, org.umetadata.schema.entity.services.PipelineService service) {
  ...
  // Async operations
  public static CompletableFuture<org.umetadata.schema.entity.services.PipelineService>

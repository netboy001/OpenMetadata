...
public class DashboardDataModel {
  ...
  // Static CRUD methods
  public static org.umetadata.schema.entity.data.DashboardDataModel create(
      CreateDashboardDataModel request) {
    // Convert CreateDashboardDataModel to DashboardDataModel entity
    org.umetadata.schema.entity.data.DashboardDataModel dataModel =
        new org.umetadata.schema.entity.data.DashboardDataModel();
  ...
  public static org.umetadata.schema.entity.data.DashboardDataModel retrieve(String id) {
    return getClient().dashboardDataModels().get(id);
  }

  public static org.umetadata.schema.entity.data.DashboardDataModel retrieve(
      String id, String fields) {
    return getClient().dashboardDataModels().get(id, fields);
  }

  public static org.umetadata.schema.entity.data.DashboardDataModel retrieveByName(String name) {
    return getClient().dashboardDataModels().getByName(name);
  }

  public static org.umetadata.schema.entity.data.DashboardDataModel retrieveByName(
      String name, String fields) {
    return getClient().dashboardDataModels().getByName(name, fields);
  }

  public static org.umetadata.schema.entity.data.DashboardDataModel update(
      String id, org.umetadata.schema.entity.data.DashboardDataModel entity) {
    return getClient().dashboardDataModels().update(id, entity);
  }

  public static org.umetadata.schema.entity.data.DashboardDataModel update(
      org.umetadata.schema.entity.data.DashboardDataModel entity) {
  ...
  // Async operations
  public static CompletableFuture<org.umetadata.schema.entity.data.DashboardDataModel>

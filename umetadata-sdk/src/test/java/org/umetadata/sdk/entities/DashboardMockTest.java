...
public class DashboardMockTest {
  ...
  void setUp() {
    ...
    org.umetadata.sdk.entities.Dashboard.setDefaultClient(mockClient);
  }
  ...
  void testCreateDashboard() {
    ...
    // Act
    Dashboard result = org.umetadata.sdk.entities.Dashboard.create(createRequest);
  ...
  void testRetrieveDashboard() {
    ...
    // Act
    Dashboard result = org.umetadata.sdk.entities.Dashboard.retrieve(dashboardId);
  ...
  void testRetrieveDashboardWithCharts() {
    ...
    // Act
    Dashboard result = org.umetadata.sdk.entities.Dashboard.retrieve(dashboardId, fields);
  ...
  void testRetrieveDashboardByName() {
    ...
    // Act
    Dashboard result = org.umetadata.sdk.entities.Dashboard.retrieveByName(fqn);
  ...
  void testUpdateDashboard() {
    ...
    // Act
    Dashboard result =
        org.umetadata.sdk.entities.Dashboard.update(
  ...
  void testDeleteDashboard() {
    ...
    // Act
    org.umetadata.sdk.entities.Dashboard.delete(dashboardId);
  ...
  void testAsyncOperations() throws Exception {
    ...
    // Act
    var future = org.umetadata.sdk.entities.Dashboard.retrieveAsync(dashboardId);

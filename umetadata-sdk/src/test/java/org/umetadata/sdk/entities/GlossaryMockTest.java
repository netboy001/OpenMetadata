...
public class GlossaryMockTest {
  ...
  void setUp() {
    ...
    org.umetadata.sdk.entities.Glossary.setDefaultClient(mockClient);
    org.umetadata.sdk.entities.GlossaryTerm.setDefaultClient(mockClient);
  }
  ...
  void testCreateGlossary() {
    ...
    // Act
    Glossary result = org.umetadata.sdk.entities.Glossary.create(createRequest);
  ...
  void testCreateGlossaryTerm() {
    ...
    // Act
    GlossaryTerm result = org.umetadata.sdk.entities.GlossaryTerm.create(createRequest);
  ...
  void testRetrieveGlossary() {
    ...
    // Act
    Glossary result = org.umetadata.sdk.entities.Glossary.retrieve(glossaryId);
  ...
  void testRetrieveGlossaryTerm() {
    ...
    // Act
    GlossaryTerm result = org.umetadata.sdk.entities.GlossaryTerm.retrieve(termId);
  ...
  void testRetrieveGlossaryTermWithRelations() {
    ...
    // Act
    GlossaryTerm result = org.umetadata.sdk.entities.GlossaryTerm.retrieve(termId, fields);
  ...
  void testUpdateGlossary() {
    ...
    // Act
    Glossary result =
        org.umetadata.sdk.entities.Glossary.update(
  ...
  void testUpdateGlossaryTerm() {
    ...
    // Act
    GlossaryTerm result =
        org.umetadata.sdk.entities.GlossaryTerm.update(
  ...
  void testDeleteGlossary() {
    ...
    // Act
    org.umetadata.sdk.entities.Glossary.delete(glossaryId);
  ...
  void testDeleteGlossaryTerm() {
    ...
    // Act
    org.umetadata.sdk.entities.GlossaryTerm.delete(termId);

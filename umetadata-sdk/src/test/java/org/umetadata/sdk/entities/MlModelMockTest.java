...
public class MlModelMockTest {
  ...
  void setUp() {
    ...
    org.umetadata.sdk.entities.MlModel.setDefaultClient(mockClient);
  }
  ...
  void testCreateMlModel() {
    ...
    // Act
    MlModel result = org.umetadata.sdk.entities.MlModel.create(createRequest);
  ...
  void testRetrieveMlModel() {
    ...
    // Act
    MlModel result = org.umetadata.sdk.entities.MlModel.retrieve(modelId);
  ...
  void testRetrieveMlModelWithFeatures() {
    ...
    // Act
    MlModel result = org.umetadata.sdk.entities.MlModel.retrieve(modelId, fields);
  ...
  void testRetrieveMlModelByName() {
    ...
    // Act
    MlModel result = org.umetadata.sdk.entities.MlModel.retrieveByName(fqn);
  ...
  void testUpdateMlModel() {
    ...
    // Act
    MlModel result =
        org.umetadata.sdk.entities.MlModel.update(
  ...
  void testMlModelWithHyperParameters() {
    ...
    // Act
    MlModel result = org.umetadata.sdk.entities.MlModel.retrieve(modelId, "mlHyperParameters");
  ...
  void testDeleteMlModel() {
    ...
    // Act
    org.umetadata.sdk.entities.MlModel.delete(modelId);
  ...
  void testAsyncOperations() throws Exception {
    ...
    // Act
    var future = org.umetadata.sdk.entities.MlModel.retrieveAsync(modelId);

...
public class ContainerMockTest {
  ...
  void setUp() {
    ...
    org.umetadata.sdk.entities.Container.setDefaultClient(mockClient);
  }
  ...
  void testCreateContainer() {
    ...
    // Act
    Container result = org.umetadata.sdk.entities.Container.create(createRequest);
  ...
  void testRetrieveContainer() {
    ...
    // Act
    Container result = org.umetadata.sdk.entities.Container.retrieve(containerId);
  ...
  void testRetrieveContainerWithDataModel() {
    ...
    // Act
    Container result = org.umetadata.sdk.entities.Container.retrieve(containerId, fields);
  ...
  void testRetrieveContainerByName() {
    ...
    // Act
    Container result = org.umetadata.sdk.entities.Container.retrieveByName(fqn);
  ...
  void testUpdateContainer() {
    ...
    // Act
    Container result =
        org.umetadata.sdk.entities.Container.update(
  ...
  void testDeleteContainer() {
    ...
    // Act
    org.umetadata.sdk.entities.Container.delete(containerId);
  ...
  void testHierarchicalContainers() {
    ...
    // Act
    Container child = org.umetadata.sdk.entities.Container.retrieve(childId, "parent");

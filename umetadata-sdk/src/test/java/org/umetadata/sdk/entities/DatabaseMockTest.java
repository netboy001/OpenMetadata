...
public class DatabaseMockTest {
  ...
  void setUp() {
    ...
    org.umetadata.sdk.entities.Database.setDefaultClient(mockClient);
  }
  ...
  void testCreateDatabase() {
    ...
    // Act
    Database result = org.umetadata.sdk.entities.Database.create(createRequest);
  ...
  void testRetrieveDatabase() {
    ...
    // Act
    Database result = org.umetadata.sdk.entities.Database.retrieve(databaseId);
  ...
  void testRetrieveDatabaseByName() {
    ...
    // Act
    Database result = org.umetadata.sdk.entities.Database.retrieveByName(fqn);
  ...
  void testUpdateDatabase() {
    ...
    // Act
    Database result = org.umetadata.sdk.entities.Database.update(databaseToUpdate);
  ...
  void testDeleteDatabase() {
    ...
    // Act
    org.umetadata.sdk.entities.Database.delete(databaseId);
  ...
  void testDeleteDatabaseWithOptions() {
    ...
    // Act
    org.umetadata.sdk.entities.Database.delete(databaseId, true, true);

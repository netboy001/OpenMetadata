...
class TablesFluentAPITest {
  ...
  void testFetchReturnsWrappersFluentTable() {
    ...
    assertInstanceOf(org.umetadata.sdk.fluent.wrappers.FluentTable.class, result);
    assertFalse(
    ...
    org.umetadata.sdk.fluent.wrappers.FluentTable fluent =
        (org.umetadata.sdk.fluent.wrappers.FluentTable) result;

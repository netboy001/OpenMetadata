...
public class PipelineMockTest {
  ...
  void setUp() {
    ...
    org.umetadata.sdk.entities.Pipeline.setDefaultClient(mockClient);
  }
  ...
  void testCreatePipeline() {
    ...
    // Act
    Pipeline result = org.umetadata.sdk.entities.Pipeline.create(createRequest);
  ...
  void testRetrievePipeline() {
    ...
    // Act
    Pipeline result = org.umetadata.sdk.entities.Pipeline.retrieve(pipelineId);
  ...
  void testRetrievePipelineWithTasks() {
    ...
    // Mock tasks
    org.umetadata.schema.type.Task task1 = new org.umetadata.schema.type.Task();
    task1.setName("extract_data");
    task1.setDisplayName("Extract Data");
    task1.setTaskType("PythonOperator");

    org.umetadata.schema.type.Task task2 = new org.umetadata.schema.type.Task();
    ...
    // Act
    Pipeline result = org.umetadata.sdk.entities.Pipeline.retrieve(pipelineId, fields);
  ...
  void testRetrievePipelineByName() {
    ...
    // Act
    Pipeline result = org.umetadata.sdk.entities.Pipeline.retrieveByName(fqn);
  ...
  void testUpdatePipeline() {
    ...
    // Act
    Pipeline result =
        org.umetadata.sdk.entities.Pipeline.update(
  ...
  void testDeletePipeline() {
    ...
    // Act
    org.umetadata.sdk.entities.Pipeline.delete(pipelineId);
  ...
  void testDeletePipelineWithOptions() {
    ...
    // Act
    org.umetadata.sdk.entities.Pipeline.delete(pipelineId, true, true);

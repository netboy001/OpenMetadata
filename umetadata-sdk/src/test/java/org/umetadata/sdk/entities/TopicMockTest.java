...
public class TopicMockTest {
  ...
  void setUp() {
    ...
    org.umetadata.sdk.entities.Topic.setDefaultClient(mockClient);
  }
  ...
  void testCreateTopic() {
    ...
    // Act
    Topic result = org.umetadata.sdk.entities.Topic.create(createRequest);
  ...
  void testRetrieveTopic() {
    ...
    // Act
    Topic result = org.umetadata.sdk.entities.Topic.retrieve(topicId);
  ...
  void testRetrieveTopicWithSchema() {
    ...
    // Mock schema field
    org.umetadata.schema.type.MessageSchema schema =
        new org.umetadata.schema.type.MessageSchema();
    expectedTopic.setMessageSchema(schema);

    when(mockTopicService.get(topicId, fields)).thenReturn(expectedTopic);

    // Act
    Topic result = org.umetadata.sdk.entities.Topic.retrieve(topicId, fields);
  ...
  void testRetrieveTopicByName() {
    ...
    // Act
    Topic result = org.umetadata.sdk.entities.Topic.retrieveByName(fqn);
  ...
  void testUpdateTopic() {
    ...
    // Act
    Topic result =
        org.umetadata.sdk.entities.Topic.update(topicToUpdate.getId().toString(), topicToUpdate);
  ...
  void testDeleteTopic() {
    ...
    // Act
    org.umetadata.sdk.entities.Topic.delete(topicId);
  ...
  void testDeleteTopicWithOptions() {
    ...
    // Act
    org.umetadata.sdk.entities.Topic.delete(topicId, true, true);
  ...
  void testAsyncOperations() throws Exception {
    ...
    // Act
    var future = org.umetadata.sdk.entities.Topic.retrieveAsync(topicId);

...
public class DatabaseServiceMockTest {
  ...
  void setUp() {
    ...
    org.umetadata.sdk.entities.DatabaseService.setDefaultClient(mockClient);
  }
  ...
  void testCreateDatabaseService() {
    ...
    // Act
    DatabaseService result = org.umetadata.sdk.entities.DatabaseService.create(createRequest);
  ...
  void testRetrieveDatabaseService() {
    ...
    // Act
    DatabaseService result = org.umetadata.sdk.entities.DatabaseService.retrieve(serviceId);
  ...
  void testUpdateDatabaseService() {
    ...
    // Act
    DatabaseService result = org.umetadata.sdk.entities.DatabaseService.update(serviceToUpdate);
  ...
  void testDeleteDatabaseService() {
    ...
    // Act
    org.umetadata.sdk.entities.DatabaseService.delete(serviceId);
  ...
  void testDeleteDatabaseServiceWithOptions() {
    ...
    // Act
    org.umetadata.sdk.entities.DatabaseService.delete(serviceId, true, true);

...
public class TeamMockTest {
  ...
  void setUp() {
    ...
    org.umetadata.sdk.entities.Team.setDefaultClient(mockClient);
  }
  ...
  void testCreateTeam() {
    ...
    // Act
    Team result = org.umetadata.sdk.entities.Team.create(createRequest);
  ...
  void testRetrieveTeam() {
    ...
    // Act
    Team result = org.umetadata.sdk.entities.Team.retrieve(teamId);
  ...
  void testRetrieveTeamWithMembers() {
    ...
    // Act
    Team result = org.umetadata.sdk.entities.Team.retrieve(teamId, fields);
  ...
  void testRetrieveTeamByName() {
    ...
    // Act
    Team result = org.umetadata.sdk.entities.Team.retrieveByName(teamName);
  ...
  void testUpdateTeam() {
    ...
    // Act
    Team result =
        org.umetadata.sdk.entities.Team.update(teamToUpdate.getId().toString(), teamToUpdate);
  ...
  void testDeleteTeam() {
    ...
    // Act
    org.umetadata.sdk.entities.Team.delete(teamId);
  ...
  void testHierarchicalTeams() {
    ...
    // Act
    Team child = org.umetadata.sdk.entities.Team.retrieve(childId, "parents");
  ...
  void testTeamWithDefaultRoles() {
    ...
    // Act
    Team result = org.umetadata.sdk.entities.Team.retrieve(teamId, "defaultRoles");

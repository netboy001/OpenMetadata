...
public class QueryMockTest {
  ...
  void setUp() {
    ...
    org.umetadata.sdk.entities.Query.setDefaultClient(mockClient);
  }
  ...
  void testCreateQuery() {
    ...
    // Act
    Query result = org.umetadata.sdk.entities.Query.create(createRequest);
  ...
  void testRetrieveQuery() {
    ...
    // Act
    Query result = org.umetadata.sdk.entities.Query.retrieve(queryId);
  ...
  void testRetrieveQueryWithUsers() {
    ...
    // Act
    Query result = org.umetadata.sdk.entities.Query.retrieve(queryId, fields);
  ...
  void testRetrieveQueryByName() {
    ...
    // Act
    Query result = org.umetadata.sdk.entities.Query.retrieveByName(fqn);
  ...
  void testUpdateQuery() {
    ...
    // Act
    Query result =
        org.umetadata.sdk.entities.Query.update(queryToUpdate.getId().toString(), queryToUpdate);
  ...
  void testQueryWithQueryUsedIn() {
    ...
    // Act
    Query result = org.umetadata.sdk.entities.Query.retrieve(queryId, "queryUsedIn");
  ...
  void testDeleteQuery() {
    ...
    // Act
    org.umetadata.sdk.entities.Query.delete(queryId);
  ...
  void testDeleteQueryWithOptions() {
    ...
    // Act
    org.umetadata.sdk.entities.Query.delete(queryId, true, true);

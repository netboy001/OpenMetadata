...
public class SearchIndexMockTest {
  ...
  void setUp() {
    ...
    org.umetadata.sdk.entities.SearchIndex.setDefaultClient(mockClient);
  }
  ...
  void testCreateSearchIndex() {
    ...
    // Act
    SearchIndex result = org.umetadata.sdk.entities.SearchIndex.create(createRequest);
  ...
  void testRetrieveSearchIndex() {
    ...
    // Act
    SearchIndex result = org.umetadata.sdk.entities.SearchIndex.retrieve(indexId);
  ...
  void testRetrieveSearchIndexWithFields() {
    ...
    // Act
    SearchIndex result = org.umetadata.sdk.entities.SearchIndex.retrieve(indexId, fields);
  ...
  void testRetrieveSearchIndexByName() {
    ...
    // Act
    SearchIndex result = org.umetadata.sdk.entities.SearchIndex.retrieveByName(fqn);
  ...
  void testUpdateSearchIndex() {
    ...
    // Act
    SearchIndex result =
        org.umetadata.sdk.entities.SearchIndex.update(
  ...
  void testDeleteSearchIndex() {
    ...
    // Act
    org.umetadata.sdk.entities.SearchIndex.delete(indexId);

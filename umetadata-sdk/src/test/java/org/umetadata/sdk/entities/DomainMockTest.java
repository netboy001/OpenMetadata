...
public class DomainMockTest {
  ...
  private MockedStatic<UMetadata> mockedUMetadata;

  @BeforeEach
  void setUp() {
    closeable = MockitoAnnotations.openMocks(this);
    when(mockClient.domains()).thenReturn(mockDomainService);
    mockedUMetadata = Mockito.mockStatic(UMetadata.class);
    mockedUMetadata.when(UMetadata::client).thenReturn(mockClient);
  }

  @AfterEach
  void tearDown() throws Exception {
    if (mockedUMetadata != null) {
      mockedUMetadata.close();
    }
    if (closeable != null) {
      closeable.close();
    }
  ...
  void testCreateDomain() {
    ...
    // Act
    org.umetadata.sdk.entities.Domain result =
        org.umetadata.sdk.entities.Domain.create(createRequest);
  ...
  void testRetrieveDomain() {
    ...
    // Act
    org.umetadata.sdk.entities.Domain result =
        org.umetadata.sdk.entities.Domain.retrieve(domainId);
  ...
  void testRetrieveDomainByName() {
    // Arrange
    String name = "Finance";
    org.umetadata.sdk.entities.Domain expectedDomain =
        new org.umetadata.sdk.entities.Domain();
    ...
    // Act
    org.umetadata.sdk.entities.Domain result =
        org.umetadata.sdk.entities.Domain.retrieveByName(name);
  ...
  void testUpdateDomain() {
    ...
    // Act
    org.umetadata.sdk.entities.Domain result =
        org.umetadata.sdk.entities.Domain.update(
  ...
  void testRetrieveDomainWithChildren() {
    ...
    // Set up mocks
    when(UMetadata.client()).thenReturn(mockClient);
    when(mockClient.domains()).thenReturn(mockDomainService);
    ...
    if (result.getChildren() != null) {
      ...
      org.umetadata.schema.type.EntityReference child1 = result.getChildren().getFirst();
      ...
      org.umetadata.schema.type.EntityReference child2 = result.getChildren().get(1);
  ...
  private org.umetadata.schema.type.EntityReference createDomainReference(Domain domain) {
    return new org.umetadata.schema.type.EntityReference()
        .withId(domain.getId())
  ...
  void testDeleteDomain() {
    ...
    // Act
    org.umetadata.sdk.entities.Domain.delete(domainId, false, true);

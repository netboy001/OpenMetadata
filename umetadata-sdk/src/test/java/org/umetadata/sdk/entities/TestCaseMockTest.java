...
public class TestCaseMockTest {
  ...
  void setUp() throws Exception {
    ...
    org.umetadata.sdk.entities.TestCase.setDefaultClient(mockClient);

    // Use reflection to set the private defaultClient field
    Field field = UMetadata.class.getDeclaredField("defaultClient");
  ...
  void testCreateTestCase() {
    ...
    // Act
    TestCase result = org.umetadata.sdk.entities.TestCase.create(createRequest);
  ...
  void testRetrieveTestCase() {
    ...
    // Act
    TestCase result = org.umetadata.sdk.entities.TestCase.retrieve(testCaseId);
  ...
  void testRetrieveTestCaseWithResults() {
    ...
    // Act
    TestCase result = org.umetadata.sdk.entities.TestCase.retrieve(testCaseId, fields);
  ...
  void testRetrieveTestCaseByName() {
    ...
    // Act
    TestCase result = org.umetadata.sdk.entities.TestCase.retrieveByName(fqn);
  ...
  void testUpdateTestCase() {
    ...
    // Act
    TestCase result =
        org.umetadata.sdk.entities.TestCase.update(
  ...
  void testDeleteTestCase() {
    ...
    // Act
    org.umetadata.sdk.entities.TestCase.delete(testCaseId, false, false);
  ...
  void testTestCaseWithParameters() {
    ...
    // Act
    TestCase result =
        org.umetadata.sdk.entities.TestCase.retrieve(testCaseId, "parameterValues");
  ...
  void testAsyncOperations() throws Exception {
    ...
    var future =
        CompletableFuture.supplyAsync(
            () -> {
              try {
                return org.umetadata.sdk.entities.TestCase.retrieve(testCaseId);
              } catch (Exception e) {

...
public class UserMockTest {
  ...
  void setUp() {
    ...
    org.umetadata.sdk.entities.User.setDefaultClient(mockClient);
  }
  ...
  void testCreateUser() {
    ...
    // Act
    User result = org.umetadata.sdk.entities.User.create(createRequest);
  ...
  void testRetrieveUser() {
    ...
    // Act
    User result = org.umetadata.sdk.entities.User.retrieve(userId);
  ...
  void testRetrieveUserWithFields() {
    ...
    // Act
    User result = org.umetadata.sdk.entities.User.retrieve(userId, fields);
  ...
  void testRetrieveUserByName() {
    ...
    // Act
    User result = org.umetadata.sdk.entities.User.retrieveByName(userName);
  ...
  void testUpdateUser() {
    ...
    // Act
    User result =
        org.umetadata.sdk.entities.User.update(userToUpdate.getId().toString(), userToUpdate);
  ...
  void testDeleteUser() {
    ...
    // Act
    org.umetadata.sdk.entities.User.delete(userId);
  ...
  void testDeleteUserWithOptions() {
    ...
    // Act
    org.umetadata.sdk.entities.User.delete(userId, true, true);

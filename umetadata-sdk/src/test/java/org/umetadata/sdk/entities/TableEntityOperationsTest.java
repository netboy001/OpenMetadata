...
public class TableEntityOperationsTest {
  ...
  void setUp() {
    ...
    org.umetadata.sdk.entities.Table.setDefaultClient(mockClient);
  ...
  void testCreateTableStaticAPI() {
    ...
    // Act - Static API
    Table result = org.umetadata.sdk.entities.Table.create(createRequest);
  ...
  void testRetrieveTableStaticAPI() {
    ...
    // Act - Static API
    Table result = org.umetadata.sdk.entities.Table.retrieve(tableId);
  ...
  void testRetrieveTableWithFields() {
    ...
    // Act - Static API
    Table result = org.umetadata.sdk.entities.Table.retrieve(tableId, fields);
  ...
  void testRetrieveTableByName() {
    ...
    // Act - Static API
    Table result = org.umetadata.sdk.entities.Table.retrieveByName(fqn);
  ...
  void testUpdateTable() {
    ...
    // Act
    Table result = org.umetadata.sdk.entities.Table.update(tableToUpdate);
  ...
  void testDeleteTable() {
    ...
    // Act
    org.umetadata.sdk.entities.Table.delete(tableId);
  ...
  void testDeleteTableWithOptions() {
    ...
    // Act
    org.umetadata.sdk.entities.Table.delete(tableId, true, true);
  ...
  void testFluentTableAddSampleDataFlushesPendingChanges() {
    ...
    org.umetadata.sdk.fluent.wrappers.FluentTable fluentTable =
        new org.umetadata.sdk.fluent.wrappers.FluentTable(initial, mockClient);
  ...
  void testAsyncOperations() throws Exception {
    ...
    // Act
    var future = org.umetadata.sdk.entities.Table.retrieveAsync(tableId);

        ...
        List.of(
            new McpSchema.PromptMessage(
                ...
                new McpSchema.TextContent(
                    String.format(
                        "Search for `%s` in UMetadata where entity type is `%s` and with a limit of `%s` . Summarise the information for all the results properly and also make sure to provide clickable links using the href field from the results.",

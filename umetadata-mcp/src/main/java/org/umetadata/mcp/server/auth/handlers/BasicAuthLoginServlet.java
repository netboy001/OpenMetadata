...
import org.umetadata.mcp.server.auth.html.HtmlTemplates;
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    try {
      ...
      try {
        ...
        org.umetadata.schema.services.connections.metadata.AuthProvider provider =
            SecurityConfigurationManager.getCurrentAuthConfig().getProvider();
        if (provider != org.umetadata.schema.services.connections.metadata.AuthProvider.LDAP) {

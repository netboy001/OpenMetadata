package org.umetadata.mcp.server.auth.handlers;

import static org.umetadata.service.security.AuthenticationCodeFlowHandler.OIDC_CREDENTIAL_PROFILE;
...
import org.umetadata.mcp.server.auth.provider.UserSSOOAuthProvider;
import org.umetadata.mcp.server.auth.repository.McpPendingAuthRequestRepository;
import org.umetadata.mcp.server.auth.validators.IdTokenValidator;
 ...
 *
 * <ol>
 *   <li><b>Flow 1: Claude Desktop ↔ UMetadata (MCP OAuth)</b>
 *       <ul>
 ...
 *       </ul>
 *   <li><b>Flow 2: UMetadata ↔ Google (SSO OAuth)</b>
 *       <ul>

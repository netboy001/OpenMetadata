package org.umetadata.mcp.server.auth.provider;

import static org.umetadata.common.utils.CommonUtil.nullOrEmpty;
import static org.umetadata.service.security.AuthenticationCodeFlowHandler.getHttpSession;
...
import org.umetadata.mcp.auth.AccessToken;
import org.umetadata.mcp.auth.AuthorizationCode;
import org.umetadata.mcp.auth.AuthorizationParams;
import org.umetadata.mcp.auth.OAuthAuthorizationServerProvider;
import org.umetadata.mcp.auth.OAuthClientInformation;
import org.umetadata.mcp.auth.OAuthToken;
import org.umetadata.mcp.auth.RefreshToken;
import org.umetadata.mcp.auth.exception.AuthorizeException;
import org.umetadata.mcp.auth.exception.RegistrationException;
import org.umetadata.mcp.auth.exception.TokenException;
import org.umetadata.mcp.server.auth.handlers.RevocationHandler;
import org.umetadata.mcp.server.auth.repository.McpPendingAuthRequestRepository;
import org.umetadata.mcp.server.auth.repository.OAuthAuthorizationCodeRepository;
import org.umetadata.mcp.server.auth.repository.OAuthClientRepository;
import org.umetadata.mcp.server.auth.repository.OAuthTokenRepository;
import org.umetadata.mcp.server.auth.util.UriUtils;
...
import org.umetadata.service.jdbi3.oauth.OAuthRecords.McpPendingAuthRequest;
import org.umetadata.service.jdbi3.oauth.OAuthRecords.OAuthAuthorizationCodeRecord;
 ...
 *
 * <p>This provider integrates UMetadata's authentication system with MCP OAuth. It auto-detects
 * the authentication method based on UMetadata configuration and handles:
 *
 * <ol>
 ...
 *   <li>Issues UMetadata JWT tokens after code exchange
 ...
 *
 * @see org.umetadata.service.security.AuthenticationCodeFlowHandler
 * @see org.umetadata.service.security.auth.AuthenticatorHandler
 * @see org.umetadata.service.security.jwt.JWTTokenGenerator
 */
@Slf4j
public class UserSSOOAuthProvider implements OAuthAuthorizationServerProvider {
  ...
  private String getBaseUrl() {
    try {
      org.umetadata.schema.api.configuration.MCPConfiguration mcpConfig =
          org.umetadata.service.security.auth.SecurityConfigurationManager.getCurrentMcpConfig();
    ...
    try {
      org.umetadata.service.jdbi3.SystemRepository systemRepo =
          org.umetadata.service.Entity.getSystemRepository();
      org.umetadata.schema.settings.Settings baseUrlSettings =
          systemRepo.getOMBaseUrlConfigInternal();
      if (baseUrlSettings != null) {
        org.umetadata.schema.api.configuration.UMetadataBaseUrlConfiguration baseUrlConfig =
  ...
  public void handleSSOCallbackWithDbState(
    ...
    // Verify user exists in UMetadata BEFORE generating an auth code.
    ...
    try {
      ...
      LOG.warn("SSO-authenticated user not found in UMetadata. Denying access.");
      ...
      response
          ...
          .write(
              "<!DOCTYPE html><html><head><meta charset=\"UTF-8\">"
                  ...
                  + "<div class=\"card\">"
                  + "<h1>Access Denied</h1>"
                  + "<p>Your account is not registered in UMetadata.</p>"

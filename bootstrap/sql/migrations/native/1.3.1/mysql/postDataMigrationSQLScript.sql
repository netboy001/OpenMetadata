...
-- If the test definition has UMetadata as a test platform, then the provider is system, else it is user
UPDATE test_definition
SET json = CASE
		WHEN JSON_CONTAINS(json, '"UMetadata"', '$.testPlatforms') THEN JSON_INSERT(json,'$.provider','system')

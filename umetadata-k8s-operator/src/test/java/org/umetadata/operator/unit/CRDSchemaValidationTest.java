...
package org.umetadata.operator.unit;
...
import org.umetadata.operator.model.CronOMJobResource;
import org.umetadata.operator.model.CronOMJobSpec;
import org.umetadata.operator.model.CronOMJobStatus;
import org.umetadata.operator.model.OMJobPhase;
import org.umetadata.operator.model.OMJobResource;
import org.umetadata.operator.model.OMJobSpec;
import org.umetadata.operator.model.OMJobStatus;
...
class CRDSchemaValidationTest {
  ...
  void testOMJobResourceCanBeFullyPopulated() {
    ...
    exitHandlerSpec.setImage("umetadata/ingestion:latest");
    ...
    ObjectMeta metadata =
        new ObjectMetaBuilder()
            .withName("test-omjob")
            .withNamespace("umetadata")
            .withLabels(Map.of("app.kubernetes.io/name", "umetadata"))
            .build();
    ...
    assertEquals("umetadata/ingestion:latest", resource.getSpec().getMainPodSpec().getImage());
  ...
  void testCronOMJobResourceCanBeFullyPopulated() {
    ...
    OMJobSpec.OMJobPodSpec podSpec = new OMJobSpec.OMJobPodSpec();
    podSpec.setImage("umetadata/ingestion:latest");

...
package org.umetadata.operator.controller;
...
import org.umetadata.operator.config.OperatorConfig;
...
import org.umetadata.operator.service.EventPublisher;
import org.umetadata.operator.service.PodManager;
...
class OMJobReconcilerTest {
  ...
  private OMJobResource createOMJobInPhase(OMJobPhase phase) {
    ...
    mainPodSpec.setImage("umetadata/ingestion:test");

    OMJobSpec.OMJobPodSpec exitHandlerSpec = new OMJobSpec.OMJobPodSpec();
    exitHandlerSpec.setImage("umetadata/ingestion:test");
    ...
    omJob.setMetadata(
        new ObjectMetaBuilder()
            ...
            .withLabels(
                Map.of(
                    "app.kubernetes.io/name", "umetadata",

...
package org.umetadata.operator.model;
...
public class CronOMJobStatus {
  ...
  public String getLastOMJobName() {
    return lastOMJobName;
  }

  public void setLastOMJobName(String lastOMJobName) {
    this.lastOMJobName = lastOMJobName;
  }

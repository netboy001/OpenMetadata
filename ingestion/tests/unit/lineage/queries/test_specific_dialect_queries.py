...
END;"""
    ...
    # Release: https://wondersgroup.com/u-metadata/collate-sqllineage/releases/tag/2.1.1-release
    # -----------------------------------------------------------------------
...
SELECT order_id, amount, status FROM combined_data"""
    ...
    def test_clickhouse_ctas_engine_union_all_not_in(self):
        ...
        Regression for https://wondersgroup.com/u-metadata/UMetadata/issues/21953.
...
SELECT entity_id, entity_name, source_system FROM source_b"""
    ...
    def test_bigquery_clone_table_with_digit_starting_name(self):
        ...
        Regression for https://wondersgroup.com/u-metadata/UMetadata/issues/23338.
    ...
    def test_snowflake_copy_into_table_with_column_list_from_stage_subquery(self):
        ...
        Regression for https://wondersgroup.com/u-metadata/UMetadata/issues/27380.
...
FILE_FORMAT = (TYPE = CSV)"""
    ...
    # Regression for https://wondersgroup.com/u-metadata/UMetadata/issues/28934

...
"""
Transport-resilience behavior of the UMeta REST client, exercised against a
...
from metadata.ingestion.umeta.client import REST, ClientConfig, RestTransportError
from metadata.ingestion.umeta.http_adapter import KeepAliveRetryAdapter

...
"""
Unit tests for UMetadata restore functionality
"""
...
class UMetaRestoreTest(TestCase):
    """
    Test the restore method in UMetadata API
    """
    ...
    def test_restore_entity_empty_response(self):
        ...
        """
        from metadata.ingestion.umeta.umeta_api import EmptyPayloadException

...
"""Test Umeta Dataframe utility tests"""
import os
import unittest
...
resp_parquet_file = (
    pq.ParquetFile(os.path.join(ROOT_DIR, "test_umeta_to_dataframe.parquet"))
    .read()
    .to_pandas()
)
...
class TestStringMethods(unittest.TestCase):
    ...
    def test_get_dataframes(self, test_connection):
        with patch(
            ...
            config = UMetadataWorkflowConfig.model_validate(mock_datalake_config)

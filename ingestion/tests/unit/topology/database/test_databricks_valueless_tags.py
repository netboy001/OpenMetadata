...
class TestDatabricksUmetaTagCallArgs:
    """_umeta_tag_call_args maps Databricks (tag_name, tag_value) onto the
    ...
    def test_valued_tag_uses_tag_name_as_classification(self):
        args = DatabricksSource._umeta_tag_call_args("pii", "ssn")
    ...
    def test_valueless_tag_falls_back_to_valueless_classification(self):
        args = DatabricksSource._umeta_tag_call_args("class.us_ssn", None)
    ...
    def test_empty_string_tag_value_is_treated_as_valueless(self):
        args = DatabricksSource._umeta_tag_call_args("plain_tag", "")
    ...
    def test_valueless_tag_without_dot_uses_tag_name_verbatim(self):
        args = DatabricksSource._umeta_tag_call_args("simple_label", None)
...
class TestDatabricksYieldSkipsEmptyTagName:
    ...
    @patch(
        "metadata.ingestion.source.database.databricks.metadata.get_umeta_tag_and_classification",
        return_value=[],
    )

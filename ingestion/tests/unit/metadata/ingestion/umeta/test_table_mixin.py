...
"""
Unit tests for the pre-serialization loop in UMetaTableMixin.ingest_table_sample_data
...
from metadata.ingestion.umeta.mixins.table_mixin import (
    UMetaTableMixin,
    _sanitize_sample_data_value,
)


def _make_mixin() -> UMetaTableMixin:
    mixin = UMetaTableMixin.__new__(UMetaTableMixin)

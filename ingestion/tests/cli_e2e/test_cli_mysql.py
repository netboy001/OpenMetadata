...
class MysqlCliTest(CliCommonDB.TestSuite, SQACommonMethods):
    ...
    drop_table_query: str = """
        DROP TABLE IF EXISTS umetadata_db.persons;
    """

    drop_view_query: str = """
        DROP VIEW  IF EXISTS umetadata_db.view_persons;
    """
    ...
    def expected_lineage_node(self) -> str:
        return "local_mysql.default.umetadata_db.view_persons"

    @staticmethod
    def fqn_created_table() -> str:
        return "local_mysql.default.umetadata_db.persons"

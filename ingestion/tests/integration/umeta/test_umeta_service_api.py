...
"""
UMetadata high-level API Chart test
"""
...
class UMetaServiceTest(TestCase):
    ...
    admin_metadata = UMetadata(server_config)
    ...
    server_config.securityConfig = UMetadataJWTClientConfig(
    ...
    def test_create_db_service_without_connection(self):
        ...
        metadata_no_password = UMetadata(server_config)

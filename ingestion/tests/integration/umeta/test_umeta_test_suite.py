...
"""
UMetadata API test suite mixin test
"""
...
from metadata.generated.schema.tests.testCase import TestCase as UMetaTestCase
...
class UMetaTestSuiteTest(TestCase):
    """
    ...
    def test_get_or_create_test_case(self):
        ...
        assert isinstance(test_case, UMetaTestCase)
    ...
    def test_create_test_case(self):
        ...
        test_case = self.metadata.get_by_name(
            entity=UMetaTestCase, fqn=test_case_fqn, fields=["*"]
        )

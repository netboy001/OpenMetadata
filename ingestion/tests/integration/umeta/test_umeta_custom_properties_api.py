...
"""
UMetadata high-level API Custom Properties Test
"""
...
class UMetaCustomAttributeTest(TestCase):
    """
    ...
    def create_custom_property(self):
        ...
        umeta_custom_property_request = UMetaCustomProperties(
            entity_type=Table,
        ...
        self.metadata.create_or_update_custom_property(
            umeta_custom_property=umeta_custom_property_request
        )
    ...
    def test_date_time_custom_properties(self):
        ...
        date_property = UMetaCustomProperties(
            entity_type=Table,
            createCustomPropertyRequest=CreateCustomPropertyRequest(
                name="CreationDate",
        ...
        self.metadata.create_or_update_custom_property(
            umeta_custom_property=date_property
        )

        # Test DATETIME custom property
        datetime_property = UMetaCustomProperties(
            entity_type=Table,
            createCustomPropertyRequest=CreateCustomPropertyRequest(
        ...
        self.metadata.create_or_update_custom_property(
            umeta_custom_property=datetime_property
        )

        # Test TIME custom property
        time_property = UMetaCustomProperties(
            entity_type=Table,
            createCustomPropertyRequest=CreateCustomPropertyRequest(
        ...
        self.metadata.create_or_update_custom_property(
            umeta_custom_property=time_property
        )
    ...
    def test_all_custom_property_data_types(self):
        ...
        for data_type, name, description, custom_property_config in test_cases:
            with self.subTest(data_type=data_type):
                ...
                property_request = UMetaCustomProperties(
                    entity_type=Table,
                ...
                result = self.metadata.create_or_update_custom_property(
                    umeta_custom_property=property_request
                )

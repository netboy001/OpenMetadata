...
"""
UMetadata high-level API Suggestion test
"""
...
def _create_bot(metadata: UMetadata) -> Tuple[User, Bot]:
    """Create a bot"""
...
class UMetaSuggestionTest(TestCase):
    """

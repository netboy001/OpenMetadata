...
"""
UMetadata Airflow Lineage Operator
"""
import logging
import traceback
...
class UMetadataLineageOperator(BaseOperator):
    """
    This Operator will check the inlets and outlets of its DAG
    and push the lineage to UMetadata.

    It requires the UMetadataConnection to be passed as
    an argument to instantiate the umeta client.
    ...
    def execute(self, context: Context) -> None:
        ...
        and push it to UMetadata using the Python Client.
        """
        try:
            ...
            metadata = UMetadata(self.server_config)

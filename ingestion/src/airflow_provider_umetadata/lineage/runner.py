...
"""
UMetadata Airflow Provider Lineage Runner
"""
import logging
import os
...
from airflow_provider_umetadata.lineage.status import STATUS_MAP
...
class AirflowLineageRunner:
    """
    Given the UMetadata connection, a service name and a DAG:

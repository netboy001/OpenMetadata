...
from metadata.ingestion.umeta.mixins.patch_mixin_utils import (
    UMetaPatchMixinBase,
    PatchField,
    PatchOperation,
    PatchPath,
...
class UMetaRolePolicyMixin(UMetaPatchMixinBase):
    """
    UMetadata API methods related to Roles and Policies.
    ...
    def patch_policy_rule(
        ...
        if operation == PatchOperation.ADD:
            ...
            for rule_index in range(len(instance.rules.root) - 1, -1, -1):
                ...
                data += UMetaRolePolicyMixin._get_optional_rule_patch(
                ...
                # Operations
                data += UMetaRolePolicyMixin._get_rule_merge_patches(

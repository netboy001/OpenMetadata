...
from metadata.ingestion.umeta.client import REST, APIError
from metadata.ingestion.umeta.utils import get_entity_type, model_str, quote
...
class UMetaLineageMixin(Generic[T]):
    """
    UMetadata API methods related to Lineage.

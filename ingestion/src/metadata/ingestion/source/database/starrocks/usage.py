...
class StarRocksUsageSource(StarRocksQueryParserSource, UsageSource):
    """
    Implements the necessary methods to extract
    Database usage metrics from StarRocks audit logs.

    Extracts query usage for all SELECT queries.
    """

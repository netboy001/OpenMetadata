...
"""
Enhanced NER Scanner that uses custom recognizers from UMetadata classifications.
"""
...
class CustomNERScanner:
    """NER Scanner that uses custom recognizers from UMetadata configurations."""
    ...
    def _map_results_to_tags(
        ...
        """
        Map Presidio recognizer results to UMetadata tag labels.

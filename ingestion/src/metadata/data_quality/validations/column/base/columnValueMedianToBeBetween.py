...
MEDIAN_METRIC_NAME = "median"


class BaseColumnValueMedianToBeBetweenValidator(BaseTestValidator):
    """Validator for column value median to be between test case"""

    MIN_BOUND = "minValueForMedianInCol"
    MAX_BOUND = "maxValueForMedianInCol"
    ...
    def _run_validation(self) -> TestCaseResult:
        ...
        try:
            ...
            return self.get_test_case_result_object(
                ...
                msg,
                [TestResultValue(name=MEDIAN_METRIC_NAME, value=None)],
            )
    ...
    def _evaluate_test_condition(
        ...
        matched = min_bound <= median_value <= max_bound
    ...
    def _format_result_message(
        ...
        if dimension_info:
            return (
                ...
                f"Found median={median_value} vs. the expected minBound={min_bound}, maxBound={max_bound}"
            )
        else:
            return f"Found median={median_value} vs. the expected minBound={min_bound}, maxBound={max_bound}."

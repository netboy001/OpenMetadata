...
class ColumnValueMinToBeBetweenValidator(
    ...
    def _execute_dimensional_validation(
        ...
        For min validator, we accumulate min values across dataframes to accurately
        compute the overall min per dimension. MIN aggregates naturally: min(min1, min2, ...) = overall_min.

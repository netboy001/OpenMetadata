...
"""
Utility functions to create u metadata connections from yaml file
"""
...
def create_umeta_connection_obj(config: str) -> UMetadataConnection:
    """Create UMetadata connection"""
    return UMetadataConnection.model_validate(yaml.safe_load(config))

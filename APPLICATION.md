...
in `umetadata-spec/src/main/resources/json/schema/entity/applications/configuration` define the json schema representing your application configuration.
...
in `umetadata-service/src/main/resources/json/data/app` define the default setting of your application. Create a new json following this naming convention `<youAppName>Application.json`

## Define your app in the Application Marketplace

In `umetadata-service/src/main/resources/json/data/appMarketPlaceDefinition`, define the elements of your application as they will appear in the app marketplace.
...
In `umetadata-ui/src/main/resources/ui/src/utils/ApplicationSchemas` add the config for your application so it can be rendered from the UI. Follow this naming convention `<yourAppName>Application.json`

## Implement Java class
In `umetadata-service/src/main/java/org/umetadata/service/apps/bundles` implement the java class corresponding to your application.
...
Setting `preview: false` will prevent users from being able to install the application. The private configuration parameters can be set at `umetadata-spec/src/main/resources/json/schema/entity/applications/configuration/private`

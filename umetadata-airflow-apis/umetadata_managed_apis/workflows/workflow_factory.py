...
from umetadata_managed_apis.utils.logger import workflow_logger
from umetadata_managed_apis.workflows.config import load_config_file
from umetadata_managed_apis.workflows.workflow_builder import WorkflowBuilder
...
class WorkflowFactory:
    ...
    def __init__(self, airflow_pipeline: IngestionPipeline) -> None:
        ...
        SecretsManagerFactory(
            airflow_pipeline.uMetadataServerConnection.secretsManagerProvider,
            airflow_pipeline.uMetadataServerConnection.secretsManagerLoader,
        )

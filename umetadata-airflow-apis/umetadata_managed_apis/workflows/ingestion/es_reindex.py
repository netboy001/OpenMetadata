...
from umetadata_managed_apis.workflows.ingestion.common import (
...
def build_es_reindex_workflow_config(
    ...
    umetadata_service: MetadataService = metadata.get_by_name(
        entity=MetadataService, fqn=ingestion_pipeline.service.fullyQualifiedName
    )
    if not umetadata_service:
        raise GetServiceException(service_type="metadata", service_name="UMetadata")

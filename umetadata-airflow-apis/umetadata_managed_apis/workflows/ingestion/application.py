...
from umetadata_managed_apis.utils.logger import set_operator_logger
...
def application_workflow(workflow_config: UMetadataApplicationConfig, **context):
    """
...
def build_application_workflow_config(
    ...
    application_workflow_config = UMetadataApplicationConfig(

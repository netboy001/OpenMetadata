...
from umetadata_managed_apis import __version__
from umetadata_managed_apis.utils.airflow_version import (
    get_base_url_config,
    is_airflow_3_or_higher,
)

PLUGIN_NAME = "umetadata_managed_apis"
REST_API_ENDPOINT = (
    "/api/v2/umetadata/" if is_airflow_3_or_higher() else "/api/v1/umetadata/"
)

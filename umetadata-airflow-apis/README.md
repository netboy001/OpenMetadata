...
```bash
export AIRFLOW_HOME=$(pwd)/umetadata-airflow-managed-api/development/airflow
airflow webserver
```
...
```
pip install umetadata-airflow-managed-apis       
```

...
if "AIRFLOW__UMETADATA_AIRFLOW_APIS__DAG_GENERATED_CONFIGS" not in os.environ:
    os.environ[
        "AIRFLOW__UMETADATA_AIRFLOW_APIS__DAG_GENERATED_CONFIGS"
    ] = "/tmp/airflow"
if "AIRFLOW__UMETADATA_AIRFLOW_APIS__DAG_RUNNER_TEMPLATE" not in os.environ:
    template_path = (
        Path(__file__).parent.parent.parent.parent
        / "umetadata_managed_apis/resources/dag_runner.j2"
    )
    ...
    os.environ["AIRFLOW__UMETADATA_AIRFLOW_APIS__DAG_RUNNER_TEMPLATE"] = str(
...
from umetadata_managed_apis.operations.delete import delete_dag_id
from umetadata_managed_apis.operations.deploy import DagDeployer
from umetadata_managed_apis.operations.kill_all import kill_all
from umetadata_managed_apis.operations.state import disable_dag, enable_dag
from umetadata_managed_apis.operations.status import status
from umetadata_managed_apis.operations.trigger import trigger
...
class TestAirflowOps(TestCase):
    ...
    conn = UMetadataConnection(
        hostPort=os.getenv("UMETADATA_HOST_PORT", "http://localhost:8585/api"),
    ...
    def test_dag_deploy_and_delete(self):
        ...
        ingestion_pipeline = IngestionPipeline(
            ...
            uMetadataServerConnection=self.conn,

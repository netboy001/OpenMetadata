...
from umetadata_managed_apis.workflows.ingestion.lineage import (
    build_lineage_workflow_config,
)
from umetadata_managed_apis.workflows.ingestion.metadata import (
    build_metadata_workflow_config,
)
from umetadata_managed_apis.workflows.ingestion.profiler import (
...
from umetadata_managed_apis.workflows.ingestion.usage import (
...
class UMetaServiceTest(TestCase):
    """
    ...
    def test_ingestion_workflow(self):
        ...
        ingestion_pipeline = IngestionPipeline(
            ...
            uMetadataServerConnection=self.server_config,

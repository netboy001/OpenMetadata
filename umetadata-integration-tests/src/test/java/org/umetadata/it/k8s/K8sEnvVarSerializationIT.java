...
import org.umetadata.service.clients.pipeline.k8s.CronOMJob;
import org.umetadata.service.clients.pipeline.k8s.K8sJobUtils;
import org.umetadata.service.clients.pipeline.k8s.OMJob;
...
class K8sEnvVarSerializationIT {
  ...
  private static final String NAMESPACE = "umetadata-pipelines-test";
  ...
  void testOMJobSerializationPreservesConfigMapKeyRef() {
    ...
    OMJob.OMJobPodSpec podSpec =
        OMJob.OMJobPodSpec.builder()
            .image("umetadata/ingestion:latest")

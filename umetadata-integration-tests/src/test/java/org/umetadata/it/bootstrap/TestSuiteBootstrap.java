...
package org.umetadata.it.bootstrap;
...
import org.umetadata.schema.api.configuration.pipelineServiceClient.Parameters;
...
import org.umetadata.schema.type.IndexMappingLanguage;
 ...
 * UMetadata application) ONCE per test session and shares them across all IT test classes.
 *
...
public class TestSuiteBootstrap implements LauncherSessionListener {
  ...
  private static final String CONFIG_PATH =
      ResourceHelpers.resourceFilePath("umetadata-secure-test.yaml");
  ...
  private static final String ELASTIC_SEARCH_CLUSTER_ALIAS = "umetadata";
  ...
  private static final String FUSEKI_DATASET = "umetadata";
  ...
  private static final String K8S_NAMESPACE = "umetadata-pipelines";
  ...
  private static DropwizardAppExtension<UMetadataApplicationConfig> APP;
  ...
  public void launcherSessionOpened(LauncherSession session) {
    ...
    try {
      ...
      LOG.info("UMetadata: http://localhost:{}", APP.getLocalPort());
  ...
  private void startDatabase() {
    ...
    if ("mysql".equalsIgnoreCase(databaseType)) {
      ...
      mysql.withDatabaseName("umetadata");
      ...
      postgres.withDatabaseName("umetadata");
  ...
  private void startK3s() {
    ...
    org.umetadata.service.clients.pipeline.PipelineServiceClientFactory.reset();
  ...
  private void startApplication() throws Exception {
    LOG.info("Starting UMetadata application...");

    UMetadataApplicationConfig config = readTestAppConfig(CONFIG_PATH);
    ...
    if (projectRoot.endsWith("umetadata-integration-tests")) {
    ...
    if (config.getMigrationConfiguration() == null) {
      config.setMigrationConfiguration(
          new org.umetadata.service.migration.MigrationConfiguration());
    }
    ...
    String testResourcesPath = projectRoot + "/umetadata-integration-tests/src/test/resources/";
    config
    ...
    APP = new DropwizardAppExtension<>(UMetadataApplication.class, config);
    ...
    LOG.info("UMetadata application started on port {}", APP.getLocalPort());
  }

  private UMetadataApplicationConfig readTestAppConfig(String path)
  ...
  private void configurePipelineServiceClient(UMetadataApplicationConfig config) {
    ...
    if (kubeConfigYaml != null) {
      ...
      pipelineConfig.setClassName(
          "org.umetadata.service.clients.pipeline.k8s.K8sPipelineClient");
      ...
      params.setAdditionalProperty("ingestionImage", "umetadata/ingestion:latest");
  ...
  private void configureRdf(UMetadataApplicationConfig config) {
  ...
  public static synchronized void setupK8s() {
    ...
    PipelineServiceClientConfiguration pipelineConfig = new PipelineServiceClientConfiguration();
    pipelineConfig.setEnabled(true);
    pipelineConfig.setClassName("org.umetadata.service.clients.pipeline.k8s.K8sPipelineClient");
    ...
    org.umetadata.sdk.PipelineServiceClientInterface pipelineClient =
        org.umetadata.service.clients.pipeline.PipelineServiceClientFactory
    ...
    try {
      org.umetadata.service.jdbi3.IngestionPipelineRepository repository =
          (org.umetadata.service.jdbi3.IngestionPipelineRepository)
              org.umetadata.service.Entity.getEntityRepository("ingestionPipeline");

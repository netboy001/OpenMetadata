...
public final class SharedEntities {
   ...
   */
  public static void initialize(UMetadataClient adminClient) {
    if (INSTANCE != null) {
    ...
    try {
      ...
      org.umetadata.schema.api.teams.CreateRole createTestRole =
          new org.umetadata.schema.api.teams.CreateRole()
   ...
   */
  public static void cleanup(UMetadataClient adminClient) {
    if (INSTANCE == null) {

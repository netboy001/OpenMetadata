...
public class MultiDomainHasDomainIT {
                ...
                try {
                  ...
                  try {
                    ...
                    try {
                      ...
                      try {
                        UMetadataClient testUserClient =
  ...
  private Domain createDomain(UMetadataClient adminClient, String name) {
  ...
  private Policy createHasDomainPolicy(UMetadataClient adminClient, String name) {
  ...
  private Role createRole(UMetadataClient adminClient, String name, String policyFqn) {
  ...
  private Team createTeam(
      UMetadataClient adminClient, String name, Role role, List<String> domainFqns) {
  ...
  private User createUser(UMetadataClient adminClient, String name, String email, Team team) {
  ...
  private Table createTableWithoutDomain(
      UMetadataClient adminClient, String name, String schemaFqn, Column column) {
    CreateTable createTable = new CreateTable();
    createTable.setName(name);
    createTable.setDatabaseSchema(schemaFqn);
    createTable.setColumns(List.of(column));
  ...
  private boolean enableSearchAccessControl(UMetadataClient adminClient) throws Exception {
    String settingsJson =
        adminClient
            .getHttpClient()
            .executeForString(
  ...
  private void restoreSearchAccessControl(UMetadataClient adminClient, boolean original)
      throws Exception {
    if (!original) {
      adminClient
          .getHttpClient()

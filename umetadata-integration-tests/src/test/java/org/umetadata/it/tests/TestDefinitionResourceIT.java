...
import org.umetadata.service.resources.dqtests.TestDefinitionResource;
 ...
 *
 * <p>Migrated from: org.umetadata.service.resources.dqtests.TestDefinitionResourceTest
 */
...
public class TestDefinitionResourceIT extends BaseEntityIT<TestDefinition, CreateTestDefinition> {
  ...
  void post_testDefinitionWithMultiplePlatforms_200_OK(TestNamespace ns) {
    ...
    request.setEntityType(TestDefinitionEntityType.TABLE);
    request.setTestPlatforms(Arrays.asList(TestPlatform.U_METADATA, TestPlatform.DBT));
  ...
  void test_testDefinitionNameUniqueness(TestNamespace ns) {
    ...
    request1.setTestPlatforms(List.of(TestPlatform.U_METADATA));
    ...
    request2.setTestPlatforms(List.of(TestPlatform.U_METADATA));

...
class LineageImpactAnalysisBenchmarkIT {
  ...
  private void runScenario(
      UMetadataClient client, SharedEntities shared, BenchmarkScenario scenario)
      throws Exception {
  ...
  private void addLineageWithColumns(UMetadataClient client, Table from, Table to)
      throws Exception {
  ...
  private void waitForIndexing(
      UMetadataClient client, String rootFqn, int depth, int expectedNodeCount) {
  ...
  private BenchmarkObservation runTableInteraction(
      UMetadataClient client, String rootFqn, int depth, String queryFilter) throws Exception {
  ...
  private BenchmarkObservation runColumnInteraction(
      UMetadataClient client, String rootFqn, int depth, String queryFilter, String columnFilter)
      throws Exception {
    String response =
        client
            .lineage()
  ...
  private JsonNode getPaginationInfo(UMetadataClient client, String rootFqn, int depth)
      throws Exception {
  ...
  private void cleanupTables(UMetadataClient client, List<Table> tables) {
            ...
            reader
                ...
                .filter(
                    line -> {
                      ...
                      return lowered.contains("umetadata") || lowered.contains("elastic");
                    })
                .collect(Collectors.joining("\n"));
        process.waitFor();
        return snapshot.isEmpty()
            ? "docker stats returned no umetadata/elasticsearch containers"
            : snapshot;
      }

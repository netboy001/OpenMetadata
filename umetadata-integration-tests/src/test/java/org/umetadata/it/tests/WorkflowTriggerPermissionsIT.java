...
import org.umetadata.schema.entity.automations.QueryRunnerRequest;
...
public class WorkflowTriggerPermissionsIT {
  ...
  void test_triggerTestConnection_admin_withServiceName_authPasses(TestNamespace ns)
      throws Exception {
    UMetadataClient admin = SdkClients.adminClient();
                ...
                new DatabaseConnection()
                    .withConfig(
                        new MysqlConnection()
                            ...
                            .withAuthType(new basicAuth().withPassword("umetadata_password"))));
    if (serviceName != null) {
  ...
  private DatabaseService createMysqlService(
      UMetadataClient client, String name, List<EntityReference> owners) {

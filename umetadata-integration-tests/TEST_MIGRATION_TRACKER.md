# Test Migration Tracker: umetadata-service → umetadata-integration-tests
...
| SDK Class | Location |
|-----------|----------|
| `Columns` | `umetadata-sdk/.../fluent/Columns.java` |
| `DataContracts` | `umetadata-sdk/.../fluent/DataContracts.java` |
| `TestCases` | `umetadata-sdk/.../fluent/TestCases.java` |
| `Usage` | `umetadata-sdk/.../fluent/Usage.java` |

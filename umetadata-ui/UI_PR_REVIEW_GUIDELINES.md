...
This document outlines the standards and best practices that must be followed when reviewing pull requests for the UMetadata UI project. GitHub Copilot and human reviewers should use this as a checklist.
...
- [ ] **Theme reference**: Styles reference `umetadata-ui-core-components` theme data

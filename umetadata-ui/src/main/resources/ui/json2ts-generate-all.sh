...
readonly SCHEMA_DIRECTORY='umetadata-spec/src/main/resources/json/schema/'
readonly UI_OUTPUT_DIRECTORY='umetadata-ui/src/main/resources/ui/src/generated'
...
addLicensing(){
    ...
    modified_license=$(sed "s/Copyright [0-9]\{4\}/Copyright ${current_year}/" umetadata-ui/src/main/resources/ui/types-licensing.txt)

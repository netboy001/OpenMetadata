...
schema_directory='umetadata-spec/src/main/resources/json/schema'
om_ui_directory='umetadata-ui/src/main/resources/ui/src/generated'
...
echo "Generating TypeScript from UMetadata specifications"

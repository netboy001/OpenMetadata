...
export const MOCK_LINEAGE_DATA = {
  ...
  nodes: [
    ...
    },
    {
      ...
      fullyQualifiedName:
        'mysql.default.umetadata_db.storage_service_entity',
      deleted: false,
    ...
    },
    {
      ...
      fullyQualifiedName:
        'mysql.default.umetadata_db.dashboard_service_entity',
      deleted: false,
    ...
    },
    {
      ...
      lineageDetails: {
        ...
        columnsLineage: [
          {
            fromColumns: [
              'mysql.default.umetadata_db.dashboard_service_entity.id',
            ],

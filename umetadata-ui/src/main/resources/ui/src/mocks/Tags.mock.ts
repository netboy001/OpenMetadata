...
export const MOCK_TAG_DATA = {
  ...
  classification: {
    ...
    displayName: '',
    deleted: false,
    href: 'http://sandbox-beta.wondersgroup.com/api/v1/classifications/16c5865a-8804-4474-a1dd-14ee9da443b2',
  },
  version: 0.1,
  updatedAt: 1704261482857,
  updatedBy: 'ashish',
  href: 'http://sandbox-beta.wondersgroup.com/api/v1/tags/e8bc85c8-a87f-471c-872e-46904c5ea888',
  deprecated: false,
  deleted: false,
  provider: 'user',

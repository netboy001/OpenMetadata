...
export const mockApplicationData = {
  ...
  features: 'Sync UMetadata and Elastic Search and Recreate Indexes.',
  ...
  className: 'org.umetadata.service.apps.bundles.searchIndex.SearchIndexApp',
...
export const mockExternalApplicationData = {
  ...
  updatedBy: 'joseph',
  href: 'http://demo.wondersgroup.com/api/v1/apps/633f579c-512c-4b5f-864b-5664aa56b37f',
  deleted: false,
  developer: 'Collate Inc.',
  developerUrl: 'https://www.wondersgroup.com',
  privacyPolicyUrl: 'https://www.wondersgroup.com',
  ...
  pipelines: [
    {
      ...
      name: 'CollateAIApplication',
      fullyQualifiedName: 'UMetadata.CollateAIApplication',
      description: 'Test Description',
      displayName: 'Collate AI',
      deleted: false,
    },

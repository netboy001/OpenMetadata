...
export const MOCK_ATHENA_SERVICE = {
  ...
  type: 'object',
  javaType:
    'org.umetadata.schema.services.connections.database.AthenaConnection',
  definitions: {
    athenaType: {
  ...
  properties: {
    ...
    awsConfig: {
      ...
      type: 'object',
      javaType: 'org.umetadata.schema.security.credentials.AWSCredentials',
      properties: {
        awsAccessKeyId: {
    ...
    databaseName: {
      title: 'Database Name',
      description:
        'Optional name to give to the database in UMetadata. If left blank, we will use default as the database name.',
      type: 'string',
    },
    connectionOptions: {
      title: 'Connection Options',
      javaType:
        'org.umetadata.schema.services.connections.database.ConnectionOptions',
      description:
    ...
    connectionArguments: {
      ...
      javaType:
        'org.umetadata.schema.services.connections.database.ConnectionArguments',
      description:
    ...
    supportsQueryComment: {
      ...
      description:
        'For Database Services using SQLAlchemy, True to enable running a comment for all queries run from UMetadata.',
      type: 'boolean',
      default: true,
    },
    ...
    sampleDataStorageConfig: {
      ...
      type: 'object',
      javaType:
        'org.umetadata.schema.services.connections.database.SampleDataStorageConfig',
      properties: {
        config: {
          oneOf: [
            {
                  ...
                  oneOf: [
                    {
                      ...
                      type: 'object',
                      javaType:
                        'org.umetadata.schema.security.credentials.AWSCredentials',
                      properties: {
                        awsAccessKeyId: {
                          title: 'AWS Access Key ID',
                          description: 'AWS Access key ID.',
...
export const AIR_BYTE_CONNECTION = {
  ...
  type: 'object',
  javaType:
    'org.umetadata.schema.services.connections.pipeline.AirbyteConnection',
  definitions: {
    AirbyteType: {
      description: 'Service type.',
      type: 'string',
...
export const ATLAS_CONNECTION = {
  ...
  type: 'object',
  javaType:
    'org.umetadata.schema.services.connections.metadata.AtlasConnection',
  definitions: {
    atlasType: {
      description: 'Service type.',
      type: 'string',

 ...
 */
/**
 * UMetadata Ingestion Framework definition.
 */
export interface Workflow {
    ...
    name: string;
    /**
     * UMetadata Ingestion Workflow Config.
     */
    uMetadataWorkflowConfig: UMetadataWorkflowConfig;
}

/**
 * UMetadata Ingestion Workflow Config.
 */
export interface UMetadataWorkflowConfig {
    bulkSink?: BulkSink;
    /**
     * Enable streaming logs to a remote log storage via the UMetadata Server
     */
...
/**
 * Configuration for BulkSink Component in the UMetadata Ingestion Framework.
 */
...
/**
 * Configuration for Processor Component in the UMetadata Ingestion Framework.
 */
...
/**
 * Configuration for Source component in UMetadata Ingestion Framework.
 */
 ...
 *
 * Custom MlModel Service connection to build a source that is not supported by UMetadata
 * yet.
 *
 ...
 * GCS Connection.
 *
 * Custom Storage Service connection to build a source that is not supported by UMetadata
 * yet.
 *
...
export interface ConfigObject {
    ...
    apiHost?: string;
    /**
     * URL of your Domo instance, e.g., https://umetadata.domo.com
     */
    ...
    pageSize?: number;
    /**
     * Whether to import Hex project categories as UMetadata tags
     *
     ...
     * database. When left blank, UMetadata Ingestion attempts to scan all the databases.
     */
    database?: string;
    /**
     ...
     * restrict the metadata reading to a single schema. When left blank, UMetadata Ingestion
     ...
     * UMetadata Ingestion attempts to scan all the catalog.
     *
     * Presto catalog
     *
    ...
    /**
     * Custom UMetadata Classification name for Postgres policy tags.
     *
     * Custom UMetadata Classification name for TimescaleDB policy tags.
     */
    ...
    /**
     * Custom UMetadata Classification name for alation tags.
     */
    ...
    /**
     * Enable enrichment of existing UMetadata assets with Collibra metadata (descriptions,
     * tags, owners). When enabled, the connector will match Collibra assets to UMetadata
    ...
    /**
     * Map OpenLineage dataset namespaces (or prefixes) to UMetadata database service names.
...
export interface Pipeline {
    ...
    /**
     * Optional configuration to soft delete schemas in UMetadata if the source schemas are
    ...
    /**
     * Optional configuration to soft delete dashboards in UMetadata if the source dashboards
    ...
    /**
     * Optional configuration to soft delete topics in UMetadata if the source topics are
    ...
    /**
     * Optional configuration to soft delete MlModels in UMetadata if the source MlModels are
    ...
    containerFilterPattern?: FilterPattern;
    /**
     * Optional configuration to soft delete containers in UMetadata if the source containers
    ...
    /**
     * Optional configuration to soft delete spreadsheets in UMetadata if the source
    ...
    /**
     * Optional configuration to soft delete worksheets in UMetadata if the source worksheets
    ...
    /**
     * Optional configuration to soft delete search indexes in UMetadata if the source search
    ...
    verifyCerts?: boolean;
    /**
     * Custom UMetadata Classification name for dbt tags.
     */
    ...
    apiEndpointFilterPattern?: FilterPattern;
    /**
     * Optional configuration to soft delete api collections in UMetadata if the source
...
/**
 * Configuration for Stage Component in the UMetadata Ingestion Framework.
 */
...
export interface UMetadataConnection {
     ...
     * Configuration for Sink Component in the UMetadata Ingestion Framework.
     */
    elasticsSearch?: UMetadataServerConfigElasticsSearch;
    /**
     * Validate Umetadata Server & Client Version.
     */
    enableVersionValidation?: boolean;
 ...
 * Configuration for Sink Component in the UMetadata Ingestion Framework.
 */
export interface UMetadataServerConfigElasticsSearch {
    config?: { [key: string]: any };
    /**
     * Type of sink component ex: metadata
     */

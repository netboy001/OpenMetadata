 ...
 * Unique identifier that identifies an entity instance.
 *
 * This schema defines all possible filters enum in UMetadata.
 */
export enum SettingType {
    ...
    UMetadataBaseURLConfiguration = "uMetadataBaseUrlConfiguration",
 ...
 *
 * This schema defines the UMetadata base URL configuration
 *
 ...
 *
 * Settings for OpenLineage HTTP API integration. Configure how UMetadata receives and
...
export interface PipelineServiceClientConfiguration {
     ...
     * users to matching teams in UMetadata during login.
     */
    ...
    /**
     * Mapping of OpenLineage dataset namespaces to UMetadata Database Service names. Used to
...
export interface AuthConfiguration {
    ...
    /**
     * UMetadata SSO Configuration
     */
    umetadata?: UMetadataJWTClientConfig;
}
 ...
 * Azure SSO Configuration
 *
 * Azure SSO Client security config to connect to UMetadata.
 */
...
/**
 * This schema defines all possible metric types in UMetadata.
 */
...
export interface SampleDataIngestionConfig {
    /**
     * Allows UMetadata to read the sample data. This setting won't save the sample data but
     * sample data will temporarily be brought in UMetadata infrastructure for processing. If
     * reading is disabled but storing is enabled, reading will be enabled by default.
     */
    readSampleData?: boolean;
    /**
     * Allows UMetadata to store the sample data. This setting will override the source
     * configuration.
     */

 ...
 */
/**
 * This schema defines the applications for U-Metadata.
 */
export interface CreateAppMarketPlaceDefinitionReq {
     ...
     * 'org.umetadata.service.apps.AbstractNativeApplication' if you don't have one yet.
     */
    className: string;
    /**
...
/**
 * This defines schema for sending alerts for UMetadata
 */
...
/**
 * This schema defines webhook for receiving events from UMetadata.
 *
 * This schema defines email config for receiving events from UMetadata.
 *

 ...
 */
/**
 * Describes an Access Control Rule for UMetadata Metadata Operations. All non-null user
...
/**
 * This schema defines all possible operations on metadata of entities in UMetadata.
 */

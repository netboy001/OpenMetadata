...
export const ROUTES = {
  ...
  SETTINGS_EDIT_EMAIL_CONFIG: `/settings/UMetadata/email/edit-email-configuration`,
  ...
  SETTINGS_EDIT_CUSTOM_LOGIN_CONFIG: `/settings/UMetadata/loginConfiguration/edit-custom-login-configuration`,
  SETTINGS_OM_URL_CONFIG: `/settings/UMetadata/uMetadataBaseUrlConfiguration/edit-u-metadata-url-configuration`,

...
export const API_COLLECTION_API_ENDPOINTS: APIEndpoint[] = [
  {
    ...
    apiCollection: {
      ...
      displayName: 'store',
      deleted: false,
      href: 'http://sandbox-beta.wondersgroup.com/api/v1/apiCollections/a5580b17-739b-4f86-b72a-96eb5c59de6f',
    },
    href: 'http://sandbox-beta.wondersgroup.com/api/v1/apiEndpoints/eb95db42-9b0d-46e0-945d-dc6a4e115692',
    owners: [],
    service: {
      id: 'c5d3b9ff-c8b4-4d3c-a695-7e94c798e3f8',
      type: 'apiService',
      ...
      displayName: 'pet_api_service',
      deleted: false,
      href: 'http://sandbox-beta.wondersgroup.com/api/v1/services/apiServices/c5d3b9ff-c8b4-4d3c-a695-7e94c798e3f8',
    },
    serviceType: APIServiceType.REST,
    deleted: false,
  ...
  },
  {
    ...
    href: 'http://sandbox-beta.wondersgroup.com/api/v1/apiEndpoints/24f70b58-d285-4f5e-881e-8d27076a3050',
    owners: [],
    service: {
      id: 'c5d3b9ff-c8b4-4d3c-a695-7e94c798e3f8',
      type: 'apiService',
  ...
  },
  {
    ...
    href: 'http://sandbox-beta.wondersgroup.com/api/v1/apiEndpoints/80cebee6-c433-4aca-be10-00835607f434',
    owners: [],
    service: {
      id: 'c5d3b9ff-c8b4-4d3c-a695-7e94c798e3f8',
      type: 'apiService',

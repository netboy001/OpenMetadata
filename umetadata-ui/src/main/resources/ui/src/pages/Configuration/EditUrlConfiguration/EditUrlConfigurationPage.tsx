...
import {
  UMETADATA_URL_CONFIG_SERVICE_CATEGORY,
  U_METADATA,
} from '../../../constants/service-guide.constant';
import { ServiceCategory } from '../../../enums/service.enum';
import { UMetadataBaseURLConfiguration } from '../../../generated/configuration/uMetadataBaseUrlConfiguration';
...
const EditUrlConfigurationPage = () => {
  ...
  const [form] = Form.useForm<UMetadataBaseURLConfiguration>();
  ...
  const fetchCustomLogoConfig = async () => {
    try {
      ...
      const { data } = await getSettingsConfigFromConfigType(
        SettingType.UMetadataBaseURLConfiguration
      );
  ...
  const handleSubmit = async (
    configValues: UMetadataBaseURLConfiguration
  ) => {
    try {
      setUpdating(true);
      const configData = {
        config_type: SettingType.UMetadataBaseURLConfiguration,
  ...
  const firstPanelChildren = (
    <>
      ...
      >
        ...
        >
          <Input
            data-testid="u-metadata-url-input"
            id="root/uMetadataUrl-input"
          />
        </Item>
        <Row justify="end">
          <Col>
  ...
  const secondPanelChildren = (
    <ServiceDocPanel
      ...
      serviceName={UMETADATA_URL_CONFIG_SERVICE_CATEGORY}
      serviceType={U_METADATA as ServiceCategory}
    />
  );

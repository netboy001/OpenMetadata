...
import { U_METADATA } from '../../constants/Services.constant';
...
describe('ServiceDetailsPage', () => {
  ...
  describe('UMetadata Service Handling', () => {
    it('should handle UMetadata service correctly', async () => {
      ...
      // Should not fetch permissions for UMetadata service

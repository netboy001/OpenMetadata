...
jest.mock('../constants/SSO.constant', () => ({
  ...
  DEFAULT_AUTHORIZER_CLASS_NAME:
    'org.umetadata.service.security.DefaultAuthorizer',
...
<EntityDescriptor xmlns="urn:oasis:names:tc:SAML:2.0:metadata" entityID="http://www.okta.com/exk123456">
  <IDPSSODescriptor protocolSupportEnumeration="urn:oasis:names:tc:SAML:2.0:protocol">
    ...
    <SingleSignOnService Binding="urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST" Location="https://dev-123456.okta.com/app/umetadata/exk123456/sso/saml"/>
    <SingleSignOnService Binding="urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect" Location="https://dev-123456.okta.com/app/umetadata/exk123456/sso/saml"/>
  </IDPSSODescriptor>
</EntityDescriptor>`;
...
<EntityDescriptor xmlns="urn:oasis:names:tc:SAML:2.0:metadata" entityID="urn:dev-xyz12345.us.auth0.com">
  ...
  it('should parse Okta metadata correctly', () => {
    ...
    expect(result.ssoLoginUrl).toBe(
      'https://dev-123456.okta.com/app/umetadata/exk123456/sso/saml'
    );

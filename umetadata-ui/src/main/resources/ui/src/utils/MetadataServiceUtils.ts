...
import uMetadataConnection from '../jsons/connectionSchemas/connections/metadata/uMetadataConnection.json';
...
export const getMetadataConfig = (type: MetadataServiceType) => {
  ...
  switch (type) {
    ...
    case MetadataServiceType.UMetadata: {
      schema = uMetadataConnection;

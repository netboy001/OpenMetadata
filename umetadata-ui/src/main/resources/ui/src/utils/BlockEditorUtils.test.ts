...
describe('transformImgTagsToFileAttachment', () => {
  ...
  describe('UMetadata Migration Scenarios', () => {
    it('should recognize legacy UMetadata format patterns', () => {
    ...
    it('should handle real UMetadata migration scenario', () => {
      // Actual data from the user's example
      const oldUMetadataImage =
        '<p><img src="https://placebear.com/g/200/200"></p>';

      expect(oldUMetadataImage).toContain('placebear.com');
      expect(oldUMetadataImage).toContain('<p><img');

      // Test that function doesn't crash with real data
      expect(() =>
        transformImgTagsToFileAttachment(oldUMetadataImage)
      ).not.toThrow();
    });
  ...
  describe('Real-world Edge Cases', () => {
    ...
    it('should handle UMetadata specific scenarios', () => {
      // Test scenarios specific to UMetadata migration
      const scenarios = [
        {

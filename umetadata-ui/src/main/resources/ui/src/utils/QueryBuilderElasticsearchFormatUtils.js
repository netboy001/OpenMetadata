...
/**
 * Maps an UMetadata custom property type (from the field config) to the
 ...
 *
 * @param {string} omPropertyType - UMetadata property type
...
/**
 * Looks up the UMetadata property type for a custom property from the
 ...
 * @param {string|null} omPropertyType - The UMetadata property type from config (preferred over path parsing)

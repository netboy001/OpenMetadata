...
describe('TestDefinitionUtils', () => {
  describe('isExternalTestDefinition', () => {
    it('should return true when testPlatforms does not include UMetadata', () => {
    ...
    it('should return false when testPlatforms includes UMetadata', () => {
      const uMetadataTest: TestDefinition = {
        id: 'test-3',
        name: 'omTest',
        testPlatforms: [TestPlatform.UMetadata],
      } as TestDefinition;

      expect(isExternalTestDefinition(uMetadataTest)).toBe(false);
    });

    it('should return false when testPlatforms includes UMetadata and other platforms', () => {
      const mixedTest: TestDefinition = {
        id: 'test-4',
        name: 'mixedTest',
        testPlatforms: [TestPlatform.UMetadata, TestPlatform.Dbt],
      } as TestDefinition;

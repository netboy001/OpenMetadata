...
import { U_METADATA } from '../constants/service-guide.constant';
...
describe('LogsClassBase', () => {
  ...
  describe('getLogBreadCrumbs', () => {
    it('should return breadcrumbs for UMetadata ingestion pipeline', () => {
      const serviceType = 'database';
      const ingestionName = `${U_METADATA}.testPipeline`;
    ...
    it('should handle multiple dots in ingestion name for UMetadata', () => {
      const serviceType = 'database';
      const ingestionName = `${U_METADATA}.pipeline.sub.test`;
      const ingestionDetails = {
        pipelineType: 'dbt',
        name: 'test',
      } as IngestionPipeline;
    ...
    it('should use displayName for UMetadata pipeline when ingestionName is pipeline id', () => {
      const serviceType = 'database';
      const ingestionName = `${U_METADATA}.a1b2c3d4-5678-90ab-cdef-pipeline-id`;
      const ingestionDetails = {
        pipelineType: 'metadata',

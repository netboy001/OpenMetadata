...
const mockTestSuite = {
  ...
  name: 'mySQL.umetadata_db.umetadata_db.web_analytic_event.testSuite',
  fullyQualifiedName:
    'mySQL.umetadata_db.umetadata_db.web_analytic_event.testSuite',
  tests: [],
  pipelines: [
    {
      ...
      fullyQualifiedName:
        'mySQL.umetadata_db.umetadata_db.web_analytic_event.testSuite.web_analytic_event_TestSuite',
      deleted: false,
    },
  ],
  ...
  basicEntityReference: {
    ...
    fullyQualifiedName:
      'mySQL.umetadata_db.umetadata_db.web_analytic_event',
  },
  summary: {
    success: 0,
    failed: 1,

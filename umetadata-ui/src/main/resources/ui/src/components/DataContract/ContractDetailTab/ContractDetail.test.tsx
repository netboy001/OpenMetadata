...
describe('ContractDetail', () => {
  ...
  describe('ODCS Import', () => {
    ...
    it('should show import UMetadata option in dropdown menu', async () => {
      render(
        <ContractDetail
          hasEditPermission
          contract={mockContract}
      ...
      expect(
        screen.getByTestId('import-umetadata-contract-button')
      ).toBeInTheDocument();
    });
    ...
    it('should open import modal with UMetadata format from contract actions', async () => {
      render(
        <ContractDetail
          hasEditPermission
          contract={mockContract}

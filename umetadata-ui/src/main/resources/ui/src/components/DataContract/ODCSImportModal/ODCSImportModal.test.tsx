  ...
  useTranslation: () => ({
    t: (key: string, options?: Record<string, string>) => {
      const translations: Record<string, string> = {
        ...
        'message.drag-drop-umetadata-file':
          'Drag and drop UMetadata file here',
        'label.supports-yaml-format': 'Supports YAML format',
        'message.invalid-odcs-contract-format': 'Invalid ODCS contract format',
        'message.invalid-umetadata-contract-format':
          'Invalid UMetadata contract format',
...
const validUMetadataYaml = `name: om-contract
displayName: OM Contract
description: Test UMetadata contract
entity:
  id: table-1
  type: table
schema:
...
describe('ContractImportModal', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render UMetadata format modal title', () => {
      render(
        <ContractImportModal
          visible
          entityId="table-1"
  ...
  describe('Import Flow', () => {
    ...
    it('should handle UMetadata import for new contract', async () => {
      ...
      const file = new File([validUMetadataYaml], 'om-contract.yaml', {
        type: 'application/x-yaml',
      });
    ...
    it('should handle UMetadata import with replace mode for existing contract', async () => {
    ...
    it('should handle UMetadata import with merge mode for existing contract', async () => {
...
status: active`;
    ...
    it('should handle UMetadata contract with display name', async () => {
...
entity:
  ...
  type: table`;
    ...
    it('should handle invalid UMetadata format', async () => {
...
version: 1.0`;
  ...
  describe('UMetadata Format Preview', () => {
    it('should show UMetadata contract features in preview', async () => {
      render(
        <ContractImportModal
          visible
          entityId="table-1"
      ...
      const file = new File([validUMetadataYaml], 'contract.yaml', {
        type: 'application/x-yaml',
      });

  ...
  const addContractActionsItems = useMemo(() => {
    return [
      ...
      },
      {
        ...
        key: DATA_CONTRACT_ACTION_DROPDOWN_KEY.IMPORT_UMETADATA,
        icon:
          hoveredAddContractItem ===
          DATA_CONTRACT_ACTION_DROPDOWN_KEY.IMPORT_UMETADATA ? (
            <ImportIconSelected />
          ) : (
            <ImportIconContract />
          ),
        testId: 'import-umetadata-contract-button',
      },
      {
        ...
        ? [
            ...
            },
            {
              label: (
                <div
                  className="contract-action-dropdown-item"
                  data-testid="import-umetadata-contract-button">
  ...
  const handleAddContractAction = useCallback(
    (key: string) => {
      ...
      switch (key) {
        ...
        case DATA_CONTRACT_ACTION_DROPDOWN_KEY.IMPORT_UMETADATA:
          return handleImportContract('umetadata');

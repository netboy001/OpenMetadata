...
describe('ServiceDocPanel Component', () => {
  ...
  describe('Brand Name Replacement', () => {
    ...
    it('should replace UMetadata with BRAND_NAME when env var is set', async () => {
      process.env = { ...originalEnv, BRAND_NAME: 'Collate' };
      mockFetchMarkdownFile.mockResolvedValue(
        'Connect to UMetadata using UMetadata SDK'
      );
    ...
    it('should keep UMetadata when BRAND_NAME env var is not set', async () => {
      process.env = { ...originalEnv };
    ...
    it('should replace all occurrences of UMetadata with BRAND_NAME', async () => {
      process.env = { ...originalEnv, BRAND_NAME: 'MyBrand' };
      mockFetchMarkdownFile.mockResolvedValue(
        'UMetadata is great. Use UMetadata for metadata management.'
      );

...
describe('TestDefinitionForm Component', () => {
  ...
  describe('Field Requirements', () => {
    ...
    // testPlatforms defaults to [UMetadata] so it never fires an error on empty submit.
    ...
    describe('Required fields', () => {
      ...
      it('testPlatforms field is required', () => {
        ...
        // testPlatforms defaults to [UMetadata] so submitting never triggers
      ...
      it('supportedDataTypes field is optional for UMetadata tests', async () => {
        render(
          <TestDefinitionForm
            onCancel={mockOnCancel}
            onSuccess={mockOnSuccess}
    ...
    describe('Optional fields', () => {
      ...
      it('supportedDataTypes field is optional for non-UMetadata tests', async () => {
        render(
          <TestDefinitionForm
            initialValues={{
  ...
  describe('External Test Definition Handling', () => {
    ...
    it('should render supported services field in edit mode for UMetadata tests', () => {
      render(
        <TestDefinitionForm
          initialValues={mockInitialValues}
          onCancel={mockOnCancel}

...
## Requirements
UMetadata supports 2 types of connection for the Nifi connector:
...
UMetadata supports basic authentication (username/password) or client certificate authentication. See requirement section for more details.
$$
...
**Important**: This file should be accessible from where the ingestion workflow is running. For example, if you are using UMetadata Ingestion Docker container, this file should be in this container.
$$

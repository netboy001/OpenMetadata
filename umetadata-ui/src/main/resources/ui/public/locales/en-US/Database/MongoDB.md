# MongoDB
In this section, we provide guides and references to use the MongoDB connector. You can view the full documentation for MongoDB <a href="https://docs.u-metadata.org/connectors/database/mongo" target="_blank">here</a>.
...
You can find further information on the Hive connector in the <a href="https://docs.u-metadata.org/connectors/database/mongo" target="_blank">here</a>.

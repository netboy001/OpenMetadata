...
- **Why it matters:** Tells UMetadata which Azure AD tenant to authenticate against.
- **Note:**
...
- **Why it matters:** Controls how user information from Azure AD maps to UMetadata user profiles.
...
- **Why it matters:** Automatically assigns users to existing UMetadata teams based on their Azure AD attributes during login.
- **How it works:**
...
- **Why it matters:** Allows UMetadata to automatically discover Azure AD's OIDC endpoints.
...
- **Why it matters:** UMetadata uses `client_secret_post` which is supported by Azure AD.

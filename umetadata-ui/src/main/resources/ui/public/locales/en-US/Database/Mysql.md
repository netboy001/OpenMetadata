...
$$note
UMetadata supports MySQL version `8.0.0` and up. 
$$
...
You can find further information on the MySQL connector in the <a href="https://docs.wondersgroup.com/connectors/database/mysql" target="_blank">docs</a>.

...
To access the Grafana APIs and import dashboards and panels from Grafana into UMetadata, you need appropriate permissions on your Grafana instance.
...
If you are running the UMetadata ingestion in a docker and your Grafana instance is hosted on `localhost`, then use `host.docker.internal` as the hostname.
$$

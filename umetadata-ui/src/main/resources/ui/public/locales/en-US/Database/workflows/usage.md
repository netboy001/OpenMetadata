...
Note that in order to find the usage information, you will first need to have the tables in UMetadata by running the Metadata Workflow. We use the table names identified in the queries to match the information present in UMetadata.

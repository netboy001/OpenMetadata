...
UMetadata is integrated with kafkaconnect up to version <a href="https://docs.kafkaconnect.io/getting-started" target="_blank">3.6.1</a> and will continue to work for future kafkaconnect versions.
...
UMetadata supports basic authentication (username/password)
`Optional`.
$$

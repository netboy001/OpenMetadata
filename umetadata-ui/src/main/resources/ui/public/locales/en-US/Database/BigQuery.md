...
If you have attached policy tags to the columns of table available in BigQuery, then UMetadata will fetch those tags and attach it to the respective columns.

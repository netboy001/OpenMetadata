...
In this section, we provide guides and references to use the UMetadata connector.

## Requirements
<!-- to be updated -->
You can find further information on the Kafka connector in the <a href="https://docs.wondersgroup.com/connectors/metadata/umetadata" target="_blank">docs</a>.
...
UMetadata Server Authentication Provider. Make sure configure same auth providers as the one configured on UMetadata server.
...
UMetadata Secrets Manager Provider. Make sure to configure the same secrets manager providers as the ones configured on the UMetadata server.
...
UMetadata Secrets Manager Client credentials

...
- **Instance Accessibility**: The ServiceNow instance URL must be reachable from the UMetadata server.
...
This should be the full URL to your ServiceNow instance. UMetadata will connect to this instance to extract metadata from your ServiceNow tables and schemas.
$$

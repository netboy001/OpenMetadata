...
Default value: `UMetadataSession`
...
Example: `umetadata-ingestion-service`
$$
...
A regular expression pattern to filter which Kinesis Firehose delivery streams to include or exclude during metadata extraction. This helps you control which pipelines are ingested into UMetadata.

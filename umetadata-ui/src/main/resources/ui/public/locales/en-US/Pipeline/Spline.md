...
UMetadata uses Spline REST Server APIs to extract the execution details from spline to generate lineage.
...
Spline UI Host & Port is an optional field which is used for generating redirection URL from UMetadata to Spline Portal. 

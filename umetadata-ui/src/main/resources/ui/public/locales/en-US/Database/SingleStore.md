...
In this section, we provide guides and references to use the SingleStore connector. You can view the full documentation for SingleStore <a href="https://docs.wondersgroup.com/connectors/database/singlestore" target="_blank">here</a>.
...
You can find further information on the SingleStore connector in the <a href="https://docs.wondersgroup.com/connectors/database/singlestore" target="_blank">docs</a>.

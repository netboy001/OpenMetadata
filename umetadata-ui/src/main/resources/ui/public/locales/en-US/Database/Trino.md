...
In this section, we provide guides and references to use the Trino connector. You can view the full documentation for Trino <a href="https://docs.u-metadata.org/connectors/database/trino" target="_blank">here</a>.
...
You can find further information on the Trino connector in the <a href="https://docs.u-metadata.org/connectors/database/trino" target="_blank">docs</a>.

...
In this section, we provide guides and references to use the Trino connector. You can view the full documentation for Trino <a href="https://docs.wondersgroup.com/connectors/database/trino" target="_blank">here</a>.
...
You can find further information on the Trino connector in the <a href="https://docs.wondersgroup.com/connectors/database/trino" target="_blank">docs</a>.
...
If you are running the UMetadata ingestion in a docker and your services are hosted on the `localhost`, then use `host.docker.internal:8080` as the value.
$$

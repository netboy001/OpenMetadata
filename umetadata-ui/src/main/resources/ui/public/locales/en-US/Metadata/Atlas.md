...
## Requirements
You can find further information on the Kafka connector in the <a href="https://docs.wondersgroup.com/connectors/metadata/atlas" target="_blank">docs</a>.
...
Service Name of the Database Service, present in UMetadata, for which metadata will be ingested from Atlas.
$$

$$section
### Messaging Service Name $(id="messagingServiceName")

Service Name of the Messaging Service, present in UMetadata, for which metadata will be ingested from Atlas.
$$

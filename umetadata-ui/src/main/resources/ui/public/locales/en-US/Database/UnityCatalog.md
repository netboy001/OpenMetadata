...
In this section, we provide guides and references to use the Unity Catalog connector. You can view the full documentation for Unity Catalog <a href="https://docs.u-metadata.org/connectors/database/unity-catalog" target="_blank">here</a>.

## Requirements

To learn more about the Unity Catalog Connection Details (`hostPort`,`token`, `http_path`) information visit these <a href="https://docs.u-metadata.org/connectors/database/unity-catalog/troubleshooting" target="_blank">docs</a>.
...
You can find further information on the Unity Catalog connector in the <a href="https://docs.u-metadata.org/connectors/database/unity-catalog" target="_blank">docs</a>.

...
You can find further information on the Fivetran connector in the <a href="https://docs.wondersgroup.com/connectors/pipeline/fivetran" target="_blank">docs</a>.
...
Pipeline Service Management URI. This should be specified as a URI string in the format `scheme://hostname:port`. By default, UMetadata will use `https://api.fivetran.com` to connect to the Fivetran APIs.

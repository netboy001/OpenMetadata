...
UMetadata for reaching OpenLineage events connects to kafka brokers.
...
UMetadata is reading OpenLineage events from certain kafka topic 
...
This should be specified as consumer group name string . E.g., `umetadata-openlineage-consumer`.
$$

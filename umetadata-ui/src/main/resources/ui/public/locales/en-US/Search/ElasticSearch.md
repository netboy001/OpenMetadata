...
In this section, we provide guides and references to use the ElasticSearch connector. You can view the full documentation for ElasticSearch <a href="https://docs.u-metadata.org/connectors/search/elasticsearch" target="_blank">here</a>.
...
You can find further information on the ElasticSearch connector in the <a href="https://docs.u-metadata.org/connectors/search/elasticsearch" target="_blank">docs</a>.

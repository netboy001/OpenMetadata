...
In this section, we provide guides and references to use the ElasticSearch connector. You can view the full documentation for ElasticSearch <a href="https://docs.wondersgroup.com/connectors/search/elasticsearch" target="_blank">here</a>.
...
You can find further information on the ElasticSearch connector in the <a href="https://docs.wondersgroup.com/connectors/search/elasticsearch" target="_blank">docs</a>.
...
If you are running the UMetadata ingestion in a docker and your services are hosted on the `localhost`, then use `http://host.docker.internal:9200` as the value.
$$

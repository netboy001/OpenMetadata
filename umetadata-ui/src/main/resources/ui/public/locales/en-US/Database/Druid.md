...
You can find further information on the Druid connector in the <a href="https://docs.wondersgroup.com/connectors/database/druid" target="_blank">docs</a>.
...
If you are running the UMetadata ingestion in a docker and your services are hosted on the `localhost`, then use `host.docker.internal:8000` as the value.
$$

...
In this section, we provide guides and references to use the Databricks connector. You can view the full documentation for Databricks <a href="https://docs.wondersgroup.com/connectors/database/databricks" target="_blank">here</a>.
...
You can find further information on the Databricks connector in the <a href="https://docs.wondersgroup.com/connectors/database/databricks" target="_blank">docs</a>.

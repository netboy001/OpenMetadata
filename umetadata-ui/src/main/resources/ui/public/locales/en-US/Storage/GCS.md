...
By default, the GCS connector will ingest only top-level containers (Buckets). If you want to extract any information from within and their data models, you can follow the <a href="https://docs.u-metadata.org/connectors/storage" target="_blank">docs</a>.

...
1. **Get UMetadata Service Provider Details** (from this form):
...
4. **Complete UMetadata Configuration**:
   - Enter the IdP details in the form below
   - Configure security settings (signing, encryption)
   - Save the configuration

**Important:** The SP Entity ID and ACS URL are generated automatically based on your UMetadata URL and cannot be changed. You must use these exact values in your IdP configuration for SAML to work.
...
- **Definition:** Unique identifier for UMetadata as a Service Provider.
- **Example:** https://umetadata.company.com
- **Auto-Generated:** This field is automatically populated based on your UMetadata deployment URL.
- **Why it matters:** IdP uses this to identify UMetadata in SAML exchanges.
- **Note:**
...
- **Example:** https://umetadata.company.com/callback
- **Auto-Generated:** This field is automatically populated based on your UMetadata deployment URL.
...
- **Definition:** Public certificate for UMetadata (Service Provider).
- **Example:** -----BEGIN CERTIFICATE-----\nMIIC...certificate content...\n-----END CERTIFICATE-----
- **Why it matters:** Used by IdP to verify signed SAML requests from UMetadata.
...
- **Note:** This controls the UMetadata JWT token lifetime, not the SAML assertion lifetime
$$
...
- **Default:** false
- **Example:** true
- **Why it matters:** Ensures authenticity of requests from UMetadata.

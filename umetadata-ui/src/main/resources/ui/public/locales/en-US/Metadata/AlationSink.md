...
The connector will ingest data from UMetadata into Alation.
...
Add a custom mapping between UMetadata databases and Alation DataSources.
...
The mapping needs to be of the format `alation_datasource_id: umetadata database fqn`

# Redshift
In this section, we provide guides and references to use the Redshift connector. You can view the full documentation for Redshift <a href="https://docs.wondersgroup.com/connectors/database/redshift" target="_blank">here</a>.
...
Information on **System Metrics** profiling can be found <a href="https://docs.wondersgroup.com/latest/how-to-guides/data-quality-observability/profiler/metrics#redshift" target="_blank">here</a>.
...
You can find more information on the usage workflow <a href="https://docs.wondersgroup.com/connectors/ingestion/workflows/usage" target="_blank">here</a> and the lineage workflow <a href="https://docs.wondersgroup.com/connectors/ingestion/workflows/lineage" target="_blank">here</a>.

You can find further information on the Redshift connector in the <a href="https://docs.wondersgroup.com/connectors/database/redshift" target="_blank">docs</a>.
...
If you are running the UMetadata ingestion in a docker and your services are hosted on the `localhost`, then use `host.docker.internal:5439` as the value.
$$

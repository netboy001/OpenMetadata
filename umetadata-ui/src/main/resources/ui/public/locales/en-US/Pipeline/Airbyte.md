...
In this section, we provide guides and references to use the Airbyte connector. You can view the full documentation for Airbyte <a href="https://docs.u-metadata.org/connectors/pipeline/airbyte" target="_blank">here</a>.
...
You can find further information on the Airbyte connector in the <a href="https://docs.u-metadata.org/connectors/pipeline/airbyte" target="_blank">docs</a>.

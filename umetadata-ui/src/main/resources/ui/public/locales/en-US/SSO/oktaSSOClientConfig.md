...
- **Why it matters:** Tells UMetadata which Okta org to authenticate against.
...
- **Why it matters:** Controls how user information from Okta maps to UMetadata user profiles.
...
- **Why it matters:** Automatically assigns users to existing UMetadata teams based on their Okta user profile during login.
- **How it works:**
...
- **Why it matters:** Allows UMetadata to automatically discover Okta's OIDC endpoints.

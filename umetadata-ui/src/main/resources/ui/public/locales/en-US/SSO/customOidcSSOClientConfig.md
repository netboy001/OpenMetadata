...
- **Why it matters:** UMetadata uses this to discover OIDC endpoints and validate tokens.
- **Required:** Yes
...
- **Why it matters:** Maps JWT claims to UMetadata user identities.
$$
...
- **Why it matters:** Controls how user information from your OIDC provider maps to UMetadata user profiles.
...
- **Why it matters:** Automatically assigns users to existing UMetadata teams based on their OIDC provider attributes during login.
- **How it works:**
...
Client ID: umetadata-client
Scopes: openid profile email groups
```

### Authentik
```
Authority: https://auth.company.com/application/o/umetadata/

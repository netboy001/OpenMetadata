# Impala
In this section, we provide guides and references to use the Impala connector. You can view the full documentation for Impala <a href="https://docs.u-metadata.org/connectors/database/impala" target="_blank">here</a>.
...
You can find further information on the Impala connector in the <a href="https://docs.u-metadata.org/connectors/database/impala" target="_blank">docs</a>.

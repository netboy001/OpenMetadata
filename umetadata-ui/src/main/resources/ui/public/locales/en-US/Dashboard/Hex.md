...
To access the Hex APIs and import projects, notebooks, and datasets from Hex into UMetadata, you'll need a **Hex API token**.
...
Enable this option to import Hex project categories and status as UMetadata tags.

When enabled, any categories and status assigned to your Hex projects will be automatically converted to tags in UMetadata, helping you organize and search for projects more effectively.

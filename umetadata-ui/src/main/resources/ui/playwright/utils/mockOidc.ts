...
export const MOCK_OIDC_CLIENT_ID = 'umetadata-test';
export const MOCK_OIDC_CLIENT_SECRET = 'umetadata-test-secret';
export const MOCK_OIDC_PUBLIC_CLIENT_ID = 'umetadata-test-public';

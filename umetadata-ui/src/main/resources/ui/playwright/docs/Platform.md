...
| 23 | **ODCS Import/Export** - Import ODCS and export as UMetadata YAML | Import ODCS and export as UMetadata YAML |
| 24 | **ODCS Import/Export** - Import ODCS with description and verify UMetadata export | Import ODCS with description and verify UMetadata export |
...
| 26 | **ODCS Import/Export** - Verify SLA mapping from ODCS to UMetadata format | SLA mapping from ODCS to UMetadata format |
...
| # | Test Case | Description |
|---|-----------|-------------|
| 1 | **Health Check for UMetadata** - All 5 checks should be successful | All 5 checks should be successful |

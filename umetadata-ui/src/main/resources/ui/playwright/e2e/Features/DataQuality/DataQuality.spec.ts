  ...
  () => {
    ...
    test('TestCase filters', async ({ page }) => {
      ...
      try {
        ...
        const testCasePlatformByUMetadata = page.waitForResponse(
          `/api/v1/dataQuality/testCases/search/list?*testPlatforms=UMetadata*`
        );
        await page.getByTestId('platform-select-filter').click();
        await page.getByTitle('UMetadata').click();
        await testCasePlatformByUMetadata;

  ...
  () => {
    ...
    test('Column Values To Be Not Null', async ({ page }) => {
      ...
      await test.step('Create', async () => {
        ...
        const testDefinitionResponse = page.waitForResponse(
          '/api/v1/dataQuality/testDefinitions?limit=*&entityType=COLUMN&testPlatform=UMetadata&supportedDataType=NUMERIC&supportedService=Mysql*'
        );
    ...
    test('Column Values To Be Between', async ({ page }) => {
      ...
      await test.step('Create', async () => {
        ...
        // Select column and wait for test definitions API response
        const testDefinitionResponse = page.waitForResponse(
          '/api/v1/dataQuality/testDefinitions?limit=*&entityType=COLUMN&testPlatform=UMetadata&supportedDataType=INT&supportedService=Mysql*'
        );
    ...
    test('Column Values To Match Regex', async ({ page }) => {
      ...
      await test.step('Create', async () => {
        ...
        // Select column and wait for API response
        const testDefinitionResponse = page.waitForResponse(
          '/api/v1/dataQuality/testDefinitions?limit=*&entityType=COLUMN&testPlatform=UMetadata&supportedDataType=VARCHAR&supportedService=Mysql*'
        );
        await page.click(`[title="${testCase.column}"]`);
        await testDefinitionResponse;
